...
var SUQFc = function (_Component) {
  _inherits(SUQFc, _Component);

  function SUQFc() {
    _classCallCheck(this, SUQFc);

    return _possibleConstructorReturn(this, (SUQFc.__proto__ || Object.getPrototypeOf(SUQFc)).apply(this, arguments));
  }
...
_metalSoy2.default.register(SUQFc, _step_4Soy2.default);

exports.default = SUQFc;
...
exports.templates = exports.SUQFc = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace SUQFc.
   * @public
   */

  goog.module('SUQFc.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'SUQFc.render';
  }
...
_metalSoy2.default.register(SUQFc, templates);
exports.SUQFc = SUQFc;
