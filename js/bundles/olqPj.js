...
var olqPj = function (_Component) {
  _inherits(olqPj, _Component);

  function olqPj() {
    _classCallCheck(this, olqPj);

    return _possibleConstructorReturn(this, (olqPj.__proto__ || Object.getPrototypeOf(olqPj)).apply(this, arguments));
  }
...
_metalSoy2.default.register(olqPj, _conversionSoy2.default);

exports.default = olqPj;
...
exports.templates = exports.olqPj = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace olqPj.
   * @public
   */

  goog.module('olqPj.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'olqPj.render';
  }
...
_metalSoy2.default.register(olqPj, templates);
exports.olqPj = olqPj;
