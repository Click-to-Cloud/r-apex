...
var PwDWD = function (_Component) {
  _inherits(PwDWD, _Component);

  function PwDWD() {
    _classCallCheck(this, PwDWD);

    return _possibleConstructorReturn(this, (PwDWD.__proto__ || Object.getPrototypeOf(PwDWD)).apply(this, arguments));
  }
...
_metalSoy2.default.register(PwDWD, _conversionSoy2.default);

exports.default = PwDWD;
...
exports.templates = exports.PwDWD = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace PwDWD.
   * @public
   */

  goog.module('PwDWD.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'PwDWD.render';
  }
...
_metalSoy2.default.register(PwDWD, templates);
exports.PwDWD = PwDWD;
