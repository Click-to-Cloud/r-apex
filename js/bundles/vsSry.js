...
var vsSry = function (_Component) {
  _inherits(vsSry, _Component);

  function vsSry() {
    _classCallCheck(this, vsSry);

    return _possibleConstructorReturn(this, (vsSry.__proto__ || Object.getPrototypeOf(vsSry)).apply(this, arguments));
  }
...
_metalSoy2.default.register(vsSry, _creationSoy2.default);

exports.default = vsSry;
...
exports.templates = exports.vsSry = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace vsSry.
   * @public
   */

  goog.module('vsSry.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'vsSry.render';
  }
...
_metalSoy2.default.register(vsSry, templates);
exports.vsSry = vsSry;
