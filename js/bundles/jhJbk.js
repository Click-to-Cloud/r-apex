...
var jhJbk = function (_Component) {
  _inherits(jhJbk, _Component);

  function jhJbk() {
    _classCallCheck(this, jhJbk);

    return _possibleConstructorReturn(this, (jhJbk.__proto__ || Object.getPrototypeOf(jhJbk)).apply(this, arguments));
  }
...
_metalSoy2.default.register(jhJbk, _relationSoy2.default);

exports.default = jhJbk;
...
exports.templates = exports.jhJbk = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace jhJbk.
   * @public
   */

  goog.module('jhJbk.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'jhJbk.render';
  }
...
_metalSoy2.default.register(jhJbk, templates);
exports.jhJbk = jhJbk;
