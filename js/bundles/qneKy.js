...
var qneKy = function (_Component) {
  _inherits(qneKy, _Component);

  function qneKy() {
    _classCallCheck(this, qneKy);

    return _possibleConstructorReturn(this, (qneKy.__proto__ || Object.getPrototypeOf(qneKy)).apply(this, arguments));
  }
...
_metalSoy2.default.register(qneKy, _methodsSoy2.default);

exports.default = qneKy;
...
exports.templates = exports.qneKy = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace qneKy.
   * @public
   */

  goog.module('qneKy.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param1457 = function param1457() {
      ie_open('h6');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param1457 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'qneKy.render';
  }
...
_metalSoy2.default.register(qneKy, templates);
exports.qneKy = qneKy;
