...
var KSIKR = function (_Component) {
  _inherits(KSIKR, _Component);

  function KSIKR() {
    _classCallCheck(this, KSIKR);

    return _possibleConstructorReturn(this, (KSIKR.__proto__ || Object.getPrototypeOf(KSIKR)).apply(this, arguments));
  }
...
_metalSoy2.default.register(KSIKR, _arithmeticSoy2.default);

exports.default = KSIKR;
...
exports.templates = exports.KSIKR = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace KSIKR.
   * @public
   */

  goog.module('KSIKR.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'KSIKR.render';
  }
...
_metalSoy2.default.register(KSIKR, templates);
exports.KSIKR = KSIKR;
