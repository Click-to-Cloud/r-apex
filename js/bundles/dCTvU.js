...
var dCTvU = function (_Component) {
  _inherits(dCTvU, _Component);

  function dCTvU() {
    _classCallCheck(this, dCTvU);

    return _possibleConstructorReturn(this, (dCTvU.__proto__ || Object.getPrototypeOf(dCTvU)).apply(this, arguments));
  }
...
_metalSoy2.default.register(dCTvU, _step_6Soy2.default);

exports.default = dCTvU;
...
exports.templates = exports.dCTvU = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace dCTvU.
   * @public
   */

  goog.module('dCTvU.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'dCTvU.render';
  }
...
_metalSoy2.default.register(dCTvU, templates);
exports.dCTvU = dCTvU;
