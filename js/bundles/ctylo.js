...
var _listSoy = __webpack_require__(291);
...
var ctylo = function (_Component) {
  _inherits(ctylo, _Component);

  function ctylo() {
    _classCallCheck(this, ctylo);

    return _possibleConstructorReturn(this, (ctylo.__proto__ || Object.getPrototypeOf(ctylo)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ctylo, _listSoy2.default);

exports.default = ctylo;
...
exports.templates = exports.ctylo = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ctylo.
   * @public
   */

  goog.module('ctylo.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ctylo.render';
  }
...
_metalSoy2.default.register(ctylo, templates);
exports.ctylo = ctylo;
