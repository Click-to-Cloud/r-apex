...
var SnFvF = function (_Component) {
  _inherits(SnFvF, _Component);

  function SnFvF() {
    _classCallCheck(this, SnFvF);

    return _possibleConstructorReturn(this, (SnFvF.__proto__ || Object.getPrototypeOf(SnFvF)).apply(this, arguments));
  }
...
_metalSoy2.default.register(SnFvF, _methodsSoy2.default);

exports.default = SnFvF;
...
exports.templates = exports.SnFvF = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace SnFvF.
   * @public
   */

  goog.module('SnFvF.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param1427 = function param1427() {
      ie_open('h6');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'SnFvF.render';
  }
...
_metalSoy2.default.register(SnFvF, templates);
exports.SnFvF = SnFvF;
