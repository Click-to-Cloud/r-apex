...
var VwGDJ = function (_Component) {
  _inherits(VwGDJ, _Component);

  function VwGDJ() {
    _classCallCheck(this, VwGDJ);

    return _possibleConstructorReturn(this, (VwGDJ.__proto__ || Object.getPrototypeOf(VwGDJ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(VwGDJ, _step_5Soy2.default);

exports.default = VwGDJ;
...
exports.templates = exports.VwGDJ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace VwGDJ.
   * @public
   */

  goog.module('VwGDJ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'VwGDJ.render';
  }
...
_metalSoy2.default.register(VwGDJ, templates);
exports.VwGDJ = VwGDJ;
