...
var TUMXB = function (_Component) {
  _inherits(TUMXB, _Component);

  function TUMXB() {
    _classCallCheck(this, TUMXB);

    return _possibleConstructorReturn(this, (TUMXB.__proto__ || Object.getPrototypeOf(TUMXB)).apply(this, arguments));
  }
...
_metalSoy2.default.register(TUMXB, _mapSoy2.default);

exports.default = TUMXB;
...
exports.templates = exports.TUMXB = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace TUMXB.
   * @public
   */

  goog.module('TUMXB.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'TUMXB.render';
  }
...
_metalSoy2.default.register(TUMXB, templates);
exports.TUMXB = TUMXB;
