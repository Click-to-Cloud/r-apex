...
var ysxsG = function (_Component) {
  _inherits(ysxsG, _Component);

  function ysxsG() {
    _classCallCheck(this, ysxsG);

    return _possibleConstructorReturn(this, (ysxsG.__proto__ || Object.getPrototypeOf(ysxsG)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ysxsG, _step_5Soy2.default);

exports.default = ysxsG;
...
exports.templates = exports.ysxsG = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ysxsG.
   * @public
   */

  goog.module('ysxsG.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param2022 = function param2022() {
      ie_open('h2');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param2022 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ysxsG.render';
  }
...
_metalSoy2.default.register(ysxsG, templates);
exports.ysxsG = ysxsG;
