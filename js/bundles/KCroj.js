...
var KCroj = function (_Component) {
  _inherits(KCroj, _Component);

  function KCroj() {
    _classCallCheck(this, KCroj);

    return _possibleConstructorReturn(this, (KCroj.__proto__ || Object.getPrototypeOf(KCroj)).apply(this, arguments));
  }
...
_metalSoy2.default.register(KCroj, _conditionSoy2.default);

exports.default = KCroj;
...
exports.templates = exports.KCroj = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace KCroj.
   * @public
   */

  goog.module('KCroj.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'KCroj.render';
  }
...
_metalSoy2.default.register(KCroj, templates);
exports.KCroj = KCroj;
