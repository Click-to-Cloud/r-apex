...
var AwiIQ = function (_Component) {
  _inherits(AwiIQ, _Component);

  function AwiIQ() {
    _classCallCheck(this, AwiIQ);

    return _possibleConstructorReturn(this, (AwiIQ.__proto__ || Object.getPrototypeOf(AwiIQ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(AwiIQ, _step_5Soy2.default);

exports.default = AwiIQ;
...
exports.templates = exports.AwiIQ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace AwiIQ.
   * @public
   */

  goog.module('AwiIQ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'AwiIQ.render';
  }
...
_metalSoy2.default.register(AwiIQ, templates);
exports.AwiIQ = AwiIQ;
