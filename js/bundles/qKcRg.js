...
var qKcRg = function (_Component) {
  _inherits(qKcRg, _Component);

  function qKcRg() {
    _classCallCheck(this, qKcRg);

    return _possibleConstructorReturn(this, (qKcRg.__proto__ || Object.getPrototypeOf(qKcRg)).apply(this, arguments));
  }
...
_metalSoy2.default.register(qKcRg, _listSoy2.default);

exports.default = qKcRg;
...
exports.templates = exports.qKcRg = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace qKcRg.
   * @public
   */

  goog.module('qKcRg.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'qKcRg.render';
  }
...
_metalSoy2.default.register(qKcRg, templates);
exports.qKcRg = qKcRg;
