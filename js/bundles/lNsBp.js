...
var lNsBp = function (_Component) {
  _inherits(lNsBp, _Component);

  function lNsBp() {
    _classCallCheck(this, lNsBp);

    return _possibleConstructorReturn(this, (lNsBp.__proto__ || Object.getPrototypeOf(lNsBp)).apply(this, arguments));
  }
...
_metalSoy2.default.register(lNsBp, _step_8Soy2.default);

exports.default = lNsBp;
...
exports.templates = exports.lNsBp = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace lNsBp.
   * @public
   */

  goog.module('lNsBp.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'lNsBp.render';
  }
...
_metalSoy2.default.register(lNsBp, templates);
exports.lNsBp = lNsBp;
