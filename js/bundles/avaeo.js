...
var avaeo = function (_Component) {
  _inherits(avaeo, _Component);

  function avaeo() {
    _classCallCheck(this, avaeo);

    return _possibleConstructorReturn(this, (avaeo.__proto__ || Object.getPrototypeOf(avaeo)).apply(this, arguments));
  }
...
_metalSoy2.default.register(avaeo, _step_7Soy2.default);

exports.default = avaeo;
...
exports.templates = exports.avaeo = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace avaeo.
   * @public
   */

  goog.module('avaeo.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'avaeo.render';
  }
...
_metalSoy2.default.register(avaeo, templates);
exports.avaeo = avaeo;
