...
var VrJKE = function (_Component) {
  _inherits(VrJKE, _Component);

  function VrJKE() {
    _classCallCheck(this, VrJKE);

    return _possibleConstructorReturn(this, (VrJKE.__proto__ || Object.getPrototypeOf(VrJKE)).apply(this, arguments));
  }
...
_metalSoy2.default.register(VrJKE, _step_6Soy2.default);

exports.default = VrJKE;
...
exports.templates = exports.VrJKE = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace VrJKE.
   * @public
   */

  goog.module('VrJKE.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param2053 = function param2053() {
      ie_open('h2');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param2053 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'VrJKE.render';
  }
...
_metalSoy2.default.register(VrJKE, templates);
exports.VrJKE = VrJKE;
