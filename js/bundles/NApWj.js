...
var NApWj = function (_Component) {
  _inherits(NApWj, _Component);

  function NApWj() {
    _classCallCheck(this, NApWj);

    return _possibleConstructorReturn(this, (NApWj.__proto__ || Object.getPrototypeOf(NApWj)).apply(this, arguments));
  }
...
_metalSoy2.default.register(NApWj, _methodsSoy2.default);

exports.default = NApWj;
...
exports.templates = exports.NApWj = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace NApWj.
   * @public
   */

  goog.module('NApWj.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'NApWj.render';
  }
...
_metalSoy2.default.register(NApWj, templates);
exports.NApWj = NApWj;
