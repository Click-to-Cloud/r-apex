...
var KuVtt = function (_Component) {
  _inherits(KuVtt, _Component);

  function KuVtt() {
    _classCallCheck(this, KuVtt);

    return _possibleConstructorReturn(this, (KuVtt.__proto__ || Object.getPrototypeOf(KuVtt)).apply(this, arguments));
  }
...
_metalSoy2.default.register(KuVtt, _step_6Soy2.default);

exports.default = KuVtt;
...
exports.templates = exports.KuVtt = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace KuVtt.
   * @public
   */

  goog.module('KuVtt.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'KuVtt.render';
  }
...
_metalSoy2.default.register(KuVtt, templates);
exports.KuVtt = KuVtt;
