...
var _utilitySoy = __webpack_require__(293);
...
var ncseA = function (_Component) {
  _inherits(ncseA, _Component);

  function ncseA() {
    _classCallCheck(this, ncseA);

    return _possibleConstructorReturn(this, (ncseA.__proto__ || Object.getPrototypeOf(ncseA)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ncseA, _utilitySoy2.default);

exports.default = ncseA;
...
exports.templates = exports.ncseA = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ncseA.
   * @public
   */

  goog.module('ncseA.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param1247 = function param1247() {
      ie_open('h6');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param1247 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ncseA.render';
  }
...
_metalSoy2.default.register(ncseA, templates);
exports.ncseA = ncseA;
