...
var TvKVZ = function (_Component) {
  _inherits(TvKVZ, _Component);

  function TvKVZ() {
    _classCallCheck(this, TvKVZ);

    return _possibleConstructorReturn(this, (TvKVZ.__proto__ || Object.getPrototypeOf(TvKVZ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(TvKVZ, _step_8Soy2.default);

exports.default = TvKVZ;
...
exports.templates = exports.TvKVZ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace TvKVZ.
   * @public
   */

  goog.module('TvKVZ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'TvKVZ.render';
  }
...
_metalSoy2.default.register(TvKVZ, templates);
exports.TvKVZ = TvKVZ;
