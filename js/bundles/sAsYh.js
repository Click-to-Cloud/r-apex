...
var sAsYh = function (_Component) {
  _inherits(sAsYh, _Component);

  function sAsYh() {
    _classCallCheck(this, sAsYh);

    return _possibleConstructorReturn(this, (sAsYh.__proto__ || Object.getPrototypeOf(sAsYh)).apply(this, arguments));
  }
...
_metalSoy2.default.register(sAsYh, _step_2Soy2.default);

exports.default = sAsYh;
...
exports.templates = exports.sAsYh = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace sAsYh.
   * @public
   */

  goog.module('sAsYh.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'sAsYh.render';
  }
...
_metalSoy2.default.register(sAsYh, templates);
exports.sAsYh = sAsYh;
