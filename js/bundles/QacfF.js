...
var QacfF = function (_Component) {
  _inherits(QacfF, _Component);

  function QacfF() {
    _classCallCheck(this, QacfF);

    return _possibleConstructorReturn(this, (QacfF.__proto__ || Object.getPrototypeOf(QacfF)).apply(this, arguments));
  }
...
_metalSoy2.default.register(QacfF, _step_2Soy2.default);

exports.default = QacfF;
...
exports.templates = exports.QacfF = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace QacfF.
   * @public
   */

  goog.module('QacfF.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'QacfF.render';
  }
...
_metalSoy2.default.register(QacfF, templates);
exports.QacfF = QacfF;
