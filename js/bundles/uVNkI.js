...
var uVNkI = function (_Component) {
  _inherits(uVNkI, _Component);

  function uVNkI() {
    _classCallCheck(this, uVNkI);

    return _possibleConstructorReturn(this, (uVNkI.__proto__ || Object.getPrototypeOf(uVNkI)).apply(this, arguments));
  }
...
_metalSoy2.default.register(uVNkI, _arithmeticSoy2.default);

exports.default = uVNkI;
...
exports.templates = exports.uVNkI = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace uVNkI.
   * @public
   */

  goog.module('uVNkI.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'uVNkI.render';
  }
...
_metalSoy2.default.register(uVNkI, templates);
exports.uVNkI = uVNkI;
