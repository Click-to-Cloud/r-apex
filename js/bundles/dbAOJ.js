...
var _step_7Soy = __webpack_require__(317);
...
var dbAOJ = function (_Component) {
  _inherits(dbAOJ, _Component);

  function dbAOJ() {
    _classCallCheck(this, dbAOJ);

    return _possibleConstructorReturn(this, (dbAOJ.__proto__ || Object.getPrototypeOf(dbAOJ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(dbAOJ, _step_7Soy2.default);

exports.default = dbAOJ;
...
exports.templates = exports.dbAOJ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace dbAOJ.
   * @public
   */

  goog.module('dbAOJ.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param2038 = function param2038() {
      ie_open('h2');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param2038 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'dbAOJ.render';
  }
...
_metalSoy2.default.register(dbAOJ, templates);
exports.dbAOJ = dbAOJ;
