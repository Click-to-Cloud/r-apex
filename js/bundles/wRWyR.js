...
var _methodsSoy = __webpack_require__(319);
...
var wRWyR = function (_Component) {
  _inherits(wRWyR, _Component);

  function wRWyR() {
    _classCallCheck(this, wRWyR);

    return _possibleConstructorReturn(this, (wRWyR.__proto__ || Object.getPrototypeOf(wRWyR)).apply(this, arguments));
  }
...
_metalSoy2.default.register(wRWyR, _methodsSoy2.default);

exports.default = wRWyR;
...
exports.templates = exports.wRWyR = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace wRWyR.
   * @public
   */

  goog.module('wRWyR.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'wRWyR.render';
  }
...
_metalSoy2.default.register(wRWyR, templates);
exports.wRWyR = wRWyR;
