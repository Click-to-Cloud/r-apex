...
var yAImi = function (_Component) {
  _inherits(yAImi, _Component);

  function yAImi() {
    _classCallCheck(this, yAImi);

    return _possibleConstructorReturn(this, (yAImi.__proto__ || Object.getPrototypeOf(yAImi)).apply(this, arguments));
  }
...
_metalSoy2.default.register(yAImi, _mapSoy2.default);

exports.default = yAImi;
...
exports.templates = exports.yAImi = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace yAImi.
   * @public
   */

  goog.module('yAImi.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'yAImi.render';
  }
...
_metalSoy2.default.register(yAImi, templates);
exports.yAImi = yAImi;
