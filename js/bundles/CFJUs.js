...
var CFJUs = function (_Component) {
  _inherits(CFJUs, _Component);

  function CFJUs() {
    _classCallCheck(this, CFJUs);

    return _possibleConstructorReturn(this, (CFJUs.__proto__ || Object.getPrototypeOf(CFJUs)).apply(this, arguments));
  }
...
_metalSoy2.default.register(CFJUs, _step_7Soy2.default);

exports.default = CFJUs;
...
exports.templates = exports.CFJUs = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace CFJUs.
   * @public
   */

  goog.module('CFJUs.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param2099 = function param2099() {
      ie_open('h2');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param2099 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'CFJUs.render';
  }
...
_metalSoy2.default.register(CFJUs, templates);
exports.CFJUs = CFJUs;
