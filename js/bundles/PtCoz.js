...
var PtCoz = function (_Component) {
  _inherits(PtCoz, _Component);

  function PtCoz() {
    _classCallCheck(this, PtCoz);

    return _possibleConstructorReturn(this, (PtCoz.__proto__ || Object.getPrototypeOf(PtCoz)).apply(this, arguments));
  }
...
_metalSoy2.default.register(PtCoz, _mapSoy2.default);

exports.default = PtCoz;
...
exports.templates = exports.PtCoz = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace PtCoz.
   * @public
   */

  goog.module('PtCoz.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'PtCoz.render';
  }
...
_metalSoy2.default.register(PtCoz, templates);
exports.PtCoz = PtCoz;
