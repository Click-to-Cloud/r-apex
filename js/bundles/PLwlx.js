...
var PLwlx = function (_Component) {
  _inherits(PLwlx, _Component);

  function PLwlx() {
    _classCallCheck(this, PLwlx);

    return _possibleConstructorReturn(this, (PLwlx.__proto__ || Object.getPrototypeOf(PLwlx)).apply(this, arguments));
  }
...
_metalSoy2.default.register(PLwlx, _methodsSoy2.default);

exports.default = PLwlx;
...
exports.templates = exports.PLwlx = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace PLwlx.
   * @public
   */

  goog.module('PLwlx.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'PLwlx.render';
  }
...
_metalSoy2.default.register(PLwlx, templates);
exports.PLwlx = PLwlx;
