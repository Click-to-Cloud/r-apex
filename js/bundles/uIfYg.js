...
var uIfYg = function (_Component) {
  _inherits(uIfYg, _Component);

  function uIfYg() {
    _classCallCheck(this, uIfYg);

    return _possibleConstructorReturn(this, (uIfYg.__proto__ || Object.getPrototypeOf(uIfYg)).apply(this, arguments));
  }
...
_metalSoy2.default.register(uIfYg, _comparatorSoy2.default);

exports.default = uIfYg;
...
exports.templates = exports.uIfYg = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace uIfYg.
   * @public
   */

  goog.module('uIfYg.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'uIfYg.render';
  }
...
_metalSoy2.default.register(uIfYg, templates);
exports.uIfYg = uIfYg;
