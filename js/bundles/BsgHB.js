...
var BsgHB = function (_Component) {
  _inherits(BsgHB, _Component);

  function BsgHB() {
    _classCallCheck(this, BsgHB);

    return _possibleConstructorReturn(this, (BsgHB.__proto__ || Object.getPrototypeOf(BsgHB)).apply(this, arguments));
  }
...
_metalSoy2.default.register(BsgHB, _relationSoy2.default);

exports.default = BsgHB;
...
exports.templates = exports.BsgHB = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace BsgHB.
   * @public
   */

  goog.module('BsgHB.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param1171 = function param1171() {
      ie_open('h6');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param1171 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'BsgHB.render';
  }
...
_metalSoy2.default.register(BsgHB, templates);
exports.BsgHB = BsgHB;
