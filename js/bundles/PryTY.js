...
var PryTY = function (_Component) {
  _inherits(PryTY, _Component);

  function PryTY() {
    _classCallCheck(this, PryTY);

    return _possibleConstructorReturn(this, (PryTY.__proto__ || Object.getPrototypeOf(PryTY)).apply(this, arguments));
  }
...
_metalSoy2.default.register(PryTY, _step_8Soy2.default);

exports.default = PryTY;
...
exports.templates = exports.PryTY = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace PryTY.
   * @public
   */

  goog.module('PryTY.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'PryTY.render';
  }
...
_metalSoy2.default.register(PryTY, templates);
exports.PryTY = PryTY;
