...
var wOomI = function (_Component) {
  _inherits(wOomI, _Component);

  function wOomI() {
    _classCallCheck(this, wOomI);

    return _possibleConstructorReturn(this, (wOomI.__proto__ || Object.getPrototypeOf(wOomI)).apply(this, arguments));
  }
...
_metalSoy2.default.register(wOomI, _logicSoy2.default);

exports.default = wOomI;
...
exports.templates = exports.wOomI = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace wOomI.
   * @public
   */

  goog.module('wOomI.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param1643 = function param1643() {
      ie_open('h6');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param1643 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'wOomI.render';
  }
...
_metalSoy2.default.register(wOomI, templates);
exports.wOomI = wOomI;
