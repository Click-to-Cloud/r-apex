...
var QBsWW = function (_Component) {
  _inherits(QBsWW, _Component);

  function QBsWW() {
    _classCallCheck(this, QBsWW);

    return _possibleConstructorReturn(this, (QBsWW.__proto__ || Object.getPrototypeOf(QBsWW)).apply(this, arguments));
  }
...
_metalSoy2.default.register(QBsWW, _mapSoy2.default);

exports.default = QBsWW;
...
exports.templates = exports.QBsWW = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace QBsWW.
   * @public
   */

  goog.module('QBsWW.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'QBsWW.render';
  }
...
_metalSoy2.default.register(QBsWW, templates);
exports.QBsWW = QBsWW;
