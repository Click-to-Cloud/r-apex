...
var QVKJk = function (_Component) {
  _inherits(QVKJk, _Component);

  function QVKJk() {
    _classCallCheck(this, QVKJk);

    return _possibleConstructorReturn(this, (QVKJk.__proto__ || Object.getPrototypeOf(QVKJk)).apply(this, arguments));
  }
...
_metalSoy2.default.register(QVKJk, _utilitySoy2.default);

exports.default = QVKJk;
...
exports.templates = exports.QVKJk = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace QVKJk.
   * @public
   */

  goog.module('QVKJk.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'QVKJk.render';
  }
...
_metalSoy2.default.register(QVKJk, templates);
exports.QVKJk = QVKJk;
