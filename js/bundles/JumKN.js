...
var JumKN = function (_Component) {
  _inherits(JumKN, _Component);

  function JumKN() {
    _classCallCheck(this, JumKN);

    return _possibleConstructorReturn(this, (JumKN.__proto__ || Object.getPrototypeOf(JumKN)).apply(this, arguments));
  }
...
_metalSoy2.default.register(JumKN, _utilitySoy2.default);

exports.default = JumKN;
...
exports.templates = exports.JumKN = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace JumKN.
   * @public
   */

  goog.module('JumKN.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param1887 = function param1887() {
      ie_open('h6');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param1887 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'JumKN.render';
  }
...
_metalSoy2.default.register(JumKN, templates);
exports.JumKN = JumKN;
