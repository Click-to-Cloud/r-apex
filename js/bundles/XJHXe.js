...
var XJHXe = function (_Component) {
  _inherits(XJHXe, _Component);

  function XJHXe() {
    _classCallCheck(this, XJHXe);

    return _possibleConstructorReturn(this, (XJHXe.__proto__ || Object.getPrototypeOf(XJHXe)).apply(this, arguments));
  }
...
_metalSoy2.default.register(XJHXe, _conversionSoy2.default);

exports.default = XJHXe;
...
exports.templates = exports.XJHXe = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace XJHXe.
   * @public
   */

  goog.module('XJHXe.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'XJHXe.render';
  }
...
_metalSoy2.default.register(XJHXe, templates);
exports.XJHXe = XJHXe;
