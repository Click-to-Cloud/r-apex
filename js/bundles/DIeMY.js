...
var DIeMY = function (_Component) {
  _inherits(DIeMY, _Component);

  function DIeMY() {
    _classCallCheck(this, DIeMY);

    return _possibleConstructorReturn(this, (DIeMY.__proto__ || Object.getPrototypeOf(DIeMY)).apply(this, arguments));
  }
...
_metalSoy2.default.register(DIeMY, _listSoy2.default);

exports.default = DIeMY;
...
exports.templates = exports.DIeMY = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace DIeMY.
   * @public
   */

  goog.module('DIeMY.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'DIeMY.render';
  }
...
_metalSoy2.default.register(DIeMY, templates);
exports.DIeMY = DIeMY;
