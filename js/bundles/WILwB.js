...
var WILwB = function (_Component) {
  _inherits(WILwB, _Component);

  function WILwB() {
    _classCallCheck(this, WILwB);

    return _possibleConstructorReturn(this, (WILwB.__proto__ || Object.getPrototypeOf(WILwB)).apply(this, arguments));
  }
...
_metalSoy2.default.register(WILwB, _databaseSoy2.default);

exports.default = WILwB;
...
exports.templates = exports.WILwB = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace WILwB.
   * @public
   */

  goog.module('WILwB.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'WILwB.render';
  }
...
_metalSoy2.default.register(WILwB, templates);
exports.WILwB = WILwB;
