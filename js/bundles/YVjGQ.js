...
var YVjGQ = function (_Component) {
  _inherits(YVjGQ, _Component);

  function YVjGQ() {
    _classCallCheck(this, YVjGQ);

    return _possibleConstructorReturn(this, (YVjGQ.__proto__ || Object.getPrototypeOf(YVjGQ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(YVjGQ, _logicSoy2.default);

exports.default = YVjGQ;
...
exports.templates = exports.YVjGQ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace YVjGQ.
   * @public
   */

  goog.module('YVjGQ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'YVjGQ.render';
  }
...
_metalSoy2.default.register(YVjGQ, templates);
exports.YVjGQ = YVjGQ;
