...
var UTLeJ = function (_Component) {
  _inherits(UTLeJ, _Component);

  function UTLeJ() {
    _classCallCheck(this, UTLeJ);

    return _possibleConstructorReturn(this, (UTLeJ.__proto__ || Object.getPrototypeOf(UTLeJ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(UTLeJ, _step_7Soy2.default);

exports.default = UTLeJ;
...
exports.templates = exports.UTLeJ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace UTLeJ.
   * @public
   */

  goog.module('UTLeJ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'UTLeJ.render';
  }
...
_metalSoy2.default.register(UTLeJ, templates);
exports.UTLeJ = UTLeJ;
