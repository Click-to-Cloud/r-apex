...
var _stringSoy = __webpack_require__(293);
...
var YOwQL = function (_Component) {
  _inherits(YOwQL, _Component);

  function YOwQL() {
    _classCallCheck(this, YOwQL);

    return _possibleConstructorReturn(this, (YOwQL.__proto__ || Object.getPrototypeOf(YOwQL)).apply(this, arguments));
  }
...
_metalSoy2.default.register(YOwQL, _stringSoy2.default);

exports.default = YOwQL;
...
exports.templates = exports.YOwQL = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace YOwQL.
   * @public
   */

  goog.module('YOwQL.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param1816 = function param1816() {
      ie_open('h6');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param1816 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'YOwQL.render';
  }
...
_metalSoy2.default.register(YOwQL, templates);
exports.YOwQL = YOwQL;
