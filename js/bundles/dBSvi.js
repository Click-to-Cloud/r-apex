...
var dBSvi = function (_Component) {
  _inherits(dBSvi, _Component);

  function dBSvi() {
    _classCallCheck(this, dBSvi);

    return _possibleConstructorReturn(this, (dBSvi.__proto__ || Object.getPrototypeOf(dBSvi)).apply(this, arguments));
  }
...
_metalSoy2.default.register(dBSvi, _step_4Soy2.default);

exports.default = dBSvi;
...
exports.templates = exports.dBSvi = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace dBSvi.
   * @public
   */

  goog.module('dBSvi.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'dBSvi.render';
  }
...
_metalSoy2.default.register(dBSvi, templates);
exports.dBSvi = dBSvi;
