...
var wMDgr = function (_Component) {
  _inherits(wMDgr, _Component);

  function wMDgr() {
    _classCallCheck(this, wMDgr);

    return _possibleConstructorReturn(this, (wMDgr.__proto__ || Object.getPrototypeOf(wMDgr)).apply(this, arguments));
  }
...
_metalSoy2.default.register(wMDgr, _creationSoy2.default);

exports.default = wMDgr;
...
exports.templates = exports.wMDgr = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace wMDgr.
   * @public
   */

  goog.module('wMDgr.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'wMDgr.render';
  }
...
_metalSoy2.default.register(wMDgr, templates);
exports.wMDgr = wMDgr;
