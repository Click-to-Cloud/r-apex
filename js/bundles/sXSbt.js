...
var _mapSoy = __webpack_require__(297);
...
var sXSbt = function (_Component) {
  _inherits(sXSbt, _Component);

  function sXSbt() {
    _classCallCheck(this, sXSbt);

    return _possibleConstructorReturn(this, (sXSbt.__proto__ || Object.getPrototypeOf(sXSbt)).apply(this, arguments));
  }
...
_metalSoy2.default.register(sXSbt, _mapSoy2.default);

exports.default = sXSbt;
...
exports.templates = exports.sXSbt = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace sXSbt.
   * @public
   */

  goog.module('sXSbt.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param1679 = function param1679() {
      ie_open('h6');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'sXSbt.render';
  }
...
_metalSoy2.default.register(sXSbt, templates);
exports.sXSbt = sXSbt;
