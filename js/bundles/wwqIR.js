...
var wwqIR = function (_Component) {
  _inherits(wwqIR, _Component);

  function wwqIR() {
    _classCallCheck(this, wwqIR);

    return _possibleConstructorReturn(this, (wwqIR.__proto__ || Object.getPrototypeOf(wwqIR)).apply(this, arguments));
  }
...
_metalSoy2.default.register(wwqIR, _step_4Soy2.default);

exports.default = wwqIR;
...
exports.templates = exports.wwqIR = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace wwqIR.
   * @public
   */

  goog.module('wwqIR.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'wwqIR.render';
  }
...
_metalSoy2.default.register(wwqIR, templates);
exports.wwqIR = wwqIR;
