...
var DgoWy = function (_Component) {
  _inherits(DgoWy, _Component);

  function DgoWy() {
    _classCallCheck(this, DgoWy);

    return _possibleConstructorReturn(this, (DgoWy.__proto__ || Object.getPrototypeOf(DgoWy)).apply(this, arguments));
  }
...
_metalSoy2.default.register(DgoWy, _step_4Soy2.default);

exports.default = DgoWy;
...
exports.templates = exports.DgoWy = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace DgoWy.
   * @public
   */

  goog.module('DgoWy.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'DgoWy.render';
  }
...
_metalSoy2.default.register(DgoWy, templates);
exports.DgoWy = DgoWy;
