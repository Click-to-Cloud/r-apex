...
var hBrup = function (_Component) {
  _inherits(hBrup, _Component);

  function hBrup() {
    _classCallCheck(this, hBrup);

    return _possibleConstructorReturn(this, (hBrup.__proto__ || Object.getPrototypeOf(hBrup)).apply(this, arguments));
  }
...
_metalSoy2.default.register(hBrup, _step_3Soy2.default);

exports.default = hBrup;
...
exports.templates = exports.hBrup = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace hBrup.
   * @public
   */

  goog.module('hBrup.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'hBrup.render';
  }
...
_metalSoy2.default.register(hBrup, templates);
exports.hBrup = hBrup;
