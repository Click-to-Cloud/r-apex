...
var eyCtT = function (_Component) {
  _inherits(eyCtT, _Component);

  function eyCtT() {
    _classCallCheck(this, eyCtT);

    return _possibleConstructorReturn(this, (eyCtT.__proto__ || Object.getPrototypeOf(eyCtT)).apply(this, arguments));
  }
...
_metalSoy2.default.register(eyCtT, _step_8Soy2.default);

exports.default = eyCtT;
...
exports.templates = exports.eyCtT = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace eyCtT.
   * @public
   */

  goog.module('eyCtT.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'eyCtT.render';
  }
...
_metalSoy2.default.register(eyCtT, templates);
exports.eyCtT = eyCtT;
