...
var gurQX = function (_Component) {
  _inherits(gurQX, _Component);

  function gurQX() {
    _classCallCheck(this, gurQX);

    return _possibleConstructorReturn(this, (gurQX.__proto__ || Object.getPrototypeOf(gurQX)).apply(this, arguments));
  }
...
_metalSoy2.default.register(gurQX, _step_4Soy2.default);

exports.default = gurQX;
...
exports.templates = exports.gurQX = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace gurQX.
   * @public
   */

  goog.module('gurQX.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param2026 = function param2026() {
      ie_open('h2');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param2026 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'gurQX.render';
  }
...
_metalSoy2.default.register(gurQX, templates);
exports.gurQX = gurQX;
