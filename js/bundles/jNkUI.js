...
var jNkUI = function (_Component) {
  _inherits(jNkUI, _Component);

  function jNkUI() {
    _classCallCheck(this, jNkUI);

    return _possibleConstructorReturn(this, (jNkUI.__proto__ || Object.getPrototypeOf(jNkUI)).apply(this, arguments));
  }
...
_metalSoy2.default.register(jNkUI, _step_2Soy2.default);

exports.default = jNkUI;
...
exports.templates = exports.jNkUI = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace jNkUI.
   * @public
   */

  goog.module('jNkUI.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param1974 = function param1974() {
      ie_open('h2');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param1974 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'jNkUI.render';
  }
...
_metalSoy2.default.register(jNkUI, templates);
exports.jNkUI = jNkUI;
