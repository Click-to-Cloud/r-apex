...
var eQZpi = function (_Component) {
  _inherits(eQZpi, _Component);

  function eQZpi() {
    _classCallCheck(this, eQZpi);

    return _possibleConstructorReturn(this, (eQZpi.__proto__ || Object.getPrototypeOf(eQZpi)).apply(this, arguments));
  }
...
_metalSoy2.default.register(eQZpi, _methodsSoy2.default);

exports.default = eQZpi;
...
exports.templates = exports.eQZpi = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace eQZpi.
   * @public
   */

  goog.module('eQZpi.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'eQZpi.render';
  }
...
_metalSoy2.default.register(eQZpi, templates);
exports.eQZpi = eQZpi;
