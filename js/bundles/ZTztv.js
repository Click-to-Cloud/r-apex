...
var ZTztv = function (_Component) {
  _inherits(ZTztv, _Component);

  function ZTztv() {
    _classCallCheck(this, ZTztv);

    return _possibleConstructorReturn(this, (ZTztv.__proto__ || Object.getPrototypeOf(ZTztv)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ZTztv, _step_4Soy2.default);

exports.default = ZTztv;
...
exports.templates = exports.ZTztv = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ZTztv.
   * @public
   */

  goog.module('ZTztv.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ZTztv.render';
  }
...
_metalSoy2.default.register(ZTztv, templates);
exports.ZTztv = ZTztv;
