...
var ovEpS = function (_Component) {
  _inherits(ovEpS, _Component);

  function ovEpS() {
    _classCallCheck(this, ovEpS);

    return _possibleConstructorReturn(this, (ovEpS.__proto__ || Object.getPrototypeOf(ovEpS)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ovEpS, _comparatorSoy2.default);

exports.default = ovEpS;
...
exports.templates = exports.ovEpS = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ovEpS.
   * @public
   */

  goog.module('ovEpS.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ovEpS.render';
  }
...
_metalSoy2.default.register(ovEpS, templates);
exports.ovEpS = ovEpS;
