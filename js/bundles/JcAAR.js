...
var JcAAR = function (_Component) {
  _inherits(JcAAR, _Component);

  function JcAAR() {
    _classCallCheck(this, JcAAR);

    return _possibleConstructorReturn(this, (JcAAR.__proto__ || Object.getPrototypeOf(JcAAR)).apply(this, arguments));
  }
...
_metalSoy2.default.register(JcAAR, _indexSoy2.default);

exports.default = JcAAR;
...
exports.templates = exports.JcAAR = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace JcAAR.
   * @public
   */

  goog.module('JcAAR.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'JcAAR.render';
  }
...
_metalSoy2.default.register(JcAAR, templates);
exports.JcAAR = JcAAR;
