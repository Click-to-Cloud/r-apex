...
var TOMak = function (_Component) {
  _inherits(TOMak, _Component);

  function TOMak() {
    _classCallCheck(this, TOMak);

    return _possibleConstructorReturn(this, (TOMak.__proto__ || Object.getPrototypeOf(TOMak)).apply(this, arguments));
  }
...
_metalSoy2.default.register(TOMak, _step_7Soy2.default);

exports.default = TOMak;
...
exports.templates = exports.TOMak = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace TOMak.
   * @public
   */

  goog.module('TOMak.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'TOMak.render';
  }
...
_metalSoy2.default.register(TOMak, templates);
exports.TOMak = TOMak;
