...
var EsKcJ = function (_Component) {
  _inherits(EsKcJ, _Component);

  function EsKcJ() {
    _classCallCheck(this, EsKcJ);

    return _possibleConstructorReturn(this, (EsKcJ.__proto__ || Object.getPrototypeOf(EsKcJ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(EsKcJ, _indexSoy2.default);

exports.default = EsKcJ;
...
exports.templates = exports.EsKcJ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace EsKcJ.
   * @public
   */

  goog.module('EsKcJ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'EsKcJ.render';
  }
...
_metalSoy2.default.register(EsKcJ, templates);
exports.EsKcJ = EsKcJ;
