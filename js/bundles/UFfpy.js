...
var UFfpy = function (_Component) {
  _inherits(UFfpy, _Component);

  function UFfpy() {
    _classCallCheck(this, UFfpy);

    return _possibleConstructorReturn(this, (UFfpy.__proto__ || Object.getPrototypeOf(UFfpy)).apply(this, arguments));
  }
...
_metalSoy2.default.register(UFfpy, _comparatorSoy2.default);

exports.default = UFfpy;
...
exports.templates = exports.UFfpy = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace UFfpy.
   * @public
   */

  goog.module('UFfpy.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'UFfpy.render';
  }
...
_metalSoy2.default.register(UFfpy, templates);
exports.UFfpy = UFfpy;
