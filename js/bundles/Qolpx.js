...
var Qolpx = function (_Component) {
  _inherits(Qolpx, _Component);

  function Qolpx() {
    _classCallCheck(this, Qolpx);

    return _possibleConstructorReturn(this, (Qolpx.__proto__ || Object.getPrototypeOf(Qolpx)).apply(this, arguments));
  }
...
_metalSoy2.default.register(Qolpx, _step_2Soy2.default);

exports.default = Qolpx;
...
exports.templates = exports.Qolpx = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace Qolpx.
   * @public
   */

  goog.module('Qolpx.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param1979 = function param1979() {
      ie_open('h2');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param1979 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'Qolpx.render';
  }
...
_metalSoy2.default.register(Qolpx, templates);
exports.Qolpx = Qolpx;
