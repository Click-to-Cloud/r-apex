...
var sgGta = function (_Component) {
  _inherits(sgGta, _Component);

  function sgGta() {
    _classCallCheck(this, sgGta);

    return _possibleConstructorReturn(this, (sgGta.__proto__ || Object.getPrototypeOf(sgGta)).apply(this, arguments));
  }
...
_metalSoy2.default.register(sgGta, _indexSoy2.default);

exports.default = sgGta;
...
exports.templates = exports.sgGta = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace sgGta.
   * @public
   */

  goog.module('sgGta.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'sgGta.render';
  }
...
_metalSoy2.default.register(sgGta, templates);
exports.sgGta = sgGta;
