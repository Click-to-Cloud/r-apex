...
var SxBYS = function (_Component) {
  _inherits(SxBYS, _Component);

  function SxBYS() {
    _classCallCheck(this, SxBYS);

    return _possibleConstructorReturn(this, (SxBYS.__proto__ || Object.getPrototypeOf(SxBYS)).apply(this, arguments));
  }
...
_metalSoy2.default.register(SxBYS, _step_8Soy2.default);

exports.default = SxBYS;
...
exports.templates = exports.SxBYS = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace SxBYS.
   * @public
   */

  goog.module('SxBYS.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param2130 = function param2130() {
      ie_open('h2');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param2130 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'SxBYS.render';
  }
...
_metalSoy2.default.register(SxBYS, templates);
exports.SxBYS = SxBYS;
