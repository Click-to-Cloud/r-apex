...
var mvCaD = function (_Component) {
  _inherits(mvCaD, _Component);

  function mvCaD() {
    _classCallCheck(this, mvCaD);

    return _possibleConstructorReturn(this, (mvCaD.__proto__ || Object.getPrototypeOf(mvCaD)).apply(this, arguments));
  }
...
_metalSoy2.default.register(mvCaD, _indexSoy2.default);

exports.default = mvCaD;
...
exports.templates = exports.mvCaD = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace mvCaD.
   * @public
   */

  goog.module('mvCaD.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'mvCaD.render';
  }
...
_metalSoy2.default.register(mvCaD, templates);
exports.mvCaD = mvCaD;
