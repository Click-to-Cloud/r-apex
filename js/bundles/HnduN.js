...
var HnduN = function (_Component) {
  _inherits(HnduN, _Component);

  function HnduN() {
    _classCallCheck(this, HnduN);

    return _possibleConstructorReturn(this, (HnduN.__proto__ || Object.getPrototypeOf(HnduN)).apply(this, arguments));
  }
...
_metalSoy2.default.register(HnduN, _conditionSoy2.default);

exports.default = HnduN;
...
exports.templates = exports.HnduN = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace HnduN.
   * @public
   */

  goog.module('HnduN.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'HnduN.render';
  }
...
_metalSoy2.default.register(HnduN, templates);
exports.HnduN = HnduN;
