...
var XfwiI = function (_Component) {
  _inherits(XfwiI, _Component);

  function XfwiI() {
    _classCallCheck(this, XfwiI);

    return _possibleConstructorReturn(this, (XfwiI.__proto__ || Object.getPrototypeOf(XfwiI)).apply(this, arguments));
  }
...
_metalSoy2.default.register(XfwiI, _step_3Soy2.default);

exports.default = XfwiI;
...
exports.templates = exports.XfwiI = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace XfwiI.
   * @public
   */

  goog.module('XfwiI.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'XfwiI.render';
  }
...
_metalSoy2.default.register(XfwiI, templates);
exports.XfwiI = XfwiI;
