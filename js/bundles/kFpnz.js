...
var kFpnz = function (_Component) {
  _inherits(kFpnz, _Component);

  function kFpnz() {
    _classCallCheck(this, kFpnz);

    return _possibleConstructorReturn(this, (kFpnz.__proto__ || Object.getPrototypeOf(kFpnz)).apply(this, arguments));
  }
...
_metalSoy2.default.register(kFpnz, _utilitySoy2.default);

exports.default = kFpnz;
...
exports.templates = exports.kFpnz = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace kFpnz.
   * @public
   */

  goog.module('kFpnz.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'kFpnz.render';
  }
...
_metalSoy2.default.register(kFpnz, templates);
exports.kFpnz = kFpnz;
