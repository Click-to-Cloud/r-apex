...
var ioutx = function (_Component) {
  _inherits(ioutx, _Component);

  function ioutx() {
    _classCallCheck(this, ioutx);

    return _possibleConstructorReturn(this, (ioutx.__proto__ || Object.getPrototypeOf(ioutx)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ioutx, _conversionSoy2.default);

exports.default = ioutx;
...
exports.templates = exports.ioutx = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ioutx.
   * @public
   */

  goog.module('ioutx.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ioutx.render';
  }
...
_metalSoy2.default.register(ioutx, templates);
exports.ioutx = ioutx;
