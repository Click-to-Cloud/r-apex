...
var nZpIH = function (_Component) {
  _inherits(nZpIH, _Component);

  function nZpIH() {
    _classCallCheck(this, nZpIH);

    return _possibleConstructorReturn(this, (nZpIH.__proto__ || Object.getPrototypeOf(nZpIH)).apply(this, arguments));
  }
...
_metalSoy2.default.register(nZpIH, _conversionSoy2.default);

exports.default = nZpIH;
...
exports.templates = exports.nZpIH = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace nZpIH.
   * @public
   */

  goog.module('nZpIH.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'nZpIH.render';
  }
...
_metalSoy2.default.register(nZpIH, templates);
exports.nZpIH = nZpIH;
