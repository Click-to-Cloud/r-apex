...
var eWJql = function (_Component) {
  _inherits(eWJql, _Component);

  function eWJql() {
    _classCallCheck(this, eWJql);

    return _possibleConstructorReturn(this, (eWJql.__proto__ || Object.getPrototypeOf(eWJql)).apply(this, arguments));
  }
...
_metalSoy2.default.register(eWJql, _functionSoy2.default);

exports.default = eWJql;
...
exports.templates = exports.eWJql = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace eWJql.
   * @public
   */

  goog.module('eWJql.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'eWJql.render';
  }
...
_metalSoy2.default.register(eWJql, templates);
exports.eWJql = eWJql;
