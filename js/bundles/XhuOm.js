...
var XhuOm = function (_Component) {
  _inherits(XhuOm, _Component);

  function XhuOm() {
    _classCallCheck(this, XhuOm);

    return _possibleConstructorReturn(this, (XhuOm.__proto__ || Object.getPrototypeOf(XhuOm)).apply(this, arguments));
  }
...
_metalSoy2.default.register(XhuOm, _conditionSoy2.default);

exports.default = XhuOm;
...
exports.templates = exports.XhuOm = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace XhuOm.
   * @public
   */

  goog.module('XhuOm.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'XhuOm.render';
  }
...
_metalSoy2.default.register(XhuOm, templates);
exports.XhuOm = XhuOm;
