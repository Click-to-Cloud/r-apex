...
var _creationSoy = __webpack_require__(297);
...
var Rogtl = function (_Component) {
  _inherits(Rogtl, _Component);

  function Rogtl() {
    _classCallCheck(this, Rogtl);

    return _possibleConstructorReturn(this, (Rogtl.__proto__ || Object.getPrototypeOf(Rogtl)).apply(this, arguments));
  }
...
_metalSoy2.default.register(Rogtl, _creationSoy2.default);

exports.default = Rogtl;
...
exports.templates = exports.Rogtl = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace Rogtl.
   * @public
   */

  goog.module('Rogtl.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param1319 = function param1319() {
      ie_open('h6');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'Rogtl.render';
  }
...
_metalSoy2.default.register(Rogtl, templates);
exports.Rogtl = Rogtl;
