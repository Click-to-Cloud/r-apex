...
var MPsRi = function (_Component) {
  _inherits(MPsRi, _Component);

  function MPsRi() {
    _classCallCheck(this, MPsRi);

    return _possibleConstructorReturn(this, (MPsRi.__proto__ || Object.getPrototypeOf(MPsRi)).apply(this, arguments));
  }
...
_metalSoy2.default.register(MPsRi, _creationSoy2.default);

exports.default = MPsRi;
...
exports.templates = exports.MPsRi = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace MPsRi.
   * @public
   */

  goog.module('MPsRi.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'MPsRi.render';
  }
...
_metalSoy2.default.register(MPsRi, templates);
exports.MPsRi = MPsRi;
