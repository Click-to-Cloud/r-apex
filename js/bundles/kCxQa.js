...
var kCxQa = function (_Component) {
  _inherits(kCxQa, _Component);

  function kCxQa() {
    _classCallCheck(this, kCxQa);

    return _possibleConstructorReturn(this, (kCxQa.__proto__ || Object.getPrototypeOf(kCxQa)).apply(this, arguments));
  }
...
_metalSoy2.default.register(kCxQa, _step_2Soy2.default);

exports.default = kCxQa;
...
exports.templates = exports.kCxQa = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace kCxQa.
   * @public
   */

  goog.module('kCxQa.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'kCxQa.render';
  }
...
_metalSoy2.default.register(kCxQa, templates);
exports.kCxQa = kCxQa;
