...
var wcssu = function (_Component) {
  _inherits(wcssu, _Component);

  function wcssu() {
    _classCallCheck(this, wcssu);

    return _possibleConstructorReturn(this, (wcssu.__proto__ || Object.getPrototypeOf(wcssu)).apply(this, arguments));
  }
...
_metalSoy2.default.register(wcssu, _functionSoy2.default);

exports.default = wcssu;
...
exports.templates = exports.wcssu = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace wcssu.
   * @public
   */

  goog.module('wcssu.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'wcssu.render';
  }
...
_metalSoy2.default.register(wcssu, templates);
exports.wcssu = wcssu;
