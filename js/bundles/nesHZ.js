...
var nesHZ = function (_Component) {
  _inherits(nesHZ, _Component);

  function nesHZ() {
    _classCallCheck(this, nesHZ);

    return _possibleConstructorReturn(this, (nesHZ.__proto__ || Object.getPrototypeOf(nesHZ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(nesHZ, _indexSoy2.default);

exports.default = nesHZ;
...
exports.templates = exports.nesHZ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace nesHZ.
   * @public
   */

  goog.module('nesHZ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'nesHZ.render';
  }
...
_metalSoy2.default.register(nesHZ, templates);
exports.nesHZ = nesHZ;
