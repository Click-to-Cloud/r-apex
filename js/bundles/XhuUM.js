...
var XhuUM = function (_Component) {
  _inherits(XhuUM, _Component);

  function XhuUM() {
    _classCallCheck(this, XhuUM);

    return _possibleConstructorReturn(this, (XhuUM.__proto__ || Object.getPrototypeOf(XhuUM)).apply(this, arguments));
  }
...
_metalSoy2.default.register(XhuUM, _step_6Soy2.default);

exports.default = XhuUM;
...
exports.templates = exports.XhuUM = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace XhuUM.
   * @public
   */

  goog.module('XhuUM.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param2058 = function param2058() {
      ie_open('h2');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param2058 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'XhuUM.render';
  }
...
_metalSoy2.default.register(XhuUM, templates);
exports.XhuUM = XhuUM;
