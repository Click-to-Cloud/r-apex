...
var DIHNy = function (_Component) {
  _inherits(DIHNy, _Component);

  function DIHNy() {
    _classCallCheck(this, DIHNy);

    return _possibleConstructorReturn(this, (DIHNy.__proto__ || Object.getPrototypeOf(DIHNy)).apply(this, arguments));
  }
...
_metalSoy2.default.register(DIHNy, _relationSoy2.default);

exports.default = DIHNy;
...
exports.templates = exports.DIHNy = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace DIHNy.
   * @public
   */

  goog.module('DIHNy.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'DIHNy.render';
  }
...
_metalSoy2.default.register(DIHNy, templates);
exports.DIHNy = DIHNy;
