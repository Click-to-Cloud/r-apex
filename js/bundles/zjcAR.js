...
var zjcAR = function (_Component) {
  _inherits(zjcAR, _Component);

  function zjcAR() {
    _classCallCheck(this, zjcAR);

    return _possibleConstructorReturn(this, (zjcAR.__proto__ || Object.getPrototypeOf(zjcAR)).apply(this, arguments));
  }
...
_metalSoy2.default.register(zjcAR, _comparatorSoy2.default);

exports.default = zjcAR;
...
exports.templates = exports.zjcAR = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace zjcAR.
   * @public
   */

  goog.module('zjcAR.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'zjcAR.render';
  }
...
_metalSoy2.default.register(zjcAR, templates);
exports.zjcAR = zjcAR;
