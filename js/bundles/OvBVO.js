...
var OvBVO = function (_Component) {
  _inherits(OvBVO, _Component);

  function OvBVO() {
    _classCallCheck(this, OvBVO);

    return _possibleConstructorReturn(this, (OvBVO.__proto__ || Object.getPrototypeOf(OvBVO)).apply(this, arguments));
  }
...
_metalSoy2.default.register(OvBVO, _step_3Soy2.default);

exports.default = OvBVO;
...
exports.templates = exports.OvBVO = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace OvBVO.
   * @public
   */

  goog.module('OvBVO.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'OvBVO.render';
  }
...
_metalSoy2.default.register(OvBVO, templates);
exports.OvBVO = OvBVO;
