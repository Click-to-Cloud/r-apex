...
var ZDHDE = function (_Component) {
  _inherits(ZDHDE, _Component);

  function ZDHDE() {
    _classCallCheck(this, ZDHDE);

    return _possibleConstructorReturn(this, (ZDHDE.__proto__ || Object.getPrototypeOf(ZDHDE)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ZDHDE, _relationSoy2.default);

exports.default = ZDHDE;
...
exports.templates = exports.ZDHDE = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ZDHDE.
   * @public
   */

  goog.module('ZDHDE.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ZDHDE.render';
  }
...
_metalSoy2.default.register(ZDHDE, templates);
exports.ZDHDE = ZDHDE;
