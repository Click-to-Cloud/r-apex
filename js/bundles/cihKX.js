...
var _functionSoy = __webpack_require__(297);
...
var cihKX = function (_Component) {
  _inherits(cihKX, _Component);

  function cihKX() {
    _classCallCheck(this, cihKX);

    return _possibleConstructorReturn(this, (cihKX.__proto__ || Object.getPrototypeOf(cihKX)).apply(this, arguments));
  }
...
_metalSoy2.default.register(cihKX, _functionSoy2.default);

exports.default = cihKX;
...
exports.templates = exports.cihKX = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace cihKX.
   * @public
   */

  goog.module('cihKX.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'cihKX.render';
  }
...
_metalSoy2.default.register(cihKX, templates);
exports.cihKX = cihKX;
