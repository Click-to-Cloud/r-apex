...
var GSvUk = function (_Component) {
  _inherits(GSvUk, _Component);

  function GSvUk() {
    _classCallCheck(this, GSvUk);

    return _possibleConstructorReturn(this, (GSvUk.__proto__ || Object.getPrototypeOf(GSvUk)).apply(this, arguments));
  }
...
_metalSoy2.default.register(GSvUk, _step_7Soy2.default);

exports.default = GSvUk;
...
exports.templates = exports.GSvUk = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace GSvUk.
   * @public
   */

  goog.module('GSvUk.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param2109 = function param2109() {
      ie_open('h2');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param2109 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'GSvUk.render';
  }
...
_metalSoy2.default.register(GSvUk, templates);
exports.GSvUk = GSvUk;
