...
var OUiDc = function (_Component) {
  _inherits(OUiDc, _Component);

  function OUiDc() {
    _classCallCheck(this, OUiDc);

    return _possibleConstructorReturn(this, (OUiDc.__proto__ || Object.getPrototypeOf(OUiDc)).apply(this, arguments));
  }
...
_metalSoy2.default.register(OUiDc, _creationSoy2.default);

exports.default = OUiDc;
...
exports.templates = exports.OUiDc = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace OUiDc.
   * @public
   */

  goog.module('OUiDc.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param1360 = function param1360() {
      ie_open('h6');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param1360 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'OUiDc.render';
  }
...
_metalSoy2.default.register(OUiDc, templates);
exports.OUiDc = OUiDc;
