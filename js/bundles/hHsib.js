...
var hHsib = function (_Component) {
  _inherits(hHsib, _Component);

  function hHsib() {
    _classCallCheck(this, hHsib);

    return _possibleConstructorReturn(this, (hHsib.__proto__ || Object.getPrototypeOf(hHsib)).apply(this, arguments));
  }
...
_metalSoy2.default.register(hHsib, _arithmeticSoy2.default);

exports.default = hHsib;
...
exports.templates = exports.hHsib = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace hHsib.
   * @public
   */

  goog.module('hHsib.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'hHsib.render';
  }
...
_metalSoy2.default.register(hHsib, templates);
exports.hHsib = hHsib;
