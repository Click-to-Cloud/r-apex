...
var cFvRn = function (_Component) {
  _inherits(cFvRn, _Component);

  function cFvRn() {
    _classCallCheck(this, cFvRn);

    return _possibleConstructorReturn(this, (cFvRn.__proto__ || Object.getPrototypeOf(cFvRn)).apply(this, arguments));
  }
...
_metalSoy2.default.register(cFvRn, _utilitySoy2.default);

exports.default = cFvRn;
...
exports.templates = exports.cFvRn = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace cFvRn.
   * @public
   */

  goog.module('cFvRn.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'cFvRn.render';
  }
...
_metalSoy2.default.register(cFvRn, templates);
exports.cFvRn = cFvRn;
