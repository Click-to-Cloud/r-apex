...
var kOsap = function (_Component) {
  _inherits(kOsap, _Component);

  function kOsap() {
    _classCallCheck(this, kOsap);

    return _possibleConstructorReturn(this, (kOsap.__proto__ || Object.getPrototypeOf(kOsap)).apply(this, arguments));
  }
...
_metalSoy2.default.register(kOsap, _conditionSoy2.default);

exports.default = kOsap;
...
exports.templates = exports.kOsap = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace kOsap.
   * @public
   */

  goog.module('kOsap.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'kOsap.render';
  }
...
_metalSoy2.default.register(kOsap, templates);
exports.kOsap = kOsap;
