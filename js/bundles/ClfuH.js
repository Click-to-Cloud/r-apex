...
var ClfuH = function (_Component) {
  _inherits(ClfuH, _Component);

  function ClfuH() {
    _classCallCheck(this, ClfuH);

    return _possibleConstructorReturn(this, (ClfuH.__proto__ || Object.getPrototypeOf(ClfuH)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ClfuH, _step_2Soy2.default);

exports.default = ClfuH;
...
exports.templates = exports.ClfuH = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ClfuH.
   * @public
   */

  goog.module('ClfuH.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ClfuH.render';
  }
...
_metalSoy2.default.register(ClfuH, templates);
exports.ClfuH = ClfuH;
