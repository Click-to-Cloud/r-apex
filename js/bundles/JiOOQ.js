...
var JiOOQ = function (_Component) {
  _inherits(JiOOQ, _Component);

  function JiOOQ() {
    _classCallCheck(this, JiOOQ);

    return _possibleConstructorReturn(this, (JiOOQ.__proto__ || Object.getPrototypeOf(JiOOQ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(JiOOQ, _conversionSoy2.default);

exports.default = JiOOQ;
...
exports.templates = exports.JiOOQ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace JiOOQ.
   * @public
   */

  goog.module('JiOOQ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'JiOOQ.render';
  }
...
_metalSoy2.default.register(JiOOQ, templates);
exports.JiOOQ = JiOOQ;
