...
var BQLeE = function (_Component) {
  _inherits(BQLeE, _Component);

  function BQLeE() {
    _classCallCheck(this, BQLeE);

    return _possibleConstructorReturn(this, (BQLeE.__proto__ || Object.getPrototypeOf(BQLeE)).apply(this, arguments));
  }
...
_metalSoy2.default.register(BQLeE, _conditionSoy2.default);

exports.default = BQLeE;
...
exports.templates = exports.BQLeE = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace BQLeE.
   * @public
   */

  goog.module('BQLeE.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'BQLeE.render';
  }
...
_metalSoy2.default.register(BQLeE, templates);
exports.BQLeE = BQLeE;
