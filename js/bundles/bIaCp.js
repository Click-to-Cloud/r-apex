...
var bIaCp = function (_Component) {
  _inherits(bIaCp, _Component);

  function bIaCp() {
    _classCallCheck(this, bIaCp);

    return _possibleConstructorReturn(this, (bIaCp.__proto__ || Object.getPrototypeOf(bIaCp)).apply(this, arguments));
  }
...
_metalSoy2.default.register(bIaCp, _indexSoy2.default);

exports.default = bIaCp;
...
exports.templates = exports.bIaCp = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace bIaCp.
   * @public
   */

  goog.module('bIaCp.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'bIaCp.render';
  }
...
_metalSoy2.default.register(bIaCp, templates);
exports.bIaCp = bIaCp;
