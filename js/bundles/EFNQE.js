...
var EFNQE = function (_Component) {
  _inherits(EFNQE, _Component);

  function EFNQE() {
    _classCallCheck(this, EFNQE);

    return _possibleConstructorReturn(this, (EFNQE.__proto__ || Object.getPrototypeOf(EFNQE)).apply(this, arguments));
  }
...
_metalSoy2.default.register(EFNQE, _indexSoy2.default);

exports.default = EFNQE;
...
exports.templates = exports.EFNQE = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace EFNQE.
   * @public
   */

  goog.module('EFNQE.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'EFNQE.render';
  }
...
_metalSoy2.default.register(EFNQE, templates);
exports.EFNQE = EFNQE;
