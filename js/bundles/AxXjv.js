...
var AxXjv = function (_Component) {
  _inherits(AxXjv, _Component);

  function AxXjv() {
    _classCallCheck(this, AxXjv);

    return _possibleConstructorReturn(this, (AxXjv.__proto__ || Object.getPrototypeOf(AxXjv)).apply(this, arguments));
  }
...
_metalSoy2.default.register(AxXjv, _mapSoy2.default);

exports.default = AxXjv;
...
exports.templates = exports.AxXjv = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace AxXjv.
   * @public
   */

  goog.module('AxXjv.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'AxXjv.render';
  }
...
_metalSoy2.default.register(AxXjv, templates);
exports.AxXjv = AxXjv;
