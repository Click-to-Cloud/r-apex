...
var OTOgD = function (_Component) {
  _inherits(OTOgD, _Component);

  function OTOgD() {
    _classCallCheck(this, OTOgD);

    return _possibleConstructorReturn(this, (OTOgD.__proto__ || Object.getPrototypeOf(OTOgD)).apply(this, arguments));
  }
...
_metalSoy2.default.register(OTOgD, _creationSoy2.default);

exports.default = OTOgD;
...
exports.templates = exports.OTOgD = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace OTOgD.
   * @public
   */

  goog.module('OTOgD.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'OTOgD.render';
  }
...
_metalSoy2.default.register(OTOgD, templates);
exports.OTOgD = OTOgD;
