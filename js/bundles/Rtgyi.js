...
var Rtgyi = function (_Component) {
  _inherits(Rtgyi, _Component);

  function Rtgyi() {
    _classCallCheck(this, Rtgyi);

    return _possibleConstructorReturn(this, (Rtgyi.__proto__ || Object.getPrototypeOf(Rtgyi)).apply(this, arguments));
  }
...
_metalSoy2.default.register(Rtgyi, _functionSoy2.default);

exports.default = Rtgyi;
...
exports.templates = exports.Rtgyi = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace Rtgyi.
   * @public
   */

  goog.module('Rtgyi.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'Rtgyi.render';
  }
...
_metalSoy2.default.register(Rtgyi, templates);
exports.Rtgyi = Rtgyi;
