...
var Fdpji = function (_Component) {
  _inherits(Fdpji, _Component);

  function Fdpji() {
    _classCallCheck(this, Fdpji);

    return _possibleConstructorReturn(this, (Fdpji.__proto__ || Object.getPrototypeOf(Fdpji)).apply(this, arguments));
  }
...
_metalSoy2.default.register(Fdpji, _indexSoy2.default);

exports.default = Fdpji;
...
exports.templates = exports.Fdpji = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace Fdpji.
   * @public
   */

  goog.module('Fdpji.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'Fdpji.render';
  }
...
_metalSoy2.default.register(Fdpji, templates);
exports.Fdpji = Fdpji;
