...
var qxWLU = function (_Component) {
  _inherits(qxWLU, _Component);

  function qxWLU() {
    _classCallCheck(this, qxWLU);

    return _possibleConstructorReturn(this, (qxWLU.__proto__ || Object.getPrototypeOf(qxWLU)).apply(this, arguments));
  }
...
_metalSoy2.default.register(qxWLU, _utilitySoy2.default);

exports.default = qxWLU;
...
exports.templates = exports.qxWLU = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace qxWLU.
   * @public
   */

  goog.module('qxWLU.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'qxWLU.render';
  }
...
_metalSoy2.default.register(qxWLU, templates);
exports.qxWLU = qxWLU;
