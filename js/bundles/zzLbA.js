...
var zzLbA = function (_Component) {
  _inherits(zzLbA, _Component);

  function zzLbA() {
    _classCallCheck(this, zzLbA);

    return _possibleConstructorReturn(this, (zzLbA.__proto__ || Object.getPrototypeOf(zzLbA)).apply(this, arguments));
  }
...
_metalSoy2.default.register(zzLbA, _creationSoy2.default);

exports.default = zzLbA;
...
exports.templates = exports.zzLbA = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace zzLbA.
   * @public
   */

  goog.module('zzLbA.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param1390 = function param1390() {
      ie_open('h6');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'zzLbA.render';
  }
...
_metalSoy2.default.register(zzLbA, templates);
exports.zzLbA = zzLbA;
