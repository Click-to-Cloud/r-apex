...
var GznHh = function (_Component) {
  _inherits(GznHh, _Component);

  function GznHh() {
    _classCallCheck(this, GznHh);

    return _possibleConstructorReturn(this, (GznHh.__proto__ || Object.getPrototypeOf(GznHh)).apply(this, arguments));
  }
...
_metalSoy2.default.register(GznHh, _step_8Soy2.default);

exports.default = GznHh;
...
exports.templates = exports.GznHh = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace GznHh.
   * @public
   */

  goog.module('GznHh.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'GznHh.render';
  }
...
_metalSoy2.default.register(GznHh, templates);
exports.GznHh = GznHh;
