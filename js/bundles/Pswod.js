...
var Pswod = function (_Component) {
  _inherits(Pswod, _Component);

  function Pswod() {
    _classCallCheck(this, Pswod);

    return _possibleConstructorReturn(this, (Pswod.__proto__ || Object.getPrototypeOf(Pswod)).apply(this, arguments));
  }
...
_metalSoy2.default.register(Pswod, _logicSoy2.default);

exports.default = Pswod;
...
exports.templates = exports.Pswod = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace Pswod.
   * @public
   */

  goog.module('Pswod.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'Pswod.render';
  }
...
_metalSoy2.default.register(Pswod, templates);
exports.Pswod = Pswod;
