...
var eMRxv = function (_Component) {
  _inherits(eMRxv, _Component);

  function eMRxv() {
    _classCallCheck(this, eMRxv);

    return _possibleConstructorReturn(this, (eMRxv.__proto__ || Object.getPrototypeOf(eMRxv)).apply(this, arguments));
  }
...
_metalSoy2.default.register(eMRxv, _logicSoy2.default);

exports.default = eMRxv;
...
exports.templates = exports.eMRxv = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace eMRxv.
   * @public
   */

  goog.module('eMRxv.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'eMRxv.render';
  }
...
_metalSoy2.default.register(eMRxv, templates);
exports.eMRxv = eMRxv;
