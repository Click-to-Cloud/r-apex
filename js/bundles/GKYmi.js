...
var GKYmi = function (_Component) {
  _inherits(GKYmi, _Component);

  function GKYmi() {
    _classCallCheck(this, GKYmi);

    return _possibleConstructorReturn(this, (GKYmi.__proto__ || Object.getPrototypeOf(GKYmi)).apply(this, arguments));
  }
...
_metalSoy2.default.register(GKYmi, _listSoy2.default);

exports.default = GKYmi;
...
exports.templates = exports.GKYmi = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace GKYmi.
   * @public
   */

  goog.module('GKYmi.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param581 = function param581() {
      ie_open('h6');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'GKYmi.render';
  }
...
_metalSoy2.default.register(GKYmi, templates);
exports.GKYmi = GKYmi;
