...
var JJQdb = function (_Component) {
  _inherits(JJQdb, _Component);

  function JJQdb() {
    _classCallCheck(this, JJQdb);

    return _possibleConstructorReturn(this, (JJQdb.__proto__ || Object.getPrototypeOf(JJQdb)).apply(this, arguments));
  }
...
_metalSoy2.default.register(JJQdb, _relationSoy2.default);

exports.default = JJQdb;
...
exports.templates = exports.JJQdb = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace JJQdb.
   * @public
   */

  goog.module('JJQdb.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'JJQdb.render';
  }
...
_metalSoy2.default.register(JJQdb, templates);
exports.JJQdb = JJQdb;
