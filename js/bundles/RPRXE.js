...
var RPRXE = function (_Component) {
  _inherits(RPRXE, _Component);

  function RPRXE() {
    _classCallCheck(this, RPRXE);

    return _possibleConstructorReturn(this, (RPRXE.__proto__ || Object.getPrototypeOf(RPRXE)).apply(this, arguments));
  }
...
_metalSoy2.default.register(RPRXE, _step_5Soy2.default);

exports.default = RPRXE;
...
exports.templates = exports.RPRXE = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace RPRXE.
   * @public
   */

  goog.module('RPRXE.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'RPRXE.render';
  }
...
_metalSoy2.default.register(RPRXE, templates);
exports.RPRXE = RPRXE;
