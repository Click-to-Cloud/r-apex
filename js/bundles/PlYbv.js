...
var PlYbv = function (_Component) {
  _inherits(PlYbv, _Component);

  function PlYbv() {
    _classCallCheck(this, PlYbv);

    return _possibleConstructorReturn(this, (PlYbv.__proto__ || Object.getPrototypeOf(PlYbv)).apply(this, arguments));
  }
...
_metalSoy2.default.register(PlYbv, _stringSoy2.default);

exports.default = PlYbv;
...
exports.templates = exports.PlYbv = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace PlYbv.
   * @public
   */

  goog.module('PlYbv.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'PlYbv.render';
  }
...
_metalSoy2.default.register(PlYbv, templates);
exports.PlYbv = PlYbv;
