...
var twYFc = function (_Component) {
  _inherits(twYFc, _Component);

  function twYFc() {
    _classCallCheck(this, twYFc);

    return _possibleConstructorReturn(this, (twYFc.__proto__ || Object.getPrototypeOf(twYFc)).apply(this, arguments));
  }
...
_metalSoy2.default.register(twYFc, _methodsSoy2.default);

exports.default = twYFc;
...
exports.templates = exports.twYFc = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace twYFc.
   * @public
   */

  goog.module('twYFc.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'twYFc.render';
  }
...
_metalSoy2.default.register(twYFc, templates);
exports.twYFc = twYFc;
