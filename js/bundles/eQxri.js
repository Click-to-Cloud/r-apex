...
var eQxri = function (_Component) {
  _inherits(eQxri, _Component);

  function eQxri() {
    _classCallCheck(this, eQxri);

    return _possibleConstructorReturn(this, (eQxri.__proto__ || Object.getPrototypeOf(eQxri)).apply(this, arguments));
  }
...
_metalSoy2.default.register(eQxri, _step_3Soy2.default);

exports.default = eQxri;
...
exports.templates = exports.eQxri = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace eQxri.
   * @public
   */

  goog.module('eQxri.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param2015 = function param2015() {
      ie_open('h2');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param2015 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'eQxri.render';
  }
...
_metalSoy2.default.register(eQxri, templates);
exports.eQxri = eQxri;
