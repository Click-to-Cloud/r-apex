...
var TOtqI = function (_Component) {
  _inherits(TOtqI, _Component);

  function TOtqI() {
    _classCallCheck(this, TOtqI);

    return _possibleConstructorReturn(this, (TOtqI.__proto__ || Object.getPrototypeOf(TOtqI)).apply(this, arguments));
  }
...
_metalSoy2.default.register(TOtqI, _step_8Soy2.default);

exports.default = TOtqI;
...
exports.templates = exports.TOtqI = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace TOtqI.
   * @public
   */

  goog.module('TOtqI.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param2095 = function param2095() {
      ie_open('h2');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param2095 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'TOtqI.render';
  }
...
_metalSoy2.default.register(TOtqI, templates);
exports.TOtqI = TOtqI;
