...
var vlDLX = function (_Component) {
  _inherits(vlDLX, _Component);

  function vlDLX() {
    _classCallCheck(this, vlDLX);

    return _possibleConstructorReturn(this, (vlDLX.__proto__ || Object.getPrototypeOf(vlDLX)).apply(this, arguments));
  }
...
_metalSoy2.default.register(vlDLX, _step_8Soy2.default);

exports.default = vlDLX;
...
exports.templates = exports.vlDLX = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace vlDLX.
   * @public
   */

  goog.module('vlDLX.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'vlDLX.render';
  }
...
_metalSoy2.default.register(vlDLX, templates);
exports.vlDLX = vlDLX;
