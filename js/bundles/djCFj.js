...
var _stringSoy = __webpack_require__(309);
...
var djCFj = function (_Component) {
  _inherits(djCFj, _Component);

  function djCFj() {
    _classCallCheck(this, djCFj);

    return _possibleConstructorReturn(this, (djCFj.__proto__ || Object.getPrototypeOf(djCFj)).apply(this, arguments));
  }
...
_metalSoy2.default.register(djCFj, _stringSoy2.default);

exports.default = djCFj;
...
exports.templates = exports.djCFj = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace djCFj.
   * @public
   */

  goog.module('djCFj.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param1770 = function param1770() {
      ie_open('h6');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param1770 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'djCFj.render';
  }
...
_metalSoy2.default.register(djCFj, templates);
exports.djCFj = djCFj;
