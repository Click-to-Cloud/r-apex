...
var XtHas = function (_Component) {
  _inherits(XtHas, _Component);

  function XtHas() {
    _classCallCheck(this, XtHas);

    return _possibleConstructorReturn(this, (XtHas.__proto__ || Object.getPrototypeOf(XtHas)).apply(this, arguments));
  }
...
_metalSoy2.default.register(XtHas, _indexSoy2.default);

exports.default = XtHas;
...
exports.templates = exports.XtHas = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace XtHas.
   * @public
   */

  goog.module('XtHas.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'XtHas.render';
  }
...
_metalSoy2.default.register(XtHas, templates);
exports.XtHas = XtHas;
