...
var hAvOD = function (_Component) {
  _inherits(hAvOD, _Component);

  function hAvOD() {
    _classCallCheck(this, hAvOD);

    return _possibleConstructorReturn(this, (hAvOD.__proto__ || Object.getPrototypeOf(hAvOD)).apply(this, arguments));
  }
...
_metalSoy2.default.register(hAvOD, _creationSoy2.default);

exports.default = hAvOD;
...
exports.templates = exports.hAvOD = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace hAvOD.
   * @public
   */

  goog.module('hAvOD.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'hAvOD.render';
  }
...
_metalSoy2.default.register(hAvOD, templates);
exports.hAvOD = hAvOD;
