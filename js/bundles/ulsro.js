...
var ulsro = function (_Component) {
  _inherits(ulsro, _Component);

  function ulsro() {
    _classCallCheck(this, ulsro);

    return _possibleConstructorReturn(this, (ulsro.__proto__ || Object.getPrototypeOf(ulsro)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ulsro, _stringSoy2.default);

exports.default = ulsro;
...
exports.templates = exports.ulsro = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ulsro.
   * @public
   */

  goog.module('ulsro.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ulsro.render';
  }
...
_metalSoy2.default.register(ulsro, templates);
exports.ulsro = ulsro;
