...
var hleEc = function (_Component) {
  _inherits(hleEc, _Component);

  function hleEc() {
    _classCallCheck(this, hleEc);

    return _possibleConstructorReturn(this, (hleEc.__proto__ || Object.getPrototypeOf(hleEc)).apply(this, arguments));
  }
...
_metalSoy2.default.register(hleEc, _step_6Soy2.default);

exports.default = hleEc;
...
exports.templates = exports.hleEc = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace hleEc.
   * @public
   */

  goog.module('hleEc.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param2073 = function param2073() {
      ie_open('h2');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param2073 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'hleEc.render';
  }
...
_metalSoy2.default.register(hleEc, templates);
exports.hleEc = hleEc;
