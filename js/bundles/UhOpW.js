...
var UhOpW = function (_Component) {
  _inherits(UhOpW, _Component);

  function UhOpW() {
    _classCallCheck(this, UhOpW);

    return _possibleConstructorReturn(this, (UhOpW.__proto__ || Object.getPrototypeOf(UhOpW)).apply(this, arguments));
  }
...
_metalSoy2.default.register(UhOpW, _conversionSoy2.default);

exports.default = UhOpW;
...
exports.templates = exports.UhOpW = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace UhOpW.
   * @public
   */

  goog.module('UhOpW.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'UhOpW.render';
  }
...
_metalSoy2.default.register(UhOpW, templates);
exports.UhOpW = UhOpW;
