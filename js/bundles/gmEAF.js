...
var gmEAF = function (_Component) {
  _inherits(gmEAF, _Component);

  function gmEAF() {
    _classCallCheck(this, gmEAF);

    return _possibleConstructorReturn(this, (gmEAF.__proto__ || Object.getPrototypeOf(gmEAF)).apply(this, arguments));
  }
...
_metalSoy2.default.register(gmEAF, _step_2Soy2.default);

exports.default = gmEAF;
...
exports.templates = exports.gmEAF = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace gmEAF.
   * @public
   */

  goog.module('gmEAF.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'gmEAF.render';
  }
...
_metalSoy2.default.register(gmEAF, templates);
exports.gmEAF = gmEAF;
