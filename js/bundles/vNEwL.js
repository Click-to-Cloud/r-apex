...
var vNEwL = function (_Component) {
  _inherits(vNEwL, _Component);

  function vNEwL() {
    _classCallCheck(this, vNEwL);

    return _possibleConstructorReturn(this, (vNEwL.__proto__ || Object.getPrototypeOf(vNEwL)).apply(this, arguments));
  }
...
_metalSoy2.default.register(vNEwL, _step_3Soy2.default);

exports.default = vNEwL;
...
exports.templates = exports.vNEwL = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace vNEwL.
   * @public
   */

  goog.module('vNEwL.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'vNEwL.render';
  }
...
_metalSoy2.default.register(vNEwL, templates);
exports.vNEwL = vNEwL;
