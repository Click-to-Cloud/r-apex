...
var ZvAzX = function (_Component) {
  _inherits(ZvAzX, _Component);

  function ZvAzX() {
    _classCallCheck(this, ZvAzX);

    return _possibleConstructorReturn(this, (ZvAzX.__proto__ || Object.getPrototypeOf(ZvAzX)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ZvAzX, _step_4Soy2.default);

exports.default = ZvAzX;
...
exports.templates = exports.ZvAzX = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ZvAzX.
   * @public
   */

  goog.module('ZvAzX.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ZvAzX.render';
  }
...
_metalSoy2.default.register(ZvAzX, templates);
exports.ZvAzX = ZvAzX;
