...
var QrarI = function (_Component) {
  _inherits(QrarI, _Component);

  function QrarI() {
    _classCallCheck(this, QrarI);

    return _possibleConstructorReturn(this, (QrarI.__proto__ || Object.getPrototypeOf(QrarI)).apply(this, arguments));
  }
...
_metalSoy2.default.register(QrarI, _step_6Soy2.default);

exports.default = QrarI;
...
exports.templates = exports.QrarI = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace QrarI.
   * @public
   */

  goog.module('QrarI.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param2088 = function param2088() {
      ie_open('h2');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param2088 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'QrarI.render';
  }
...
_metalSoy2.default.register(QrarI, templates);
exports.QrarI = QrarI;
