...
var UTidO = function (_Component) {
  _inherits(UTidO, _Component);

  function UTidO() {
    _classCallCheck(this, UTidO);

    return _possibleConstructorReturn(this, (UTidO.__proto__ || Object.getPrototypeOf(UTidO)).apply(this, arguments));
  }
...
_metalSoy2.default.register(UTidO, _arithmeticSoy2.default);

exports.default = UTidO;
...
exports.templates = exports.UTidO = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace UTidO.
   * @public
   */

  goog.module('UTidO.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'UTidO.render';
  }
...
_metalSoy2.default.register(UTidO, templates);
exports.UTidO = UTidO;
