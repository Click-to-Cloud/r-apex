...
var bIbgB = function (_Component) {
  _inherits(bIbgB, _Component);

  function bIbgB() {
    _classCallCheck(this, bIbgB);

    return _possibleConstructorReturn(this, (bIbgB.__proto__ || Object.getPrototypeOf(bIbgB)).apply(this, arguments));
  }
...
_metalSoy2.default.register(bIbgB, _comparatorSoy2.default);

exports.default = bIbgB;
...
exports.templates = exports.bIbgB = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace bIbgB.
   * @public
   */

  goog.module('bIbgB.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'bIbgB.render';
  }
...
_metalSoy2.default.register(bIbgB, templates);
exports.bIbgB = bIbgB;
