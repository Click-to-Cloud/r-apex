...
var ThYWR = function (_Component) {
  _inherits(ThYWR, _Component);

  function ThYWR() {
    _classCallCheck(this, ThYWR);

    return _possibleConstructorReturn(this, (ThYWR.__proto__ || Object.getPrototypeOf(ThYWR)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ThYWR, _mapSoy2.default);

exports.default = ThYWR;
...
exports.templates = exports.ThYWR = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ThYWR.
   * @public
   */

  goog.module('ThYWR.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ThYWR.render';
  }
...
_metalSoy2.default.register(ThYWR, templates);
exports.ThYWR = ThYWR;
