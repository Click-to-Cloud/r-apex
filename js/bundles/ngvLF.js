...
var ngvLF = function (_Component) {
  _inherits(ngvLF, _Component);

  function ngvLF() {
    _classCallCheck(this, ngvLF);

    return _possibleConstructorReturn(this, (ngvLF.__proto__ || Object.getPrototypeOf(ngvLF)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ngvLF, _methodsSoy2.default);

exports.default = ngvLF;
...
exports.templates = exports.ngvLF = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ngvLF.
   * @public
   */

  goog.module('ngvLF.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ngvLF.render';
  }
...
_metalSoy2.default.register(ngvLF, templates);
exports.ngvLF = ngvLF;
