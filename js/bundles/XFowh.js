...
var XFowh = function (_Component) {
  _inherits(XFowh, _Component);

  function XFowh() {
    _classCallCheck(this, XFowh);

    return _possibleConstructorReturn(this, (XFowh.__proto__ || Object.getPrototypeOf(XFowh)).apply(this, arguments));
  }
...
_metalSoy2.default.register(XFowh, _conversionSoy2.default);

exports.default = XFowh;
...
exports.templates = exports.XFowh = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace XFowh.
   * @public
   */

  goog.module('XFowh.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'XFowh.render';
  }
...
_metalSoy2.default.register(XFowh, templates);
exports.XFowh = XFowh;
