...
var EvXXk = function (_Component) {
  _inherits(EvXXk, _Component);

  function EvXXk() {
    _classCallCheck(this, EvXXk);

    return _possibleConstructorReturn(this, (EvXXk.__proto__ || Object.getPrototypeOf(EvXXk)).apply(this, arguments));
  }
...
_metalSoy2.default.register(EvXXk, _conditionSoy2.default);

exports.default = EvXXk;
...
exports.templates = exports.EvXXk = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace EvXXk.
   * @public
   */

  goog.module('EvXXk.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'EvXXk.render';
  }
...
_metalSoy2.default.register(EvXXk, templates);
exports.EvXXk = EvXXk;
