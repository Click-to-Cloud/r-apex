...
var aFvGV = function (_Component) {
  _inherits(aFvGV, _Component);

  function aFvGV() {
    _classCallCheck(this, aFvGV);

    return _possibleConstructorReturn(this, (aFvGV.__proto__ || Object.getPrototypeOf(aFvGV)).apply(this, arguments));
  }
...
_metalSoy2.default.register(aFvGV, _utilitySoy2.default);

exports.default = aFvGV;
...
exports.templates = exports.aFvGV = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace aFvGV.
   * @public
   */

  goog.module('aFvGV.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'aFvGV.render';
  }
...
_metalSoy2.default.register(aFvGV, templates);
exports.aFvGV = aFvGV;
