...
var afnAW = function (_Component) {
  _inherits(afnAW, _Component);

  function afnAW() {
    _classCallCheck(this, afnAW);

    return _possibleConstructorReturn(this, (afnAW.__proto__ || Object.getPrototypeOf(afnAW)).apply(this, arguments));
  }
...
_metalSoy2.default.register(afnAW, _step_2Soy2.default);

exports.default = afnAW;
...
exports.templates = exports.afnAW = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace afnAW.
   * @public
   */

  goog.module('afnAW.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param1959 = function param1959() {
      ie_open('h2');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param1959 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'afnAW.render';
  }
...
_metalSoy2.default.register(afnAW, templates);
exports.afnAW = afnAW;
