...
var _listSoy = __webpack_require__(301);
...
var TQBWr = function (_Component) {
  _inherits(TQBWr, _Component);

  function TQBWr() {
    _classCallCheck(this, TQBWr);

    return _possibleConstructorReturn(this, (TQBWr.__proto__ || Object.getPrototypeOf(TQBWr)).apply(this, arguments));
  }
...
_metalSoy2.default.register(TQBWr, _listSoy2.default);

exports.default = TQBWr;
...
exports.templates = exports.TQBWr = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace TQBWr.
   * @public
   */

  goog.module('TQBWr.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param1216 = function param1216() {
      ie_open('h6');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'TQBWr.render';
  }
...
_metalSoy2.default.register(TQBWr, templates);
exports.TQBWr = TQBWr;
