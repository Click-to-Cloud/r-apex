...
var VSZPm = function (_Component) {
  _inherits(VSZPm, _Component);

  function VSZPm() {
    _classCallCheck(this, VSZPm);

    return _possibleConstructorReturn(this, (VSZPm.__proto__ || Object.getPrototypeOf(VSZPm)).apply(this, arguments));
  }
...
_metalSoy2.default.register(VSZPm, _conversionSoy2.default);

exports.default = VSZPm;
...
exports.templates = exports.VSZPm = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace VSZPm.
   * @public
   */

  goog.module('VSZPm.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'VSZPm.render';
  }
...
_metalSoy2.default.register(VSZPm, templates);
exports.VSZPm = VSZPm;
