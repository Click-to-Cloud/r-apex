...
var SuTDK = function (_Component) {
  _inherits(SuTDK, _Component);

  function SuTDK() {
    _classCallCheck(this, SuTDK);

    return _possibleConstructorReturn(this, (SuTDK.__proto__ || Object.getPrototypeOf(SuTDK)).apply(this, arguments));
  }
...
_metalSoy2.default.register(SuTDK, _indexSoy2.default);

exports.default = SuTDK;
...
exports.templates = exports.SuTDK = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace SuTDK.
   * @public
   */

  goog.module('SuTDK.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'SuTDK.render';
  }
...
_metalSoy2.default.register(SuTDK, templates);
exports.SuTDK = SuTDK;
