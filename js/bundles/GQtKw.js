...
var GQtKw = function (_Component) {
  _inherits(GQtKw, _Component);

  function GQtKw() {
    _classCallCheck(this, GQtKw);

    return _possibleConstructorReturn(this, (GQtKw.__proto__ || Object.getPrototypeOf(GQtKw)).apply(this, arguments));
  }
...
_metalSoy2.default.register(GQtKw, _listSoy2.default);

exports.default = GQtKw;
...
exports.templates = exports.GQtKw = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace GQtKw.
   * @public
   */

  goog.module('GQtKw.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'GQtKw.render';
  }
...
_metalSoy2.default.register(GQtKw, templates);
exports.GQtKw = GQtKw;
