...
var rbnJx = function (_Component) {
  _inherits(rbnJx, _Component);

  function rbnJx() {
    _classCallCheck(this, rbnJx);

    return _possibleConstructorReturn(this, (rbnJx.__proto__ || Object.getPrototypeOf(rbnJx)).apply(this, arguments));
  }
...
_metalSoy2.default.register(rbnJx, _conversionSoy2.default);

exports.default = rbnJx;
...
exports.templates = exports.rbnJx = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace rbnJx.
   * @public
   */

  goog.module('rbnJx.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'rbnJx.render';
  }
...
_metalSoy2.default.register(rbnJx, templates);
exports.rbnJx = rbnJx;
