...
var CTBio = function (_Component) {
  _inherits(CTBio, _Component);

  function CTBio() {
    _classCallCheck(this, CTBio);

    return _possibleConstructorReturn(this, (CTBio.__proto__ || Object.getPrototypeOf(CTBio)).apply(this, arguments));
  }
...
_metalSoy2.default.register(CTBio, _stringSoy2.default);

exports.default = CTBio;
...
exports.templates = exports.CTBio = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace CTBio.
   * @public
   */

  goog.module('CTBio.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'CTBio.render';
  }
...
_metalSoy2.default.register(CTBio, templates);
exports.CTBio = CTBio;
