...
var GVgrl = function (_Component) {
  _inherits(GVgrl, _Component);

  function GVgrl() {
    _classCallCheck(this, GVgrl);

    return _possibleConstructorReturn(this, (GVgrl.__proto__ || Object.getPrototypeOf(GVgrl)).apply(this, arguments));
  }
...
_metalSoy2.default.register(GVgrl, _functionSoy2.default);

exports.default = GVgrl;
...
exports.templates = exports.GVgrl = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace GVgrl.
   * @public
   */

  goog.module('GVgrl.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param556 = function param556() {
      ie_open('h6');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'GVgrl.render';
  }
...
_metalSoy2.default.register(GVgrl, templates);
exports.GVgrl = GVgrl;
