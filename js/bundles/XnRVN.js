...
var XnRVN = function (_Component) {
  _inherits(XnRVN, _Component);

  function XnRVN() {
    _classCallCheck(this, XnRVN);

    return _possibleConstructorReturn(this, (XnRVN.__proto__ || Object.getPrototypeOf(XnRVN)).apply(this, arguments));
  }
...
_metalSoy2.default.register(XnRVN, _step_5Soy2.default);

exports.default = XnRVN;
...
exports.templates = exports.XnRVN = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace XnRVN.
   * @public
   */

  goog.module('XnRVN.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'XnRVN.render';
  }
...
_metalSoy2.default.register(XnRVN, templates);
exports.XnRVN = XnRVN;
