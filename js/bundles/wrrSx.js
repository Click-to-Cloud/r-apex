...
var wrrSx = function (_Component) {
  _inherits(wrrSx, _Component);

  function wrrSx() {
    _classCallCheck(this, wrrSx);

    return _possibleConstructorReturn(this, (wrrSx.__proto__ || Object.getPrototypeOf(wrrSx)).apply(this, arguments));
  }
...
_metalSoy2.default.register(wrrSx, _step_7Soy2.default);

exports.default = wrrSx;
...
exports.templates = exports.wrrSx = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace wrrSx.
   * @public
   */

  goog.module('wrrSx.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'wrrSx.render';
  }
...
_metalSoy2.default.register(wrrSx, templates);
exports.wrrSx = wrrSx;
