...
var AWxDc = function (_Component) {
  _inherits(AWxDc, _Component);

  function AWxDc() {
    _classCallCheck(this, AWxDc);

    return _possibleConstructorReturn(this, (AWxDc.__proto__ || Object.getPrototypeOf(AWxDc)).apply(this, arguments));
  }
...
_metalSoy2.default.register(AWxDc, _step_6Soy2.default);

exports.default = AWxDc;
...
exports.templates = exports.AWxDc = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace AWxDc.
   * @public
   */

  goog.module('AWxDc.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'AWxDc.render';
  }
...
_metalSoy2.default.register(AWxDc, templates);
exports.AWxDc = AWxDc;
