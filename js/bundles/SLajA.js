...
var SLajA = function (_Component) {
  _inherits(SLajA, _Component);

  function SLajA() {
    _classCallCheck(this, SLajA);

    return _possibleConstructorReturn(this, (SLajA.__proto__ || Object.getPrototypeOf(SLajA)).apply(this, arguments));
  }
...
_metalSoy2.default.register(SLajA, _methodsSoy2.default);

exports.default = SLajA;
...
exports.templates = exports.SLajA = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace SLajA.
   * @public
   */

  goog.module('SLajA.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'SLajA.render';
  }
...
_metalSoy2.default.register(SLajA, templates);
exports.SLajA = SLajA;
