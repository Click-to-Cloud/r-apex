...
var vGpTB = function (_Component) {
  _inherits(vGpTB, _Component);

  function vGpTB() {
    _classCallCheck(this, vGpTB);

    return _possibleConstructorReturn(this, (vGpTB.__proto__ || Object.getPrototypeOf(vGpTB)).apply(this, arguments));
  }
...
_metalSoy2.default.register(vGpTB, _step_8Soy2.default);

exports.default = vGpTB;
...
exports.templates = exports.vGpTB = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace vGpTB.
   * @public
   */

  goog.module('vGpTB.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'vGpTB.render';
  }
...
_metalSoy2.default.register(vGpTB, templates);
exports.vGpTB = vGpTB;
