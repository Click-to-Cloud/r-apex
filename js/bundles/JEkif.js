...
var _comparatorSoy = __webpack_require__(291);
...
var JEkif = function (_Component) {
  _inherits(JEkif, _Component);

  function JEkif() {
    _classCallCheck(this, JEkif);

    return _possibleConstructorReturn(this, (JEkif.__proto__ || Object.getPrototypeOf(JEkif)).apply(this, arguments));
  }
...
_metalSoy2.default.register(JEkif, _comparatorSoy2.default);

exports.default = JEkif;
...
exports.templates = exports.JEkif = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace JEkif.
   * @public
   */

  goog.module('JEkif.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param1006 = function param1006() {
      ie_open('h6');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param1006 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'JEkif.render';
  }
...
_metalSoy2.default.register(JEkif, templates);
exports.JEkif = JEkif;
