...
var VRwJO = function (_Component) {
  _inherits(VRwJO, _Component);

  function VRwJO() {
    _classCallCheck(this, VRwJO);

    return _possibleConstructorReturn(this, (VRwJO.__proto__ || Object.getPrototypeOf(VRwJO)).apply(this, arguments));
  }
...
_metalSoy2.default.register(VRwJO, _relationSoy2.default);

exports.default = VRwJO;
...
exports.templates = exports.VRwJO = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace VRwJO.
   * @public
   */

  goog.module('VRwJO.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param1760 = function param1760() {
      ie_open('h6');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'VRwJO.render';
  }
...
_metalSoy2.default.register(VRwJO, templates);
exports.VRwJO = VRwJO;
