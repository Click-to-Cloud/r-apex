...
var jHrDm = function (_Component) {
  _inherits(jHrDm, _Component);

  function jHrDm() {
    _classCallCheck(this, jHrDm);

    return _possibleConstructorReturn(this, (jHrDm.__proto__ || Object.getPrototypeOf(jHrDm)).apply(this, arguments));
  }
...
_metalSoy2.default.register(jHrDm, _conditionSoy2.default);

exports.default = jHrDm;
...
exports.templates = exports.jHrDm = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace jHrDm.
   * @public
   */

  goog.module('jHrDm.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'jHrDm.render';
  }
...
_metalSoy2.default.register(jHrDm, templates);
exports.jHrDm = jHrDm;
