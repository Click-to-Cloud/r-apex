...
var tLzaV = function (_Component) {
  _inherits(tLzaV, _Component);

  function tLzaV() {
    _classCallCheck(this, tLzaV);

    return _possibleConstructorReturn(this, (tLzaV.__proto__ || Object.getPrototypeOf(tLzaV)).apply(this, arguments));
  }
...
_metalSoy2.default.register(tLzaV, _conditionSoy2.default);

exports.default = tLzaV;
...
exports.templates = exports.tLzaV = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace tLzaV.
   * @public
   */

  goog.module('tLzaV.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'tLzaV.render';
  }
...
_metalSoy2.default.register(tLzaV, templates);
exports.tLzaV = tLzaV;
