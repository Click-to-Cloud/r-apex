...
var ICDcW = function (_Component) {
  _inherits(ICDcW, _Component);

  function ICDcW() {
    _classCallCheck(this, ICDcW);

    return _possibleConstructorReturn(this, (ICDcW.__proto__ || Object.getPrototypeOf(ICDcW)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ICDcW, _creationSoy2.default);

exports.default = ICDcW;
...
exports.templates = exports.ICDcW = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ICDcW.
   * @public
   */

  goog.module('ICDcW.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ICDcW.render';
  }
...
_metalSoy2.default.register(ICDcW, templates);
exports.ICDcW = ICDcW;
