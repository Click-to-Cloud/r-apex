...
var arinI = function (_Component) {
  _inherits(arinI, _Component);

  function arinI() {
    _classCallCheck(this, arinI);

    return _possibleConstructorReturn(this, (arinI.__proto__ || Object.getPrototypeOf(arinI)).apply(this, arguments));
  }
...
_metalSoy2.default.register(arinI, _relationSoy2.default);

exports.default = arinI;
...
exports.templates = exports.arinI = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace arinI.
   * @public
   */

  goog.module('arinI.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'arinI.render';
  }
...
_metalSoy2.default.register(arinI, templates);
exports.arinI = arinI;
