...
var XQAsx = function (_Component) {
  _inherits(XQAsx, _Component);

  function XQAsx() {
    _classCallCheck(this, XQAsx);

    return _possibleConstructorReturn(this, (XQAsx.__proto__ || Object.getPrototypeOf(XQAsx)).apply(this, arguments));
  }
...
_metalSoy2.default.register(XQAsx, _functionSoy2.default);

exports.default = XQAsx;
...
exports.templates = exports.XQAsx = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace XQAsx.
   * @public
   */

  goog.module('XQAsx.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'XQAsx.render';
  }
...
_metalSoy2.default.register(XQAsx, templates);
exports.XQAsx = XQAsx;
