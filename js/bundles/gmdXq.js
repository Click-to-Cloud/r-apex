...
var gmdXq = function (_Component) {
  _inherits(gmdXq, _Component);

  function gmdXq() {
    _classCallCheck(this, gmdXq);

    return _possibleConstructorReturn(this, (gmdXq.__proto__ || Object.getPrototypeOf(gmdXq)).apply(this, arguments));
  }
...
_metalSoy2.default.register(gmdXq, _indexSoy2.default);

exports.default = gmdXq;
...
exports.templates = exports.gmdXq = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace gmdXq.
   * @public
   */

  goog.module('gmdXq.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'gmdXq.render';
  }
...
_metalSoy2.default.register(gmdXq, templates);
exports.gmdXq = gmdXq;
