...
var ZpJpo = function (_Component) {
  _inherits(ZpJpo, _Component);

  function ZpJpo() {
    _classCallCheck(this, ZpJpo);

    return _possibleConstructorReturn(this, (ZpJpo.__proto__ || Object.getPrototypeOf(ZpJpo)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ZpJpo, _step_3Soy2.default);

exports.default = ZpJpo;
...
exports.templates = exports.ZpJpo = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ZpJpo.
   * @public
   */

  goog.module('ZpJpo.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ZpJpo.render';
  }
...
_metalSoy2.default.register(ZpJpo, templates);
exports.ZpJpo = ZpJpo;
