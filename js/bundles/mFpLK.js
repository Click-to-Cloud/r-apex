...
var mFpLK = function (_Component) {
  _inherits(mFpLK, _Component);

  function mFpLK() {
    _classCallCheck(this, mFpLK);

    return _possibleConstructorReturn(this, (mFpLK.__proto__ || Object.getPrototypeOf(mFpLK)).apply(this, arguments));
  }
...
_metalSoy2.default.register(mFpLK, _step_5Soy2.default);

exports.default = mFpLK;
...
exports.templates = exports.mFpLK = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace mFpLK.
   * @public
   */

  goog.module('mFpLK.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'mFpLK.render';
  }
...
_metalSoy2.default.register(mFpLK, templates);
exports.mFpLK = mFpLK;
