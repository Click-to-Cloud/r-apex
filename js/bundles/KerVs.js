...
var KerVs = function (_Component) {
  _inherits(KerVs, _Component);

  function KerVs() {
    _classCallCheck(this, KerVs);

    return _possibleConstructorReturn(this, (KerVs.__proto__ || Object.getPrototypeOf(KerVs)).apply(this, arguments));
  }
...
_metalSoy2.default.register(KerVs, _indexSoy2.default);

exports.default = KerVs;
...
exports.templates = exports.KerVs = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace KerVs.
   * @public
   */

  goog.module('KerVs.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'KerVs.render';
  }
...
_metalSoy2.default.register(KerVs, templates);
exports.KerVs = KerVs;
