...
var labRF = function (_Component) {
  _inherits(labRF, _Component);

  function labRF() {
    _classCallCheck(this, labRF);

    return _possibleConstructorReturn(this, (labRF.__proto__ || Object.getPrototypeOf(labRF)).apply(this, arguments));
  }
...
_metalSoy2.default.register(labRF, _logicSoy2.default);

exports.default = labRF;
...
exports.templates = exports.labRF = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace labRF.
   * @public
   */

  goog.module('labRF.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'labRF.render';
  }
...
_metalSoy2.default.register(labRF, templates);
exports.labRF = labRF;
