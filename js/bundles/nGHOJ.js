...
var nGHOJ = function (_Component) {
  _inherits(nGHOJ, _Component);

  function nGHOJ() {
    _classCallCheck(this, nGHOJ);

    return _possibleConstructorReturn(this, (nGHOJ.__proto__ || Object.getPrototypeOf(nGHOJ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(nGHOJ, _conversionSoy2.default);

exports.default = nGHOJ;
...
exports.templates = exports.nGHOJ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace nGHOJ.
   * @public
   */

  goog.module('nGHOJ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'nGHOJ.render';
  }
...
_metalSoy2.default.register(nGHOJ, templates);
exports.nGHOJ = nGHOJ;
