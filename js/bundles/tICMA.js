...
var tICMA = function (_Component) {
  _inherits(tICMA, _Component);

  function tICMA() {
    _classCallCheck(this, tICMA);

    return _possibleConstructorReturn(this, (tICMA.__proto__ || Object.getPrototypeOf(tICMA)).apply(this, arguments));
  }
...
_metalSoy2.default.register(tICMA, _conditionSoy2.default);

exports.default = tICMA;
...
exports.templates = exports.tICMA = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace tICMA.
   * @public
   */

  goog.module('tICMA.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'tICMA.render';
  }
...
_metalSoy2.default.register(tICMA, templates);
exports.tICMA = tICMA;
