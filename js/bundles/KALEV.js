...
var KALEV = function (_Component) {
  _inherits(KALEV, _Component);

  function KALEV() {
    _classCallCheck(this, KALEV);

    return _possibleConstructorReturn(this, (KALEV.__proto__ || Object.getPrototypeOf(KALEV)).apply(this, arguments));
  }
...
_metalSoy2.default.register(KALEV, _methodsSoy2.default);

exports.default = KALEV;
...
exports.templates = exports.KALEV = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace KALEV.
   * @public
   */

  goog.module('KALEV.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'KALEV.render';
  }
...
_metalSoy2.default.register(KALEV, templates);
exports.KALEV = KALEV;
