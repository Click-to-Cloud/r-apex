...
var HEVGw = function (_Component) {
  _inherits(HEVGw, _Component);

  function HEVGw() {
    _classCallCheck(this, HEVGw);

    return _possibleConstructorReturn(this, (HEVGw.__proto__ || Object.getPrototypeOf(HEVGw)).apply(this, arguments));
  }
...
_metalSoy2.default.register(HEVGw, _databaseSoy2.default);

exports.default = HEVGw;
...
exports.templates = exports.HEVGw = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace HEVGw.
   * @public
   */

  goog.module('HEVGw.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'HEVGw.render';
  }
...
_metalSoy2.default.register(HEVGw, templates);
exports.HEVGw = HEVGw;
