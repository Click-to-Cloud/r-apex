...
var kDCRb = function (_Component) {
  _inherits(kDCRb, _Component);

  function kDCRb() {
    _classCallCheck(this, kDCRb);

    return _possibleConstructorReturn(this, (kDCRb.__proto__ || Object.getPrototypeOf(kDCRb)).apply(this, arguments));
  }
...
_metalSoy2.default.register(kDCRb, _arithmeticSoy2.default);

exports.default = kDCRb;
...
exports.templates = exports.kDCRb = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace kDCRb.
   * @public
   */

  goog.module('kDCRb.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'kDCRb.render';
  }
...
_metalSoy2.default.register(kDCRb, templates);
exports.kDCRb = kDCRb;
