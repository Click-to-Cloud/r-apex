...
var CqYWh = function (_Component) {
  _inherits(CqYWh, _Component);

  function CqYWh() {
    _classCallCheck(this, CqYWh);

    return _possibleConstructorReturn(this, (CqYWh.__proto__ || Object.getPrototypeOf(CqYWh)).apply(this, arguments));
  }
...
_metalSoy2.default.register(CqYWh, _step_8Soy2.default);

exports.default = CqYWh;
...
exports.templates = exports.CqYWh = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace CqYWh.
   * @public
   */

  goog.module('CqYWh.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'CqYWh.render';
  }
...
_metalSoy2.default.register(CqYWh, templates);
exports.CqYWh = CqYWh;
