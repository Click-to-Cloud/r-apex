...
var TmBVQ = function (_Component) {
  _inherits(TmBVQ, _Component);

  function TmBVQ() {
    _classCallCheck(this, TmBVQ);

    return _possibleConstructorReturn(this, (TmBVQ.__proto__ || Object.getPrototypeOf(TmBVQ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(TmBVQ, _arithmeticSoy2.default);

exports.default = TmBVQ;
...
exports.templates = exports.TmBVQ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace TmBVQ.
   * @public
   */

  goog.module('TmBVQ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'TmBVQ.render';
  }
...
_metalSoy2.default.register(TmBVQ, templates);
exports.TmBVQ = TmBVQ;
