...
var PMqbv = function (_Component) {
  _inherits(PMqbv, _Component);

  function PMqbv() {
    _classCallCheck(this, PMqbv);

    return _possibleConstructorReturn(this, (PMqbv.__proto__ || Object.getPrototypeOf(PMqbv)).apply(this, arguments));
  }
...
_metalSoy2.default.register(PMqbv, _step_5Soy2.default);

exports.default = PMqbv;
...
exports.templates = exports.PMqbv = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace PMqbv.
   * @public
   */

  goog.module('PMqbv.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'PMqbv.render';
  }
...
_metalSoy2.default.register(PMqbv, templates);
exports.PMqbv = PMqbv;
