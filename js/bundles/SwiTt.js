...
var SwiTt = function (_Component) {
  _inherits(SwiTt, _Component);

  function SwiTt() {
    _classCallCheck(this, SwiTt);

    return _possibleConstructorReturn(this, (SwiTt.__proto__ || Object.getPrototypeOf(SwiTt)).apply(this, arguments));
  }
...
_metalSoy2.default.register(SwiTt, _comparatorSoy2.default);

exports.default = SwiTt;
...
exports.templates = exports.SwiTt = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace SwiTt.
   * @public
   */

  goog.module('SwiTt.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'SwiTt.render';
  }
...
_metalSoy2.default.register(SwiTt, templates);
exports.SwiTt = SwiTt;
