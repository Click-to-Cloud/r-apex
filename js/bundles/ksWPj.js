...
var ksWPj = function (_Component) {
  _inherits(ksWPj, _Component);

  function ksWPj() {
    _classCallCheck(this, ksWPj);

    return _possibleConstructorReturn(this, (ksWPj.__proto__ || Object.getPrototypeOf(ksWPj)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ksWPj, _indexSoy2.default);

exports.default = ksWPj;
...
exports.templates = exports.ksWPj = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ksWPj.
   * @public
   */

  goog.module('ksWPj.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ksWPj.render';
  }
...
_metalSoy2.default.register(ksWPj, templates);
exports.ksWPj = ksWPj;
