...
var yQvMC = function (_Component) {
  _inherits(yQvMC, _Component);

  function yQvMC() {
    _classCallCheck(this, yQvMC);

    return _possibleConstructorReturn(this, (yQvMC.__proto__ || Object.getPrototypeOf(yQvMC)).apply(this, arguments));
  }
...
_metalSoy2.default.register(yQvMC, _indexSoy2.default);

exports.default = yQvMC;
...
exports.templates = exports.yQvMC = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace yQvMC.
   * @public
   */

  goog.module('yQvMC.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'yQvMC.render';
  }
...
_metalSoy2.default.register(yQvMC, templates);
exports.yQvMC = yQvMC;
