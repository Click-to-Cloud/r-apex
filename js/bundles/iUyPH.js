...
var iUyPH = function (_Component) {
  _inherits(iUyPH, _Component);

  function iUyPH() {
    _classCallCheck(this, iUyPH);

    return _possibleConstructorReturn(this, (iUyPH.__proto__ || Object.getPrototypeOf(iUyPH)).apply(this, arguments));
  }
...
_metalSoy2.default.register(iUyPH, _creationSoy2.default);

exports.default = iUyPH;
...
exports.templates = exports.iUyPH = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace iUyPH.
   * @public
   */

  goog.module('iUyPH.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'iUyPH.render';
  }
...
_metalSoy2.default.register(iUyPH, templates);
exports.iUyPH = iUyPH;
