...
var FmHMx = function (_Component) {
  _inherits(FmHMx, _Component);

  function FmHMx() {
    _classCallCheck(this, FmHMx);

    return _possibleConstructorReturn(this, (FmHMx.__proto__ || Object.getPrototypeOf(FmHMx)).apply(this, arguments));
  }
...
_metalSoy2.default.register(FmHMx, _step_6Soy2.default);

exports.default = FmHMx;
...
exports.templates = exports.FmHMx = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace FmHMx.
   * @public
   */

  goog.module('FmHMx.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'FmHMx.render';
  }
...
_metalSoy2.default.register(FmHMx, templates);
exports.FmHMx = FmHMx;
