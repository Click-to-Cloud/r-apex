...
var fwgyo = function (_Component) {
  _inherits(fwgyo, _Component);

  function fwgyo() {
    _classCallCheck(this, fwgyo);

    return _possibleConstructorReturn(this, (fwgyo.__proto__ || Object.getPrototypeOf(fwgyo)).apply(this, arguments));
  }
...
_metalSoy2.default.register(fwgyo, _functionSoy2.default);

exports.default = fwgyo;
...
exports.templates = exports.fwgyo = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace fwgyo.
   * @public
   */

  goog.module('fwgyo.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'fwgyo.render';
  }
...
_metalSoy2.default.register(fwgyo, templates);
exports.fwgyo = fwgyo;
