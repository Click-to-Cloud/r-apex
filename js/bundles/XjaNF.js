...
var XjaNF = function (_Component) {
  _inherits(XjaNF, _Component);

  function XjaNF() {
    _classCallCheck(this, XjaNF);

    return _possibleConstructorReturn(this, (XjaNF.__proto__ || Object.getPrototypeOf(XjaNF)).apply(this, arguments));
  }
...
_metalSoy2.default.register(XjaNF, _conversionSoy2.default);

exports.default = XjaNF;
...
exports.templates = exports.XjaNF = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace XjaNF.
   * @public
   */

  goog.module('XjaNF.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'XjaNF.render';
  }
...
_metalSoy2.default.register(XjaNF, templates);
exports.XjaNF = XjaNF;
