...
var gxwGA = function (_Component) {
  _inherits(gxwGA, _Component);

  function gxwGA() {
    _classCallCheck(this, gxwGA);

    return _possibleConstructorReturn(this, (gxwGA.__proto__ || Object.getPrototypeOf(gxwGA)).apply(this, arguments));
  }
...
_metalSoy2.default.register(gxwGA, _methodsSoy2.default);

exports.default = gxwGA;
...
exports.templates = exports.gxwGA = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace gxwGA.
   * @public
   */

  goog.module('gxwGA.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'gxwGA.render';
  }
...
_metalSoy2.default.register(gxwGA, templates);
exports.gxwGA = gxwGA;
