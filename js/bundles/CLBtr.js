...
var CLBtr = function (_Component) {
  _inherits(CLBtr, _Component);

  function CLBtr() {
    _classCallCheck(this, CLBtr);

    return _possibleConstructorReturn(this, (CLBtr.__proto__ || Object.getPrototypeOf(CLBtr)).apply(this, arguments));
  }
...
_metalSoy2.default.register(CLBtr, _conversionSoy2.default);

exports.default = CLBtr;
...
exports.templates = exports.CLBtr = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace CLBtr.
   * @public
   */

  goog.module('CLBtr.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'CLBtr.render';
  }
...
_metalSoy2.default.register(CLBtr, templates);
exports.CLBtr = CLBtr;
