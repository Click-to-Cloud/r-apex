...
var IQMfS = function (_Component) {
  _inherits(IQMfS, _Component);

  function IQMfS() {
    _classCallCheck(this, IQMfS);

    return _possibleConstructorReturn(this, (IQMfS.__proto__ || Object.getPrototypeOf(IQMfS)).apply(this, arguments));
  }
...
_metalSoy2.default.register(IQMfS, _step_7Soy2.default);

exports.default = IQMfS;
...
exports.templates = exports.IQMfS = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace IQMfS.
   * @public
   */

  goog.module('IQMfS.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'IQMfS.render';
  }
...
_metalSoy2.default.register(IQMfS, templates);
exports.IQMfS = IQMfS;
