...
var gyaPX = function (_Component) {
  _inherits(gyaPX, _Component);

  function gyaPX() {
    _classCallCheck(this, gyaPX);

    return _possibleConstructorReturn(this, (gyaPX.__proto__ || Object.getPrototypeOf(gyaPX)).apply(this, arguments));
  }
...
_metalSoy2.default.register(gyaPX, _utilitySoy2.default);

exports.default = gyaPX;
...
exports.templates = exports.gyaPX = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace gyaPX.
   * @public
   */

  goog.module('gyaPX.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'gyaPX.render';
  }
...
_metalSoy2.default.register(gyaPX, templates);
exports.gyaPX = gyaPX;
