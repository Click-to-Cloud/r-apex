...
var dHKML = function (_Component) {
  _inherits(dHKML, _Component);

  function dHKML() {
    _classCallCheck(this, dHKML);

    return _possibleConstructorReturn(this, (dHKML.__proto__ || Object.getPrototypeOf(dHKML)).apply(this, arguments));
  }
...
_metalSoy2.default.register(dHKML, _indexSoy2.default);

exports.default = dHKML;
...
exports.templates = exports.dHKML = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace dHKML.
   * @public
   */

  goog.module('dHKML.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'dHKML.render';
  }
...
_metalSoy2.default.register(dHKML, templates);
exports.dHKML = dHKML;
