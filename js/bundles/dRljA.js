...
var dRljA = function (_Component) {
  _inherits(dRljA, _Component);

  function dRljA() {
    _classCallCheck(this, dRljA);

    return _possibleConstructorReturn(this, (dRljA.__proto__ || Object.getPrototypeOf(dRljA)).apply(this, arguments));
  }
...
_metalSoy2.default.register(dRljA, _comparatorSoy2.default);

exports.default = dRljA;
...
exports.templates = exports.dRljA = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace dRljA.
   * @public
   */

  goog.module('dRljA.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'dRljA.render';
  }
...
_metalSoy2.default.register(dRljA, templates);
exports.dRljA = dRljA;
