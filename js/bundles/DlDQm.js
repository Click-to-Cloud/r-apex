...
var DlDQm = function (_Component) {
  _inherits(DlDQm, _Component);

  function DlDQm() {
    _classCallCheck(this, DlDQm);

    return _possibleConstructorReturn(this, (DlDQm.__proto__ || Object.getPrototypeOf(DlDQm)).apply(this, arguments));
  }
...
_metalSoy2.default.register(DlDQm, _step_4Soy2.default);

exports.default = DlDQm;
...
exports.templates = exports.DlDQm = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace DlDQm.
   * @public
   */

  goog.module('DlDQm.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'DlDQm.render';
  }
...
_metalSoy2.default.register(DlDQm, templates);
exports.DlDQm = DlDQm;
