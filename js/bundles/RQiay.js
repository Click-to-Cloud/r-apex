...
var RQiay = function (_Component) {
  _inherits(RQiay, _Component);

  function RQiay() {
    _classCallCheck(this, RQiay);

    return _possibleConstructorReturn(this, (RQiay.__proto__ || Object.getPrototypeOf(RQiay)).apply(this, arguments));
  }
...
_metalSoy2.default.register(RQiay, _methodsSoy2.default);

exports.default = RQiay;
...
exports.templates = exports.RQiay = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace RQiay.
   * @public
   */

  goog.module('RQiay.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'RQiay.render';
  }
...
_metalSoy2.default.register(RQiay, templates);
exports.RQiay = RQiay;
