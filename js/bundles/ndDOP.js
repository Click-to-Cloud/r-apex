...
var ndDOP = function (_Component) {
  _inherits(ndDOP, _Component);

  function ndDOP() {
    _classCallCheck(this, ndDOP);

    return _possibleConstructorReturn(this, (ndDOP.__proto__ || Object.getPrototypeOf(ndDOP)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ndDOP, _step_8Soy2.default);

exports.default = ndDOP;
...
exports.templates = exports.ndDOP = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ndDOP.
   * @public
   */

  goog.module('ndDOP.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ndDOP.render';
  }
...
_metalSoy2.default.register(ndDOP, templates);
exports.ndDOP = ndDOP;
