...
var nrLkq = function (_Component) {
  _inherits(nrLkq, _Component);

  function nrLkq() {
    _classCallCheck(this, nrLkq);

    return _possibleConstructorReturn(this, (nrLkq.__proto__ || Object.getPrototypeOf(nrLkq)).apply(this, arguments));
  }
...
_metalSoy2.default.register(nrLkq, _step_3Soy2.default);

exports.default = nrLkq;
...
exports.templates = exports.nrLkq = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace nrLkq.
   * @public
   */

  goog.module('nrLkq.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param1985 = function param1985() {
      ie_open('h2');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param1985 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'nrLkq.render';
  }
...
_metalSoy2.default.register(nrLkq, templates);
exports.nrLkq = nrLkq;
