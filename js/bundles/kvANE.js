...
var kvANE = function (_Component) {
  _inherits(kvANE, _Component);

  function kvANE() {
    _classCallCheck(this, kvANE);

    return _possibleConstructorReturn(this, (kvANE.__proto__ || Object.getPrototypeOf(kvANE)).apply(this, arguments));
  }
...
_metalSoy2.default.register(kvANE, _conditionSoy2.default);

exports.default = kvANE;
...
exports.templates = exports.kvANE = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace kvANE.
   * @public
   */

  goog.module('kvANE.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'kvANE.render';
  }
...
_metalSoy2.default.register(kvANE, templates);
exports.kvANE = kvANE;
