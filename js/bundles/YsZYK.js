...
var YsZYK = function (_Component) {
  _inherits(YsZYK, _Component);

  function YsZYK() {
    _classCallCheck(this, YsZYK);

    return _possibleConstructorReturn(this, (YsZYK.__proto__ || Object.getPrototypeOf(YsZYK)).apply(this, arguments));
  }
...
_metalSoy2.default.register(YsZYK, _stringSoy2.default);

exports.default = YsZYK;
...
exports.templates = exports.YsZYK = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace YsZYK.
   * @public
   */

  goog.module('YsZYK.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'YsZYK.render';
  }
...
_metalSoy2.default.register(YsZYK, templates);
exports.YsZYK = YsZYK;
