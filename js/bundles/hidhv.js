...
var hidhv = function (_Component) {
  _inherits(hidhv, _Component);

  function hidhv() {
    _classCallCheck(this, hidhv);

    return _possibleConstructorReturn(this, (hidhv.__proto__ || Object.getPrototypeOf(hidhv)).apply(this, arguments));
  }
...
_metalSoy2.default.register(hidhv, _indexSoy2.default);

exports.default = hidhv;
...
exports.templates = exports.hidhv = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace hidhv.
   * @public
   */

  goog.module('hidhv.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'hidhv.render';
  }
...
_metalSoy2.default.register(hidhv, templates);
exports.hidhv = hidhv;
