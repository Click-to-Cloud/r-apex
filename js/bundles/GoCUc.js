...
var GoCUc = function (_Component) {
  _inherits(GoCUc, _Component);

  function GoCUc() {
    _classCallCheck(this, GoCUc);

    return _possibleConstructorReturn(this, (GoCUc.__proto__ || Object.getPrototypeOf(GoCUc)).apply(this, arguments));
  }
...
_metalSoy2.default.register(GoCUc, _databaseSoy2.default);

exports.default = GoCUc;
...
exports.templates = exports.GoCUc = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace GoCUc.
   * @public
   */

  goog.module('GoCUc.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'GoCUc.render';
  }
...
_metalSoy2.default.register(GoCUc, templates);
exports.GoCUc = GoCUc;
