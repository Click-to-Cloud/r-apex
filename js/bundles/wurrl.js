...
var wurrl = function (_Component) {
  _inherits(wurrl, _Component);

  function wurrl() {
    _classCallCheck(this, wurrl);

    return _possibleConstructorReturn(this, (wurrl.__proto__ || Object.getPrototypeOf(wurrl)).apply(this, arguments));
  }
...
_metalSoy2.default.register(wurrl, _comparatorSoy2.default);

exports.default = wurrl;
...
exports.templates = exports.wurrl = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace wurrl.
   * @public
   */

  goog.module('wurrl.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'wurrl.render';
  }
...
_metalSoy2.default.register(wurrl, templates);
exports.wurrl = wurrl;
