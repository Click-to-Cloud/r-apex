...
var knpOw = function (_Component) {
  _inherits(knpOw, _Component);

  function knpOw() {
    _classCallCheck(this, knpOw);

    return _possibleConstructorReturn(this, (knpOw.__proto__ || Object.getPrototypeOf(knpOw)).apply(this, arguments));
  }
...
_metalSoy2.default.register(knpOw, _step_5Soy2.default);

exports.default = knpOw;
...
exports.templates = exports.knpOw = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace knpOw.
   * @public
   */

  goog.module('knpOw.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param2042 = function param2042() {
      ie_open('h2');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param2042 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'knpOw.render';
  }
...
_metalSoy2.default.register(knpOw, templates);
exports.knpOw = knpOw;
