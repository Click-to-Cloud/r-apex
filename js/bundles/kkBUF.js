...
var kkBUF = function (_Component) {
  _inherits(kkBUF, _Component);

  function kkBUF() {
    _classCallCheck(this, kkBUF);

    return _possibleConstructorReturn(this, (kkBUF.__proto__ || Object.getPrototypeOf(kkBUF)).apply(this, arguments));
  }
...
_metalSoy2.default.register(kkBUF, _conversionSoy2.default);

exports.default = kkBUF;
...
exports.templates = exports.kkBUF = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace kkBUF.
   * @public
   */

  goog.module('kkBUF.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'kkBUF.render';
  }
...
_metalSoy2.default.register(kkBUF, templates);
exports.kkBUF = kkBUF;
