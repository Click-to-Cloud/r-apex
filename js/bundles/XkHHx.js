...
var XkHHx = function (_Component) {
  _inherits(XkHHx, _Component);

  function XkHHx() {
    _classCallCheck(this, XkHHx);

    return _possibleConstructorReturn(this, (XkHHx.__proto__ || Object.getPrototypeOf(XkHHx)).apply(this, arguments));
  }
...
_metalSoy2.default.register(XkHHx, _step_2Soy2.default);

exports.default = XkHHx;
...
exports.templates = exports.XkHHx = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace XkHHx.
   * @public
   */

  goog.module('XkHHx.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param1989 = function param1989() {
      ie_open('h2');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param1989 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'XkHHx.render';
  }
...
_metalSoy2.default.register(XkHHx, templates);
exports.XkHHx = XkHHx;
