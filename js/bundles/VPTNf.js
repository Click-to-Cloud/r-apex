...
var VPTNf = function (_Component) {
  _inherits(VPTNf, _Component);

  function VPTNf() {
    _classCallCheck(this, VPTNf);

    return _possibleConstructorReturn(this, (VPTNf.__proto__ || Object.getPrototypeOf(VPTNf)).apply(this, arguments));
  }
...
_metalSoy2.default.register(VPTNf, _logicSoy2.default);

exports.default = VPTNf;
...
exports.templates = exports.VPTNf = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace VPTNf.
   * @public
   */

  goog.module('VPTNf.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'VPTNf.render';
  }
...
_metalSoy2.default.register(VPTNf, templates);
exports.VPTNf = VPTNf;
