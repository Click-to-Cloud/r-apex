...
var QHNFI = function (_Component) {
  _inherits(QHNFI, _Component);

  function QHNFI() {
    _classCallCheck(this, QHNFI);

    return _possibleConstructorReturn(this, (QHNFI.__proto__ || Object.getPrototypeOf(QHNFI)).apply(this, arguments));
  }
...
_metalSoy2.default.register(QHNFI, _relationSoy2.default);

exports.default = QHNFI;
...
exports.templates = exports.QHNFI = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace QHNFI.
   * @public
   */

  goog.module('QHNFI.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'QHNFI.render';
  }
...
_metalSoy2.default.register(QHNFI, templates);
exports.QHNFI = QHNFI;
