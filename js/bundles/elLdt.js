...
var elLdt = function (_Component) {
  _inherits(elLdt, _Component);

  function elLdt() {
    _classCallCheck(this, elLdt);

    return _possibleConstructorReturn(this, (elLdt.__proto__ || Object.getPrototypeOf(elLdt)).apply(this, arguments));
  }
...
_metalSoy2.default.register(elLdt, _stringSoy2.default);

exports.default = elLdt;
...
exports.templates = exports.elLdt = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace elLdt.
   * @public
   */

  goog.module('elLdt.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'elLdt.render';
  }
...
_metalSoy2.default.register(elLdt, templates);
exports.elLdt = elLdt;
