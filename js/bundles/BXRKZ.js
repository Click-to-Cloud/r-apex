...
var BXRKZ = function (_Component) {
  _inherits(BXRKZ, _Component);

  function BXRKZ() {
    _classCallCheck(this, BXRKZ);

    return _possibleConstructorReturn(this, (BXRKZ.__proto__ || Object.getPrototypeOf(BXRKZ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(BXRKZ, _listSoy2.default);

exports.default = BXRKZ;
...
exports.templates = exports.BXRKZ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace BXRKZ.
   * @public
   */

  goog.module('BXRKZ.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param1252 = function param1252() {
      ie_open('h6');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param1252 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'BXRKZ.render';
  }
...
_metalSoy2.default.register(BXRKZ, templates);
exports.BXRKZ = BXRKZ;
