...
var FnKtf = function (_Component) {
  _inherits(FnKtf, _Component);

  function FnKtf() {
    _classCallCheck(this, FnKtf);

    return _possibleConstructorReturn(this, (FnKtf.__proto__ || Object.getPrototypeOf(FnKtf)).apply(this, arguments));
  }
...
_metalSoy2.default.register(FnKtf, _functionSoy2.default);

exports.default = FnKtf;
...
exports.templates = exports.FnKtf = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace FnKtf.
   * @public
   */

  goog.module('FnKtf.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param1140 = function param1140() {
      ie_open('h6');
      ...
      itext('Return a function which returns the value whenever called.');
      ie_close('p');
      $templateAlias2({ code: 'Func f = R.constant.apply(2);\nSystem.debug(f.run(2));', mode: 'javascript' }, null, opt_ijData);
      ie_close('article');
      ie_open('article', null, null, 'id', '19');
      ie_open('h2');
      itext('throwException');
      ie_close('h2');
      ie_open('p');
      itext('Throws exception');
      ie_close('p');
      $templateAlias2({ code: 'R.throwException.run(new Func.FuncException(\'test\'));', mode: 'javascript' }, null, opt_ijData);
      ie_close('article');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param1140 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'FnKtf.render';
  }
...
_metalSoy2.default.register(FnKtf, templates);
exports.FnKtf = FnKtf;
