...
var jMJBw = function (_Component) {
  _inherits(jMJBw, _Component);

  function jMJBw() {
    _classCallCheck(this, jMJBw);

    return _possibleConstructorReturn(this, (jMJBw.__proto__ || Object.getPrototypeOf(jMJBw)).apply(this, arguments));
  }
...
_metalSoy2.default.register(jMJBw, _logicSoy2.default);

exports.default = jMJBw;
...
exports.templates = exports.jMJBw = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace jMJBw.
   * @public
   */

  goog.module('jMJBw.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'jMJBw.render';
  }
...
_metalSoy2.default.register(jMJBw, templates);
exports.jMJBw = jMJBw;
