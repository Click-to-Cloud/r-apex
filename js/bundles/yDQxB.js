...
var yDQxB = function (_Component) {
  _inherits(yDQxB, _Component);

  function yDQxB() {
    _classCallCheck(this, yDQxB);

    return _possibleConstructorReturn(this, (yDQxB.__proto__ || Object.getPrototypeOf(yDQxB)).apply(this, arguments));
  }
...
_metalSoy2.default.register(yDQxB, _stringSoy2.default);

exports.default = yDQxB;
...
exports.templates = exports.yDQxB = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace yDQxB.
   * @public
   */

  goog.module('yDQxB.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'yDQxB.render';
  }
...
_metalSoy2.default.register(yDQxB, templates);
exports.yDQxB = yDQxB;
