...
var MWNLx = function (_Component) {
  _inherits(MWNLx, _Component);

  function MWNLx() {
    _classCallCheck(this, MWNLx);

    return _possibleConstructorReturn(this, (MWNLx.__proto__ || Object.getPrototypeOf(MWNLx)).apply(this, arguments));
  }
...
_metalSoy2.default.register(MWNLx, _step_7Soy2.default);

exports.default = MWNLx;
...
exports.templates = exports.MWNLx = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace MWNLx.
   * @public
   */

  goog.module('MWNLx.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'MWNLx.render';
  }
...
_metalSoy2.default.register(MWNLx, templates);
exports.MWNLx = MWNLx;
