...
var KirlM = function (_Component) {
  _inherits(KirlM, _Component);

  function KirlM() {
    _classCallCheck(this, KirlM);

    return _possibleConstructorReturn(this, (KirlM.__proto__ || Object.getPrototypeOf(KirlM)).apply(this, arguments));
  }
...
_metalSoy2.default.register(KirlM, _stringSoy2.default);

exports.default = KirlM;
...
exports.templates = exports.KirlM = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace KirlM.
   * @public
   */

  goog.module('KirlM.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param1811 = function param1811() {
      ie_open('h6');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param1811 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'KirlM.render';
  }
...
_metalSoy2.default.register(KirlM, templates);
exports.KirlM = KirlM;
