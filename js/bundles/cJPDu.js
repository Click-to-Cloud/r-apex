...
var cJPDu = function (_Component) {
  _inherits(cJPDu, _Component);

  function cJPDu() {
    _classCallCheck(this, cJPDu);

    return _possibleConstructorReturn(this, (cJPDu.__proto__ || Object.getPrototypeOf(cJPDu)).apply(this, arguments));
  }
...
_metalSoy2.default.register(cJPDu, _indexSoy2.default);

exports.default = cJPDu;
...
exports.templates = exports.cJPDu = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace cJPDu.
   * @public
   */

  goog.module('cJPDu.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'cJPDu.render';
  }
...
_metalSoy2.default.register(cJPDu, templates);
exports.cJPDu = cJPDu;
