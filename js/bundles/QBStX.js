...
var QBStX = function (_Component) {
  _inherits(QBStX, _Component);

  function QBStX() {
    _classCallCheck(this, QBStX);

    return _possibleConstructorReturn(this, (QBStX.__proto__ || Object.getPrototypeOf(QBStX)).apply(this, arguments));
  }
...
_metalSoy2.default.register(QBStX, _step_6Soy2.default);

exports.default = QBStX;
...
exports.templates = exports.QBStX = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace QBStX.
   * @public
   */

  goog.module('QBStX.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'QBStX.render';
  }
...
_metalSoy2.default.register(QBStX, templates);
exports.QBStX = QBStX;
