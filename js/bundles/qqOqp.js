...
var _creationSoy = __webpack_require__(315);
...
var qqOqp = function (_Component) {
  _inherits(qqOqp, _Component);

  function qqOqp() {
    _classCallCheck(this, qqOqp);

    return _possibleConstructorReturn(this, (qqOqp.__proto__ || Object.getPrototypeOf(qqOqp)).apply(this, arguments));
  }
...
_metalSoy2.default.register(qqOqp, _creationSoy2.default);

exports.default = qqOqp;
...
exports.templates = exports.qqOqp = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace qqOqp.
   * @public
   */

  goog.module('qqOqp.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'qqOqp.render';
  }
...
_metalSoy2.default.register(qqOqp, templates);
exports.qqOqp = qqOqp;
