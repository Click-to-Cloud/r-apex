...
var NyCut = function (_Component) {
  _inherits(NyCut, _Component);

  function NyCut() {
    _classCallCheck(this, NyCut);

    return _possibleConstructorReturn(this, (NyCut.__proto__ || Object.getPrototypeOf(NyCut)).apply(this, arguments));
  }
...
_metalSoy2.default.register(NyCut, _listSoy2.default);

exports.default = NyCut;
...
exports.templates = exports.NyCut = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace NyCut.
   * @public
   */

  goog.module('NyCut.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'NyCut.render';
  }
...
_metalSoy2.default.register(NyCut, templates);
exports.NyCut = NyCut;
