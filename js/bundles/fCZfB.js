...
var fCZfB = function (_Component) {
  _inherits(fCZfB, _Component);

  function fCZfB() {
    _classCallCheck(this, fCZfB);

    return _possibleConstructorReturn(this, (fCZfB.__proto__ || Object.getPrototypeOf(fCZfB)).apply(this, arguments));
  }
...
_metalSoy2.default.register(fCZfB, _step_2Soy2.default);

exports.default = fCZfB;
...
exports.templates = exports.fCZfB = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace fCZfB.
   * @public
   */

  goog.module('fCZfB.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'fCZfB.render';
  }
...
_metalSoy2.default.register(fCZfB, templates);
exports.fCZfB = fCZfB;
