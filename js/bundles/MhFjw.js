...
var MhFjw = function (_Component) {
  _inherits(MhFjw, _Component);

  function MhFjw() {
    _classCallCheck(this, MhFjw);

    return _possibleConstructorReturn(this, (MhFjw.__proto__ || Object.getPrototypeOf(MhFjw)).apply(this, arguments));
  }
...
_metalSoy2.default.register(MhFjw, _step_4Soy2.default);

exports.default = MhFjw;
...
exports.templates = exports.MhFjw = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace MhFjw.
   * @public
   */

  goog.module('MhFjw.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'MhFjw.render';
  }
...
_metalSoy2.default.register(MhFjw, templates);
exports.MhFjw = MhFjw;
