...
var dXHhT = function (_Component) {
  _inherits(dXHhT, _Component);

  function dXHhT() {
    _classCallCheck(this, dXHhT);

    return _possibleConstructorReturn(this, (dXHhT.__proto__ || Object.getPrototypeOf(dXHhT)).apply(this, arguments));
  }
...
_metalSoy2.default.register(dXHhT, _mapSoy2.default);

exports.default = dXHhT;
...
exports.templates = exports.dXHhT = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace dXHhT.
   * @public
   */

  goog.module('dXHhT.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'dXHhT.render';
  }
...
_metalSoy2.default.register(dXHhT, templates);
exports.dXHhT = dXHhT;
