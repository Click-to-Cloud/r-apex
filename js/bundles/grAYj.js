...
var grAYj = function (_Component) {
  _inherits(grAYj, _Component);

  function grAYj() {
    _classCallCheck(this, grAYj);

    return _possibleConstructorReturn(this, (grAYj.__proto__ || Object.getPrototypeOf(grAYj)).apply(this, arguments));
  }
...
_metalSoy2.default.register(grAYj, _step_4Soy2.default);

exports.default = grAYj;
...
exports.templates = exports.grAYj = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace grAYj.
   * @public
   */

  goog.module('grAYj.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param2006 = function param2006() {
      ie_open('h2');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param2006 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'grAYj.render';
  }
...
_metalSoy2.default.register(grAYj, templates);
exports.grAYj = grAYj;
