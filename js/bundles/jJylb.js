...
var jJylb = function (_Component) {
  _inherits(jJylb, _Component);

  function jJylb() {
    _classCallCheck(this, jJylb);

    return _possibleConstructorReturn(this, (jJylb.__proto__ || Object.getPrototypeOf(jJylb)).apply(this, arguments));
  }
...
_metalSoy2.default.register(jJylb, _step_2Soy2.default);

exports.default = jJylb;
...
exports.templates = exports.jJylb = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace jJylb.
   * @public
   */

  goog.module('jJylb.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'jJylb.render';
  }
...
_metalSoy2.default.register(jJylb, templates);
exports.jJylb = jJylb;
