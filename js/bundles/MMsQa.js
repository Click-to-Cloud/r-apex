...
var MMsQa = function (_Component) {
  _inherits(MMsQa, _Component);

  function MMsQa() {
    _classCallCheck(this, MMsQa);

    return _possibleConstructorReturn(this, (MMsQa.__proto__ || Object.getPrototypeOf(MMsQa)).apply(this, arguments));
  }
...
_metalSoy2.default.register(MMsQa, _databaseSoy2.default);

exports.default = MMsQa;
...
exports.templates = exports.MMsQa = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace MMsQa.
   * @public
   */

  goog.module('MMsQa.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'MMsQa.render';
  }
...
_metalSoy2.default.register(MMsQa, templates);
exports.MMsQa = MMsQa;
