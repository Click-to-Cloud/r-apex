...
var sBjGe = function (_Component) {
  _inherits(sBjGe, _Component);

  function sBjGe() {
    _classCallCheck(this, sBjGe);

    return _possibleConstructorReturn(this, (sBjGe.__proto__ || Object.getPrototypeOf(sBjGe)).apply(this, arguments));
  }
...
_metalSoy2.default.register(sBjGe, _mapSoy2.default);

exports.default = sBjGe;
...
exports.templates = exports.sBjGe = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace sBjGe.
   * @public
   */

  goog.module('sBjGe.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param1090 = function param1090() {
      ie_open('h6');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param1090 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'sBjGe.render';
  }
...
_metalSoy2.default.register(sBjGe, templates);
exports.sBjGe = sBjGe;
