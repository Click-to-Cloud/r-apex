...
var _conditionSoy = __webpack_require__(293);
...
var pwAoe = function (_Component) {
  _inherits(pwAoe, _Component);

  function pwAoe() {
    _classCallCheck(this, pwAoe);

    return _possibleConstructorReturn(this, (pwAoe.__proto__ || Object.getPrototypeOf(pwAoe)).apply(this, arguments));
  }
...
_metalSoy2.default.register(pwAoe, _conditionSoy2.default);

exports.default = pwAoe;
...
exports.templates = exports.pwAoe = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace pwAoe.
   * @public
   */

  goog.module('pwAoe.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param1047 = function param1047() {
      ie_open('h6');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param1047 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'pwAoe.render';
  }
...
_metalSoy2.default.register(pwAoe, templates);
exports.pwAoe = pwAoe;
