...
var lznfx = function (_Component) {
  _inherits(lznfx, _Component);

  function lznfx() {
    _classCallCheck(this, lznfx);

    return _possibleConstructorReturn(this, (lznfx.__proto__ || Object.getPrototypeOf(lznfx)).apply(this, arguments));
  }
...
_metalSoy2.default.register(lznfx, _step_8Soy2.default);

exports.default = lznfx;
...
exports.templates = exports.lznfx = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace lznfx.
   * @public
   */

  goog.module('lznfx.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'lznfx.render';
  }
...
_metalSoy2.default.register(lznfx, templates);
exports.lznfx = lznfx;
