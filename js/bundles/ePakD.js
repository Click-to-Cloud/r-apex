...
var ePakD = function (_Component) {
  _inherits(ePakD, _Component);

  function ePakD() {
    _classCallCheck(this, ePakD);

    return _possibleConstructorReturn(this, (ePakD.__proto__ || Object.getPrototypeOf(ePakD)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ePakD, _indexSoy2.default);

exports.default = ePakD;
...
exports.templates = exports.ePakD = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ePakD.
   * @public
   */

  goog.module('ePakD.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ePakD.render';
  }
...
_metalSoy2.default.register(ePakD, templates);
exports.ePakD = ePakD;
