...
var zhryL = function (_Component) {
  _inherits(zhryL, _Component);

  function zhryL() {
    _classCallCheck(this, zhryL);

    return _possibleConstructorReturn(this, (zhryL.__proto__ || Object.getPrototypeOf(zhryL)).apply(this, arguments));
  }
...
_metalSoy2.default.register(zhryL, _step_6Soy2.default);

exports.default = zhryL;
...
exports.templates = exports.zhryL = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace zhryL.
   * @public
   */

  goog.module('zhryL.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'zhryL.render';
  }
...
_metalSoy2.default.register(zhryL, templates);
exports.zhryL = zhryL;
