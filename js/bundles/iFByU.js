...
var iFByU = function (_Component) {
  _inherits(iFByU, _Component);

  function iFByU() {
    _classCallCheck(this, iFByU);

    return _possibleConstructorReturn(this, (iFByU.__proto__ || Object.getPrototypeOf(iFByU)).apply(this, arguments));
  }
...
_metalSoy2.default.register(iFByU, _utilitySoy2.default);

exports.default = iFByU;
...
exports.templates = exports.iFByU = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace iFByU.
   * @public
   */

  goog.module('iFByU.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'iFByU.render';
  }
...
_metalSoy2.default.register(iFByU, templates);
exports.iFByU = iFByU;
