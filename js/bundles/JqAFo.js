...
var JqAFo = function (_Component) {
  _inherits(JqAFo, _Component);

  function JqAFo() {
    _classCallCheck(this, JqAFo);

    return _possibleConstructorReturn(this, (JqAFo.__proto__ || Object.getPrototypeOf(JqAFo)).apply(this, arguments));
  }
...
_metalSoy2.default.register(JqAFo, _relationSoy2.default);

exports.default = JqAFo;
...
exports.templates = exports.JqAFo = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace JqAFo.
   * @public
   */

  goog.module('JqAFo.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'JqAFo.render';
  }
...
_metalSoy2.default.register(JqAFo, templates);
exports.JqAFo = JqAFo;
