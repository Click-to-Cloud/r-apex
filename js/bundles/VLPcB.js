...
var VLPcB = function (_Component) {
  _inherits(VLPcB, _Component);

  function VLPcB() {
    _classCallCheck(this, VLPcB);

    return _possibleConstructorReturn(this, (VLPcB.__proto__ || Object.getPrototypeOf(VLPcB)).apply(this, arguments));
  }
...
_metalSoy2.default.register(VLPcB, _step_6Soy2.default);

exports.default = VLPcB;
...
exports.templates = exports.VLPcB = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace VLPcB.
   * @public
   */

  goog.module('VLPcB.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param2078 = function param2078() {
      ie_open('h2');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param2078 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'VLPcB.render';
  }
...
_metalSoy2.default.register(VLPcB, templates);
exports.VLPcB = VLPcB;
