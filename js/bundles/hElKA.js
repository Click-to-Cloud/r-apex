...
var hElKA = function (_Component) {
  _inherits(hElKA, _Component);

  function hElKA() {
    _classCallCheck(this, hElKA);

    return _possibleConstructorReturn(this, (hElKA.__proto__ || Object.getPrototypeOf(hElKA)).apply(this, arguments));
  }
...
_metalSoy2.default.register(hElKA, _listSoy2.default);

exports.default = hElKA;
...
exports.templates = exports.hElKA = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace hElKA.
   * @public
   */

  goog.module('hElKA.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param673 = function param673() {
      ie_open('h6');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'hElKA.render';
  }
...
_metalSoy2.default.register(hElKA, templates);
exports.hElKA = hElKA;
