...
var WDDGW = function (_Component) {
  _inherits(WDDGW, _Component);

  function WDDGW() {
    _classCallCheck(this, WDDGW);

    return _possibleConstructorReturn(this, (WDDGW.__proto__ || Object.getPrototypeOf(WDDGW)).apply(this, arguments));
  }
...
_metalSoy2.default.register(WDDGW, _functionSoy2.default);

exports.default = WDDGW;
...
exports.templates = exports.WDDGW = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace WDDGW.
   * @public
   */

  goog.module('WDDGW.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'WDDGW.render';
  }
...
_metalSoy2.default.register(WDDGW, templates);
exports.WDDGW = WDDGW;
