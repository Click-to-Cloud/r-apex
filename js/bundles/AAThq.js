...
var AAThq = function (_Component) {
  _inherits(AAThq, _Component);

  function AAThq() {
    _classCallCheck(this, AAThq);

    return _possibleConstructorReturn(this, (AAThq.__proto__ || Object.getPrototypeOf(AAThq)).apply(this, arguments));
  }
...
_metalSoy2.default.register(AAThq, _indexSoy2.default);

exports.default = AAThq;
...
exports.templates = exports.AAThq = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace AAThq.
   * @public
   */

  goog.module('AAThq.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param1267 = function param1267() {
      ie_open('h6');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param1267 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'AAThq.render';
  }
...
_metalSoy2.default.register(AAThq, templates);
exports.AAThq = AAThq;
