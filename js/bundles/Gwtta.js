...
var Gwtta = function (_Component) {
  _inherits(Gwtta, _Component);

  function Gwtta() {
    _classCallCheck(this, Gwtta);

    return _possibleConstructorReturn(this, (Gwtta.__proto__ || Object.getPrototypeOf(Gwtta)).apply(this, arguments));
  }
...
_metalSoy2.default.register(Gwtta, _indexSoy2.default);

exports.default = Gwtta;
...
exports.templates = exports.Gwtta = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace Gwtta.
   * @public
   */

  goog.module('Gwtta.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'Gwtta.render';
  }
...
_metalSoy2.default.register(Gwtta, templates);
exports.Gwtta = Gwtta;
