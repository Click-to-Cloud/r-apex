...
var CvhUA = function (_Component) {
  _inherits(CvhUA, _Component);

  function CvhUA() {
    _classCallCheck(this, CvhUA);

    return _possibleConstructorReturn(this, (CvhUA.__proto__ || Object.getPrototypeOf(CvhUA)).apply(this, arguments));
  }
...
_metalSoy2.default.register(CvhUA, _step_7Soy2.default);

exports.default = CvhUA;
...
exports.templates = exports.CvhUA = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace CvhUA.
   * @public
   */

  goog.module('CvhUA.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'CvhUA.render';
  }
...
_metalSoy2.default.register(CvhUA, templates);
exports.CvhUA = CvhUA;
