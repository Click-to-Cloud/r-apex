...
var bGhHv = function (_Component) {
  _inherits(bGhHv, _Component);

  function bGhHv() {
    _classCallCheck(this, bGhHv);

    return _possibleConstructorReturn(this, (bGhHv.__proto__ || Object.getPrototypeOf(bGhHv)).apply(this, arguments));
  }
...
_metalSoy2.default.register(bGhHv, _step_5Soy2.default);

exports.default = bGhHv;
...
exports.templates = exports.bGhHv = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace bGhHv.
   * @public
   */

  goog.module('bGhHv.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'bGhHv.render';
  }
...
_metalSoy2.default.register(bGhHv, templates);
exports.bGhHv = bGhHv;
