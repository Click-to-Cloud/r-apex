...
var Fystj = function (_Component) {
  _inherits(Fystj, _Component);

  function Fystj() {
    _classCallCheck(this, Fystj);

    return _possibleConstructorReturn(this, (Fystj.__proto__ || Object.getPrototypeOf(Fystj)).apply(this, arguments));
  }
...
_metalSoy2.default.register(Fystj, _arithmeticSoy2.default);

exports.default = Fystj;
...
exports.templates = exports.Fystj = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace Fystj.
   * @public
   */

  goog.module('Fystj.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'Fystj.render';
  }
...
_metalSoy2.default.register(Fystj, templates);
exports.Fystj = Fystj;
