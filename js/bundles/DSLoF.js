...
var DSLoF = function (_Component) {
  _inherits(DSLoF, _Component);

  function DSLoF() {
    _classCallCheck(this, DSLoF);

    return _possibleConstructorReturn(this, (DSLoF.__proto__ || Object.getPrototypeOf(DSLoF)).apply(this, arguments));
  }
...
_metalSoy2.default.register(DSLoF, _conversionSoy2.default);

exports.default = DSLoF;
...
exports.templates = exports.DSLoF = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace DSLoF.
   * @public
   */

  goog.module('DSLoF.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'DSLoF.render';
  }
...
_metalSoy2.default.register(DSLoF, templates);
exports.DSLoF = DSLoF;
