...
var ftbJa = function (_Component) {
  _inherits(ftbJa, _Component);

  function ftbJa() {
    _classCallCheck(this, ftbJa);

    return _possibleConstructorReturn(this, (ftbJa.__proto__ || Object.getPrototypeOf(ftbJa)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ftbJa, _step_5Soy2.default);

exports.default = ftbJa;
...
exports.templates = exports.ftbJa = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ftbJa.
   * @public
   */

  goog.module('ftbJa.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ftbJa.render';
  }
...
_metalSoy2.default.register(ftbJa, templates);
exports.ftbJa = ftbJa;
