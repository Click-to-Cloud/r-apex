...
var BqiOI = function (_Component) {
  _inherits(BqiOI, _Component);

  function BqiOI() {
    _classCallCheck(this, BqiOI);

    return _possibleConstructorReturn(this, (BqiOI.__proto__ || Object.getPrototypeOf(BqiOI)).apply(this, arguments));
  }
...
_metalSoy2.default.register(BqiOI, _comparatorSoy2.default);

exports.default = BqiOI;
...
exports.templates = exports.BqiOI = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace BqiOI.
   * @public
   */

  goog.module('BqiOI.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'BqiOI.render';
  }
...
_metalSoy2.default.register(BqiOI, templates);
exports.BqiOI = BqiOI;
