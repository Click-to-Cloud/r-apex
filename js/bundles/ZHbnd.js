...
var ZHbnd = function (_Component) {
  _inherits(ZHbnd, _Component);

  function ZHbnd() {
    _classCallCheck(this, ZHbnd);

    return _possibleConstructorReturn(this, (ZHbnd.__proto__ || Object.getPrototypeOf(ZHbnd)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ZHbnd, _step_2Soy2.default);

exports.default = ZHbnd;
...
exports.templates = exports.ZHbnd = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ZHbnd.
   * @public
   */

  goog.module('ZHbnd.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ZHbnd.render';
  }
...
_metalSoy2.default.register(ZHbnd, templates);
exports.ZHbnd = ZHbnd;
