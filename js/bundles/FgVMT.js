...
var FgVMT = function (_Component) {
  _inherits(FgVMT, _Component);

  function FgVMT() {
    _classCallCheck(this, FgVMT);

    return _possibleConstructorReturn(this, (FgVMT.__proto__ || Object.getPrototypeOf(FgVMT)).apply(this, arguments));
  }
...
_metalSoy2.default.register(FgVMT, _step_7Soy2.default);

exports.default = FgVMT;
...
exports.templates = exports.FgVMT = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace FgVMT.
   * @public
   */

  goog.module('FgVMT.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'FgVMT.render';
  }
...
_metalSoy2.default.register(FgVMT, templates);
exports.FgVMT = FgVMT;
