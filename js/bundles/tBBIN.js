...
var tBBIN = function (_Component) {
  _inherits(tBBIN, _Component);

  function tBBIN() {
    _classCallCheck(this, tBBIN);

    return _possibleConstructorReturn(this, (tBBIN.__proto__ || Object.getPrototypeOf(tBBIN)).apply(this, arguments));
  }
...
_metalSoy2.default.register(tBBIN, _step_3Soy2.default);

exports.default = tBBIN;
...
exports.templates = exports.tBBIN = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace tBBIN.
   * @public
   */

  goog.module('tBBIN.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'tBBIN.render';
  }
...
_metalSoy2.default.register(tBBIN, templates);
exports.tBBIN = tBBIN;
