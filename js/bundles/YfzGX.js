...
var YfzGX = function (_Component) {
  _inherits(YfzGX, _Component);

  function YfzGX() {
    _classCallCheck(this, YfzGX);

    return _possibleConstructorReturn(this, (YfzGX.__proto__ || Object.getPrototypeOf(YfzGX)).apply(this, arguments));
  }
...
_metalSoy2.default.register(YfzGX, _step_4Soy2.default);

exports.default = YfzGX;
...
exports.templates = exports.YfzGX = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace YfzGX.
   * @public
   */

  goog.module('YfzGX.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param2036 = function param2036() {
      ie_open('h2');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param2036 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'YfzGX.render';
  }
...
_metalSoy2.default.register(YfzGX, templates);
exports.YfzGX = YfzGX;
