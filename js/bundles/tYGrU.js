...
var _relationSoy = __webpack_require__(289);
...
var tYGrU = function (_Component) {
  _inherits(tYGrU, _Component);

  function tYGrU() {
    _classCallCheck(this, tYGrU);

    return _possibleConstructorReturn(this, (tYGrU.__proto__ || Object.getPrototypeOf(tYGrU)).apply(this, arguments));
  }
...
_metalSoy2.default.register(tYGrU, _relationSoy2.default);

exports.default = tYGrU;
...
exports.templates = exports.tYGrU = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace tYGrU.
   * @public
   */

  goog.module('tYGrU.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param1089 = function param1089() {
      ie_open('h6');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param1089 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'tYGrU.render';
  }
...
_metalSoy2.default.register(tYGrU, templates);
exports.tYGrU = tYGrU;
