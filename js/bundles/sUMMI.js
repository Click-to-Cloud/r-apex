...
var sUMMI = function (_Component) {
  _inherits(sUMMI, _Component);

  function sUMMI() {
    _classCallCheck(this, sUMMI);

    return _possibleConstructorReturn(this, (sUMMI.__proto__ || Object.getPrototypeOf(sUMMI)).apply(this, arguments));
  }
...
_metalSoy2.default.register(sUMMI, _stringSoy2.default);

exports.default = sUMMI;
...
exports.templates = exports.sUMMI = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace sUMMI.
   * @public
   */

  goog.module('sUMMI.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param1232 = function param1232() {
      ie_open('h6');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param1232 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'sUMMI.render';
  }
...
_metalSoy2.default.register(sUMMI, templates);
exports.sUMMI = sUMMI;
