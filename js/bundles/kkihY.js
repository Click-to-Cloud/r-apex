...
var kkihY = function (_Component) {
  _inherits(kkihY, _Component);

  function kkihY() {
    _classCallCheck(this, kkihY);

    return _possibleConstructorReturn(this, (kkihY.__proto__ || Object.getPrototypeOf(kkihY)).apply(this, arguments));
  }
...
_metalSoy2.default.register(kkihY, _stringSoy2.default);

exports.default = kkihY;
...
exports.templates = exports.kkihY = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace kkihY.
   * @public
   */

  goog.module('kkihY.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'kkihY.render';
  }
...
_metalSoy2.default.register(kkihY, templates);
exports.kkihY = kkihY;
