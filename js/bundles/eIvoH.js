...
var eIvoH = function (_Component) {
  _inherits(eIvoH, _Component);

  function eIvoH() {
    _classCallCheck(this, eIvoH);

    return _possibleConstructorReturn(this, (eIvoH.__proto__ || Object.getPrototypeOf(eIvoH)).apply(this, arguments));
  }
...
_metalSoy2.default.register(eIvoH, _functionSoy2.default);

exports.default = eIvoH;
...
exports.templates = exports.eIvoH = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace eIvoH.
   * @public
   */

  goog.module('eIvoH.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param1135 = function param1135() {
      ie_open('h6');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'eIvoH.render';
  }
...
_metalSoy2.default.register(eIvoH, templates);
exports.eIvoH = eIvoH;
