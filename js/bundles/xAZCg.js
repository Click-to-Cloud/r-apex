...
var xAZCg = function (_Component) {
  _inherits(xAZCg, _Component);

  function xAZCg() {
    _classCallCheck(this, xAZCg);

    return _possibleConstructorReturn(this, (xAZCg.__proto__ || Object.getPrototypeOf(xAZCg)).apply(this, arguments));
  }
...
_metalSoy2.default.register(xAZCg, _mapSoy2.default);

exports.default = xAZCg;
...
exports.templates = exports.xAZCg = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace xAZCg.
   * @public
   */

  goog.module('xAZCg.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'xAZCg.render';
  }
...
_metalSoy2.default.register(xAZCg, templates);
exports.xAZCg = xAZCg;
