...
var jwbvI = function (_Component) {
  _inherits(jwbvI, _Component);

  function jwbvI() {
    _classCallCheck(this, jwbvI);

    return _possibleConstructorReturn(this, (jwbvI.__proto__ || Object.getPrototypeOf(jwbvI)).apply(this, arguments));
  }
...
_metalSoy2.default.register(jwbvI, _utilitySoy2.default);

exports.default = jwbvI;
...
exports.templates = exports.jwbvI = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace jwbvI.
   * @public
   */

  goog.module('jwbvI.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param1877 = function param1877() {
      ie_open('h6');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param1877 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'jwbvI.render';
  }
...
_metalSoy2.default.register(jwbvI, templates);
exports.jwbvI = jwbvI;
