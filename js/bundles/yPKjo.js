...
var yPKjo = function (_Component) {
  _inherits(yPKjo, _Component);

  function yPKjo() {
    _classCallCheck(this, yPKjo);

    return _possibleConstructorReturn(this, (yPKjo.__proto__ || Object.getPrototypeOf(yPKjo)).apply(this, arguments));
  }
...
_metalSoy2.default.register(yPKjo, _utilitySoy2.default);

exports.default = yPKjo;
...
exports.templates = exports.yPKjo = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace yPKjo.
   * @public
   */

  goog.module('yPKjo.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param1303 = function param1303() {
      ie_open('h6');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param1303 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'yPKjo.render';
  }
...
_metalSoy2.default.register(yPKjo, templates);
exports.yPKjo = yPKjo;
