...
var prTUq = function (_Component) {
  _inherits(prTUq, _Component);

  function prTUq() {
    _classCallCheck(this, prTUq);

    return _possibleConstructorReturn(this, (prTUq.__proto__ || Object.getPrototypeOf(prTUq)).apply(this, arguments));
  }
...
_metalSoy2.default.register(prTUq, _step_3Soy2.default);

exports.default = prTUq;
...
exports.templates = exports.prTUq = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace prTUq.
   * @public
   */

  goog.module('prTUq.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param1980 = function param1980() {
      ie_open('h2');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'prTUq.render';
  }
...
_metalSoy2.default.register(prTUq, templates);
exports.prTUq = prTUq;
