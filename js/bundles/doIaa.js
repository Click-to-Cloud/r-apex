...
var doIaa = function (_Component) {
  _inherits(doIaa, _Component);

  function doIaa() {
    _classCallCheck(this, doIaa);

    return _possibleConstructorReturn(this, (doIaa.__proto__ || Object.getPrototypeOf(doIaa)).apply(this, arguments));
  }
...
_metalSoy2.default.register(doIaa, _comparatorSoy2.default);

exports.default = doIaa;
...
exports.templates = exports.doIaa = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace doIaa.
   * @public
   */

  goog.module('doIaa.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'doIaa.render';
  }
...
_metalSoy2.default.register(doIaa, templates);
exports.doIaa = doIaa;
