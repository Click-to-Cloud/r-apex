...
var _relationSoy = __webpack_require__(307);
...
var DeSAr = function (_Component) {
  _inherits(DeSAr, _Component);

  function DeSAr() {
    _classCallCheck(this, DeSAr);

    return _possibleConstructorReturn(this, (DeSAr.__proto__ || Object.getPrototypeOf(DeSAr)).apply(this, arguments));
  }
...
_metalSoy2.default.register(DeSAr, _relationSoy2.default);

exports.default = DeSAr;
...
exports.templates = exports.DeSAr = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace DeSAr.
   * @public
   */

  goog.module('DeSAr.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param1724 = function param1724() {
      ie_open('h6');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param1724 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'DeSAr.render';
  }
...
_metalSoy2.default.register(DeSAr, templates);
exports.DeSAr = DeSAr;
