...
var fVbJS = function (_Component) {
  _inherits(fVbJS, _Component);

  function fVbJS() {
    _classCallCheck(this, fVbJS);

    return _possibleConstructorReturn(this, (fVbJS.__proto__ || Object.getPrototypeOf(fVbJS)).apply(this, arguments));
  }
...
_metalSoy2.default.register(fVbJS, _conditionSoy2.default);

exports.default = fVbJS;
...
exports.templates = exports.fVbJS = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace fVbJS.
   * @public
   */

  goog.module('fVbJS.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'fVbJS.render';
  }
...
_metalSoy2.default.register(fVbJS, templates);
exports.fVbJS = fVbJS;
