...
var OGGrI = function (_Component) {
  _inherits(OGGrI, _Component);

  function OGGrI() {
    _classCallCheck(this, OGGrI);

    return _possibleConstructorReturn(this, (OGGrI.__proto__ || Object.getPrototypeOf(OGGrI)).apply(this, arguments));
  }
...
_metalSoy2.default.register(OGGrI, _step_7Soy2.default);

exports.default = OGGrI;
...
exports.templates = exports.OGGrI = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace OGGrI.
   * @public
   */

  goog.module('OGGrI.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'OGGrI.render';
  }
...
_metalSoy2.default.register(OGGrI, templates);
exports.OGGrI = OGGrI;
