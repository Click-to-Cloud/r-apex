...
var UPtpi = function (_Component) {
  _inherits(UPtpi, _Component);

  function UPtpi() {
    _classCallCheck(this, UPtpi);

    return _possibleConstructorReturn(this, (UPtpi.__proto__ || Object.getPrototypeOf(UPtpi)).apply(this, arguments));
  }
...
_metalSoy2.default.register(UPtpi, _conversionSoy2.default);

exports.default = UPtpi;
...
exports.templates = exports.UPtpi = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace UPtpi.
   * @public
   */

  goog.module('UPtpi.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'UPtpi.render';
  }
...
_metalSoy2.default.register(UPtpi, templates);
exports.UPtpi = UPtpi;
