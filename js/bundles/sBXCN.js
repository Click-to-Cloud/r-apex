...
var sBXCN = function (_Component) {
  _inherits(sBXCN, _Component);

  function sBXCN() {
    _classCallCheck(this, sBXCN);

    return _possibleConstructorReturn(this, (sBXCN.__proto__ || Object.getPrototypeOf(sBXCN)).apply(this, arguments));
  }
...
_metalSoy2.default.register(sBXCN, _functionSoy2.default);

exports.default = sBXCN;
...
exports.templates = exports.sBXCN = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace sBXCN.
   * @public
   */

  goog.module('sBXCN.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'sBXCN.render';
  }
...
_metalSoy2.default.register(sBXCN, templates);
exports.sBXCN = sBXCN;
