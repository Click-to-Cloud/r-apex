...
var aLwnJ = function (_Component) {
  _inherits(aLwnJ, _Component);

  function aLwnJ() {
    _classCallCheck(this, aLwnJ);

    return _possibleConstructorReturn(this, (aLwnJ.__proto__ || Object.getPrototypeOf(aLwnJ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(aLwnJ, _step_5Soy2.default);

exports.default = aLwnJ;
...
exports.templates = exports.aLwnJ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace aLwnJ.
   * @public
   */

  goog.module('aLwnJ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'aLwnJ.render';
  }
...
_metalSoy2.default.register(aLwnJ, templates);
exports.aLwnJ = aLwnJ;
