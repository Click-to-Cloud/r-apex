...
var _mapSoy = __webpack_require__(287);
...
var CJDst = function (_Component) {
  _inherits(CJDst, _Component);

  function CJDst() {
    _classCallCheck(this, CJDst);

    return _possibleConstructorReturn(this, (CJDst.__proto__ || Object.getPrototypeOf(CJDst)).apply(this, arguments));
  }
...
_metalSoy2.default.register(CJDst, _mapSoy2.default);

exports.default = CJDst;
...
exports.templates = exports.CJDst = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace CJDst.
   * @public
   */

  goog.module('CJDst.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'CJDst.render';
  }
...
_metalSoy2.default.register(CJDst, templates);
exports.CJDst = CJDst;
