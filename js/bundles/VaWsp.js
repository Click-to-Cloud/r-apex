...
var VaWsp = function (_Component) {
  _inherits(VaWsp, _Component);

  function VaWsp() {
    _classCallCheck(this, VaWsp);

    return _possibleConstructorReturn(this, (VaWsp.__proto__ || Object.getPrototypeOf(VaWsp)).apply(this, arguments));
  }
...
_metalSoy2.default.register(VaWsp, _relationSoy2.default);

exports.default = VaWsp;
...
exports.templates = exports.VaWsp = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace VaWsp.
   * @public
   */

  goog.module('VaWsp.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'VaWsp.render';
  }
...
_metalSoy2.default.register(VaWsp, templates);
exports.VaWsp = VaWsp;
