...
var vPRPX = function (_Component) {
  _inherits(vPRPX, _Component);

  function vPRPX() {
    _classCallCheck(this, vPRPX);

    return _possibleConstructorReturn(this, (vPRPX.__proto__ || Object.getPrototypeOf(vPRPX)).apply(this, arguments));
  }
...
_metalSoy2.default.register(vPRPX, _step_5Soy2.default);

exports.default = vPRPX;
...
exports.templates = exports.vPRPX = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace vPRPX.
   * @public
   */

  goog.module('vPRPX.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'vPRPX.render';
  }
...
_metalSoy2.default.register(vPRPX, templates);
exports.vPRPX = vPRPX;
