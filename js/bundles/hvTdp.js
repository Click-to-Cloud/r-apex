...
var _mapSoy = __webpack_require__(289);
...
var hvTdp = function (_Component) {
  _inherits(hvTdp, _Component);

  function hvTdp() {
    _classCallCheck(this, hvTdp);

    return _possibleConstructorReturn(this, (hvTdp.__proto__ || Object.getPrototypeOf(hvTdp)).apply(this, arguments));
  }
...
_metalSoy2.default.register(hvTdp, _mapSoy2.default);

exports.default = hvTdp;
...
exports.templates = exports.hvTdp = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace hvTdp.
   * @public
   */

  goog.module('hvTdp.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param1684 = function param1684() {
      ie_open('h6');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param1684 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'hvTdp.render';
  }
...
_metalSoy2.default.register(hvTdp, templates);
exports.hvTdp = hvTdp;
