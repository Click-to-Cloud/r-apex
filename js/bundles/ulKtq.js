...
var ulKtq = function (_Component) {
  _inherits(ulKtq, _Component);

  function ulKtq() {
    _classCallCheck(this, ulKtq);

    return _possibleConstructorReturn(this, (ulKtq.__proto__ || Object.getPrototypeOf(ulKtq)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ulKtq, _comparatorSoy2.default);

exports.default = ulKtq;
...
exports.templates = exports.ulKtq = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ulKtq.
   * @public
   */

  goog.module('ulKtq.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ulKtq.render';
  }
...
_metalSoy2.default.register(ulKtq, templates);
exports.ulKtq = ulKtq;
