...
var YCWau = function (_Component) {
  _inherits(YCWau, _Component);

  function YCWau() {
    _classCallCheck(this, YCWau);

    return _possibleConstructorReturn(this, (YCWau.__proto__ || Object.getPrototypeOf(YCWau)).apply(this, arguments));
  }
...
_metalSoy2.default.register(YCWau, _step_5Soy2.default);

exports.default = YCWau;
...
exports.templates = exports.YCWau = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace YCWau.
   * @public
   */

  goog.module('YCWau.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param2037 = function param2037() {
      ie_open('h2');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param2037 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'YCWau.render';
  }
...
_metalSoy2.default.register(YCWau, templates);
exports.YCWau = YCWau;
