...
var Wreqr = function (_Component) {
  _inherits(Wreqr, _Component);

  function Wreqr() {
    _classCallCheck(this, Wreqr);

    return _possibleConstructorReturn(this, (Wreqr.__proto__ || Object.getPrototypeOf(Wreqr)).apply(this, arguments));
  }
...
_metalSoy2.default.register(Wreqr, _step_7Soy2.default);

exports.default = Wreqr;
...
exports.templates = exports.Wreqr = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace Wreqr.
   * @public
   */

  goog.module('Wreqr.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param2094 = function param2094() {
      ie_open('h2');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param2094 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'Wreqr.render';
  }
...
_metalSoy2.default.register(Wreqr, templates);
exports.Wreqr = Wreqr;
