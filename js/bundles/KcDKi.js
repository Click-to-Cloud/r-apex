...
var KcDKi = function (_Component) {
  _inherits(KcDKi, _Component);

  function KcDKi() {
    _classCallCheck(this, KcDKi);

    return _possibleConstructorReturn(this, (KcDKi.__proto__ || Object.getPrototypeOf(KcDKi)).apply(this, arguments));
  }
...
_metalSoy2.default.register(KcDKi, _step_3Soy2.default);

exports.default = KcDKi;
...
exports.templates = exports.KcDKi = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace KcDKi.
   * @public
   */

  goog.module('KcDKi.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'KcDKi.render';
  }
...
_metalSoy2.default.register(KcDKi, templates);
exports.KcDKi = KcDKi;
