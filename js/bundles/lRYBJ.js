...
var _comparatorSoy = __webpack_require__(273);
...
var lRYBJ = function (_Component) {
  _inherits(lRYBJ, _Component);

  function lRYBJ() {
    _classCallCheck(this, lRYBJ);

    return _possibleConstructorReturn(this, (lRYBJ.__proto__ || Object.getPrototypeOf(lRYBJ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(lRYBJ, _comparatorSoy2.default);

exports.default = lRYBJ;
...
exports.templates = exports.lRYBJ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace lRYBJ.
   * @public
   */

  goog.module('lRYBJ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'lRYBJ.render';
  }
...
_metalSoy2.default.register(lRYBJ, templates);
exports.lRYBJ = lRYBJ;
