...
var gMaAa = function (_Component) {
  _inherits(gMaAa, _Component);

  function gMaAa() {
    _classCallCheck(this, gMaAa);

    return _possibleConstructorReturn(this, (gMaAa.__proto__ || Object.getPrototypeOf(gMaAa)).apply(this, arguments));
  }
...
_metalSoy2.default.register(gMaAa, _conditionSoy2.default);

exports.default = gMaAa;
...
exports.templates = exports.gMaAa = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace gMaAa.
   * @public
   */

  goog.module('gMaAa.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'gMaAa.render';
  }
...
_metalSoy2.default.register(gMaAa, templates);
exports.gMaAa = gMaAa;
