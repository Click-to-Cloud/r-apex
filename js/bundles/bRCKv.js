...
var bRCKv = function (_Component) {
  _inherits(bRCKv, _Component);

  function bRCKv() {
    _classCallCheck(this, bRCKv);

    return _possibleConstructorReturn(this, (bRCKv.__proto__ || Object.getPrototypeOf(bRCKv)).apply(this, arguments));
  }
...
_metalSoy2.default.register(bRCKv, _conversionSoy2.default);

exports.default = bRCKv;
...
exports.templates = exports.bRCKv = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace bRCKv.
   * @public
   */

  goog.module('bRCKv.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'bRCKv.render';
  }
...
_metalSoy2.default.register(bRCKv, templates);
exports.bRCKv = bRCKv;
