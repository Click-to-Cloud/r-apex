...
var fwsIX = function (_Component) {
  _inherits(fwsIX, _Component);

  function fwsIX() {
    _classCallCheck(this, fwsIX);

    return _possibleConstructorReturn(this, (fwsIX.__proto__ || Object.getPrototypeOf(fwsIX)).apply(this, arguments));
  }
...
_metalSoy2.default.register(fwsIX, _conversionSoy2.default);

exports.default = fwsIX;
...
exports.templates = exports.fwsIX = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace fwsIX.
   * @public
   */

  goog.module('fwsIX.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'fwsIX.render';
  }
...
_metalSoy2.default.register(fwsIX, templates);
exports.fwsIX = fwsIX;
