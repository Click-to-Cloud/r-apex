...
var PvoSa = function (_Component) {
  _inherits(PvoSa, _Component);

  function PvoSa() {
    _classCallCheck(this, PvoSa);

    return _possibleConstructorReturn(this, (PvoSa.__proto__ || Object.getPrototypeOf(PvoSa)).apply(this, arguments));
  }
...
_metalSoy2.default.register(PvoSa, _step_7Soy2.default);

exports.default = PvoSa;
...
exports.templates = exports.PvoSa = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace PvoSa.
   * @public
   */

  goog.module('PvoSa.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param2074 = function param2074() {
      ie_open('h2');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param2074 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'PvoSa.render';
  }
...
_metalSoy2.default.register(PvoSa, templates);
exports.PvoSa = PvoSa;
