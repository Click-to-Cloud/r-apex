...
var Nfvks = function (_Component) {
  _inherits(Nfvks, _Component);

  function Nfvks() {
    _classCallCheck(this, Nfvks);

    return _possibleConstructorReturn(this, (Nfvks.__proto__ || Object.getPrototypeOf(Nfvks)).apply(this, arguments));
  }
...
_metalSoy2.default.register(Nfvks, _creationSoy2.default);

exports.default = Nfvks;
...
exports.templates = exports.Nfvks = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace Nfvks.
   * @public
   */

  goog.module('Nfvks.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'Nfvks.render';
  }
...
_metalSoy2.default.register(Nfvks, templates);
exports.Nfvks = Nfvks;
