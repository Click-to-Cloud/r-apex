...
var gtKOi = function (_Component) {
  _inherits(gtKOi, _Component);

  function gtKOi() {
    _classCallCheck(this, gtKOi);

    return _possibleConstructorReturn(this, (gtKOi.__proto__ || Object.getPrototypeOf(gtKOi)).apply(this, arguments));
  }
...
_metalSoy2.default.register(gtKOi, _functionSoy2.default);

exports.default = gtKOi;
...
exports.templates = exports.gtKOi = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace gtKOi.
   * @public
   */

  goog.module('gtKOi.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'gtKOi.render';
  }
...
_metalSoy2.default.register(gtKOi, templates);
exports.gtKOi = gtKOi;
