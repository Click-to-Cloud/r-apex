...
var yDyKJ = function (_Component) {
  _inherits(yDyKJ, _Component);

  function yDyKJ() {
    _classCallCheck(this, yDyKJ);

    return _possibleConstructorReturn(this, (yDyKJ.__proto__ || Object.getPrototypeOf(yDyKJ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(yDyKJ, _logicSoy2.default);

exports.default = yDyKJ;
...
exports.templates = exports.yDyKJ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace yDyKJ.
   * @public
   */

  goog.module('yDyKJ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'yDyKJ.render';
  }
...
_metalSoy2.default.register(yDyKJ, templates);
exports.yDyKJ = yDyKJ;
