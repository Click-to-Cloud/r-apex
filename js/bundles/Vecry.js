...
var Vecry = function (_Component) {
  _inherits(Vecry, _Component);

  function Vecry() {
    _classCallCheck(this, Vecry);

    return _possibleConstructorReturn(this, (Vecry.__proto__ || Object.getPrototypeOf(Vecry)).apply(this, arguments));
  }
...
_metalSoy2.default.register(Vecry, _conversionSoy2.default);

exports.default = Vecry;
...
exports.templates = exports.Vecry = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace Vecry.
   * @public
   */

  goog.module('Vecry.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'Vecry.render';
  }
...
_metalSoy2.default.register(Vecry, templates);
exports.Vecry = Vecry;
