...
var nZETi = function (_Component) {
  _inherits(nZETi, _Component);

  function nZETi() {
    _classCallCheck(this, nZETi);

    return _possibleConstructorReturn(this, (nZETi.__proto__ || Object.getPrototypeOf(nZETi)).apply(this, arguments));
  }
...
_metalSoy2.default.register(nZETi, _stringSoy2.default);

exports.default = nZETi;
...
exports.templates = exports.nZETi = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace nZETi.
   * @public
   */

  goog.module('nZETi.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'nZETi.render';
  }
...
_metalSoy2.default.register(nZETi, templates);
exports.nZETi = nZETi;
