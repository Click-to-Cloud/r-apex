...
var QZMVN = function (_Component) {
  _inherits(QZMVN, _Component);

  function QZMVN() {
    _classCallCheck(this, QZMVN);

    return _possibleConstructorReturn(this, (QZMVN.__proto__ || Object.getPrototypeOf(QZMVN)).apply(this, arguments));
  }
...
_metalSoy2.default.register(QZMVN, _indexSoy2.default);

exports.default = QZMVN;
...
exports.templates = exports.QZMVN = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace QZMVN.
   * @public
   */

  goog.module('QZMVN.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'QZMVN.render';
  }
...
_metalSoy2.default.register(QZMVN, templates);
exports.QZMVN = QZMVN;
