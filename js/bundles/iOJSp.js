...
var iOJSp = function (_Component) {
  _inherits(iOJSp, _Component);

  function iOJSp() {
    _classCallCheck(this, iOJSp);

    return _possibleConstructorReturn(this, (iOJSp.__proto__ || Object.getPrototypeOf(iOJSp)).apply(this, arguments));
  }
...
_metalSoy2.default.register(iOJSp, _conversionSoy2.default);

exports.default = iOJSp;
...
exports.templates = exports.iOJSp = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace iOJSp.
   * @public
   */

  goog.module('iOJSp.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'iOJSp.render';
  }
...
_metalSoy2.default.register(iOJSp, templates);
exports.iOJSp = iOJSp;
