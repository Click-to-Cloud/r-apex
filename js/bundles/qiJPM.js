...
var qiJPM = function (_Component) {
  _inherits(qiJPM, _Component);

  function qiJPM() {
    _classCallCheck(this, qiJPM);

    return _possibleConstructorReturn(this, (qiJPM.__proto__ || Object.getPrototypeOf(qiJPM)).apply(this, arguments));
  }
...
_metalSoy2.default.register(qiJPM, _mapSoy2.default);

exports.default = qiJPM;
...
exports.templates = exports.qiJPM = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace qiJPM.
   * @public
   */

  goog.module('qiJPM.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'qiJPM.render';
  }
...
_metalSoy2.default.register(qiJPM, templates);
exports.qiJPM = qiJPM;
