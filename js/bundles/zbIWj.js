...
var zbIWj = function (_Component) {
  _inherits(zbIWj, _Component);

  function zbIWj() {
    _classCallCheck(this, zbIWj);

    return _possibleConstructorReturn(this, (zbIWj.__proto__ || Object.getPrototypeOf(zbIWj)).apply(this, arguments));
  }
...
_metalSoy2.default.register(zbIWj, _logicSoy2.default);

exports.default = zbIWj;
...
exports.templates = exports.zbIWj = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace zbIWj.
   * @public
   */

  goog.module('zbIWj.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'zbIWj.render';
  }
...
_metalSoy2.default.register(zbIWj, templates);
exports.zbIWj = zbIWj;
