...
var HxDDq = function (_Component) {
  _inherits(HxDDq, _Component);

  function HxDDq() {
    _classCallCheck(this, HxDDq);

    return _possibleConstructorReturn(this, (HxDDq.__proto__ || Object.getPrototypeOf(HxDDq)).apply(this, arguments));
  }
...
_metalSoy2.default.register(HxDDq, _step_6Soy2.default);

exports.default = HxDDq;
...
exports.templates = exports.HxDDq = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace HxDDq.
   * @public
   */

  goog.module('HxDDq.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'HxDDq.render';
  }
...
_metalSoy2.default.register(HxDDq, templates);
exports.HxDDq = HxDDq;
