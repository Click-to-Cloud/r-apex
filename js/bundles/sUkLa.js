...
var sUkLa = function (_Component) {
  _inherits(sUkLa, _Component);

  function sUkLa() {
    _classCallCheck(this, sUkLa);

    return _possibleConstructorReturn(this, (sUkLa.__proto__ || Object.getPrototypeOf(sUkLa)).apply(this, arguments));
  }
...
_metalSoy2.default.register(sUkLa, _step_6Soy2.default);

exports.default = sUkLa;
...
exports.templates = exports.sUkLa = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace sUkLa.
   * @public
   */

  goog.module('sUkLa.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'sUkLa.render';
  }
...
_metalSoy2.default.register(sUkLa, templates);
exports.sUkLa = sUkLa;
