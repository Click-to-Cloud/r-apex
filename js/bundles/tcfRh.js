...
var tcfRh = function (_Component) {
  _inherits(tcfRh, _Component);

  function tcfRh() {
    _classCallCheck(this, tcfRh);

    return _possibleConstructorReturn(this, (tcfRh.__proto__ || Object.getPrototypeOf(tcfRh)).apply(this, arguments));
  }
...
_metalSoy2.default.register(tcfRh, _conversionSoy2.default);

exports.default = tcfRh;
...
exports.templates = exports.tcfRh = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace tcfRh.
   * @public
   */

  goog.module('tcfRh.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'tcfRh.render';
  }
...
_metalSoy2.default.register(tcfRh, templates);
exports.tcfRh = tcfRh;
