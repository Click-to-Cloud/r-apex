...
var iuIMA = function (_Component) {
  _inherits(iuIMA, _Component);

  function iuIMA() {
    _classCallCheck(this, iuIMA);

    return _possibleConstructorReturn(this, (iuIMA.__proto__ || Object.getPrototypeOf(iuIMA)).apply(this, arguments));
  }
...
_metalSoy2.default.register(iuIMA, _conversionSoy2.default);

exports.default = iuIMA;
...
exports.templates = exports.iuIMA = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace iuIMA.
   * @public
   */

  goog.module('iuIMA.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'iuIMA.render';
  }
...
_metalSoy2.default.register(iuIMA, templates);
exports.iuIMA = iuIMA;
