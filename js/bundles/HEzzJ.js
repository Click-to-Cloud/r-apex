...
var HEzzJ = function (_Component) {
  _inherits(HEzzJ, _Component);

  function HEzzJ() {
    _classCallCheck(this, HEzzJ);

    return _possibleConstructorReturn(this, (HEzzJ.__proto__ || Object.getPrototypeOf(HEzzJ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(HEzzJ, _logicSoy2.default);

exports.default = HEzzJ;
...
exports.templates = exports.HEzzJ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace HEzzJ.
   * @public
   */

  goog.module('HEzzJ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'HEzzJ.render';
  }
...
_metalSoy2.default.register(HEzzJ, templates);
exports.HEzzJ = HEzzJ;
