...
var tvQXQ = function (_Component) {
  _inherits(tvQXQ, _Component);

  function tvQXQ() {
    _classCallCheck(this, tvQXQ);

    return _possibleConstructorReturn(this, (tvQXQ.__proto__ || Object.getPrototypeOf(tvQXQ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(tvQXQ, _step_8Soy2.default);

exports.default = tvQXQ;
...
exports.templates = exports.tvQXQ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace tvQXQ.
   * @public
   */

  goog.module('tvQXQ.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param2115 = function param2115() {
      ie_open('h2');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param2115 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'tvQXQ.render';
  }
...
_metalSoy2.default.register(tvQXQ, templates);
exports.tvQXQ = tvQXQ;
