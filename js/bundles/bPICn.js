...
var bPICn = function (_Component) {
  _inherits(bPICn, _Component);

  function bPICn() {
    _classCallCheck(this, bPICn);

    return _possibleConstructorReturn(this, (bPICn.__proto__ || Object.getPrototypeOf(bPICn)).apply(this, arguments));
  }
...
_metalSoy2.default.register(bPICn, _creationSoy2.default);

exports.default = bPICn;
...
exports.templates = exports.bPICn = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace bPICn.
   * @public
   */

  goog.module('bPICn.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'bPICn.render';
  }
...
_metalSoy2.default.register(bPICn, templates);
exports.bPICn = bPICn;
