...
var LjkTO = function (_Component) {
  _inherits(LjkTO, _Component);

  function LjkTO() {
    _classCallCheck(this, LjkTO);

    return _possibleConstructorReturn(this, (LjkTO.__proto__ || Object.getPrototypeOf(LjkTO)).apply(this, arguments));
  }
...
_metalSoy2.default.register(LjkTO, _step_3Soy2.default);

exports.default = LjkTO;
...
exports.templates = exports.LjkTO = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace LjkTO.
   * @public
   */

  goog.module('LjkTO.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param2000 = function param2000() {
      ie_open('h2');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param2000 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'LjkTO.render';
  }
...
_metalSoy2.default.register(LjkTO, templates);
exports.LjkTO = LjkTO;
