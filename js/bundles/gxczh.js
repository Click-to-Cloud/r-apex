...
var gxczh = function (_Component) {
  _inherits(gxczh, _Component);

  function gxczh() {
    _classCallCheck(this, gxczh);

    return _possibleConstructorReturn(this, (gxczh.__proto__ || Object.getPrototypeOf(gxczh)).apply(this, arguments));
  }
...
_metalSoy2.default.register(gxczh, _arithmeticSoy2.default);

exports.default = gxczh;
...
exports.templates = exports.gxczh = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace gxczh.
   * @public
   */

  goog.module('gxczh.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'gxczh.render';
  }
...
_metalSoy2.default.register(gxczh, templates);
exports.gxczh = gxczh;
