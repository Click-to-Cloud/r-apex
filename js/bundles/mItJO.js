...
var mItJO = function (_Component) {
  _inherits(mItJO, _Component);

  function mItJO() {
    _classCallCheck(this, mItJO);

    return _possibleConstructorReturn(this, (mItJO.__proto__ || Object.getPrototypeOf(mItJO)).apply(this, arguments));
  }
...
_metalSoy2.default.register(mItJO, _arithmeticSoy2.default);

exports.default = mItJO;
...
exports.templates = exports.mItJO = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace mItJO.
   * @public
   */

  goog.module('mItJO.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'mItJO.render';
  }
...
_metalSoy2.default.register(mItJO, templates);
exports.mItJO = mItJO;
