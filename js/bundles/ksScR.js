...
var ksScR = function (_Component) {
  _inherits(ksScR, _Component);

  function ksScR() {
    _classCallCheck(this, ksScR);

    return _possibleConstructorReturn(this, (ksScR.__proto__ || Object.getPrototypeOf(ksScR)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ksScR, _comparatorSoy2.default);

exports.default = ksScR;
...
exports.templates = exports.ksScR = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ksScR.
   * @public
   */

  goog.module('ksScR.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ksScR.render';
  }
...
_metalSoy2.default.register(ksScR, templates);
exports.ksScR = ksScR;
