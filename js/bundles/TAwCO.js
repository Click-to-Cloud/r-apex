...
var TAwCO = function (_Component) {
  _inherits(TAwCO, _Component);

  function TAwCO() {
    _classCallCheck(this, TAwCO);

    return _possibleConstructorReturn(this, (TAwCO.__proto__ || Object.getPrototypeOf(TAwCO)).apply(this, arguments));
  }
...
_metalSoy2.default.register(TAwCO, _methodsSoy2.default);

exports.default = TAwCO;
...
exports.templates = exports.TAwCO = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace TAwCO.
   * @public
   */

  goog.module('TAwCO.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'TAwCO.render';
  }
...
_metalSoy2.default.register(TAwCO, templates);
exports.TAwCO = TAwCO;
