...
var EYMMe = function (_Component) {
  _inherits(EYMMe, _Component);

  function EYMMe() {
    _classCallCheck(this, EYMMe);

    return _possibleConstructorReturn(this, (EYMMe.__proto__ || Object.getPrototypeOf(EYMMe)).apply(this, arguments));
  }
...
_metalSoy2.default.register(EYMMe, _conversionSoy2.default);

exports.default = EYMMe;
...
exports.templates = exports.EYMMe = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace EYMMe.
   * @public
   */

  goog.module('EYMMe.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param1379 = function param1379() {
      ie_open('h6');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param1379 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'EYMMe.render';
  }
...
_metalSoy2.default.register(EYMMe, templates);
exports.EYMMe = EYMMe;
