...
var AeNYC = function (_Component) {
  _inherits(AeNYC, _Component);

  function AeNYC() {
    _classCallCheck(this, AeNYC);

    return _possibleConstructorReturn(this, (AeNYC.__proto__ || Object.getPrototypeOf(AeNYC)).apply(this, arguments));
  }
...
_metalSoy2.default.register(AeNYC, _step_7Soy2.default);

exports.default = AeNYC;
...
exports.templates = exports.AeNYC = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace AeNYC.
   * @public
   */

  goog.module('AeNYC.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param2079 = function param2079() {
      ie_open('h2');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param2079 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'AeNYC.render';
  }
...
_metalSoy2.default.register(AeNYC, templates);
exports.AeNYC = AeNYC;
