...
var TQWwm = function (_Component) {
  _inherits(TQWwm, _Component);

  function TQWwm() {
    _classCallCheck(this, TQWwm);

    return _possibleConstructorReturn(this, (TQWwm.__proto__ || Object.getPrototypeOf(TQWwm)).apply(this, arguments));
  }
...
_metalSoy2.default.register(TQWwm, _step_4Soy2.default);

exports.default = TQWwm;
...
exports.templates = exports.TQWwm = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace TQWwm.
   * @public
   */

  goog.module('TQWwm.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param2021 = function param2021() {
      ie_open('h2');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param2021 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'TQWwm.render';
  }
...
_metalSoy2.default.register(TQWwm, templates);
exports.TQWwm = TQWwm;
