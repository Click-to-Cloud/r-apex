...
var lBEJN = function (_Component) {
  _inherits(lBEJN, _Component);

  function lBEJN() {
    _classCallCheck(this, lBEJN);

    return _possibleConstructorReturn(this, (lBEJN.__proto__ || Object.getPrototypeOf(lBEJN)).apply(this, arguments));
  }
...
_metalSoy2.default.register(lBEJN, _indexSoy2.default);

exports.default = lBEJN;
...
exports.templates = exports.lBEJN = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace lBEJN.
   * @public
   */

  goog.module('lBEJN.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'lBEJN.render';
  }
...
_metalSoy2.default.register(lBEJN, templates);
exports.lBEJN = lBEJN;
