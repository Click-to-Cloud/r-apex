...
var MgSen = function (_Component) {
  _inherits(MgSen, _Component);

  function MgSen() {
    _classCallCheck(this, MgSen);

    return _possibleConstructorReturn(this, (MgSen.__proto__ || Object.getPrototypeOf(MgSen)).apply(this, arguments));
  }
...
_metalSoy2.default.register(MgSen, _stringSoy2.default);

exports.default = MgSen;
...
exports.templates = exports.MgSen = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace MgSen.
   * @public
   */

  goog.module('MgSen.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'MgSen.render';
  }
...
_metalSoy2.default.register(MgSen, templates);
exports.MgSen = MgSen;
