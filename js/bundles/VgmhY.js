...
var VgmhY = function (_Component) {
  _inherits(VgmhY, _Component);

  function VgmhY() {
    _classCallCheck(this, VgmhY);

    return _possibleConstructorReturn(this, (VgmhY.__proto__ || Object.getPrototypeOf(VgmhY)).apply(this, arguments));
  }
...
_metalSoy2.default.register(VgmhY, _step_6Soy2.default);

exports.default = VgmhY;
...
exports.templates = exports.VgmhY = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace VgmhY.
   * @public
   */

  goog.module('VgmhY.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'VgmhY.render';
  }
...
_metalSoy2.default.register(VgmhY, templates);
exports.VgmhY = VgmhY;
