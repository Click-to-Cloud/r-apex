...
var igPDO = function (_Component) {
  _inherits(igPDO, _Component);

  function igPDO() {
    _classCallCheck(this, igPDO);

    return _possibleConstructorReturn(this, (igPDO.__proto__ || Object.getPrototypeOf(igPDO)).apply(this, arguments));
  }
...
_metalSoy2.default.register(igPDO, _comparatorSoy2.default);

exports.default = igPDO;
...
exports.templates = exports.igPDO = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace igPDO.
   * @public
   */

  goog.module('igPDO.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'igPDO.render';
  }
...
_metalSoy2.default.register(igPDO, templates);
exports.igPDO = igPDO;
