...
var olwir = function (_Component) {
  _inherits(olwir, _Component);

  function olwir() {
    _classCallCheck(this, olwir);

    return _possibleConstructorReturn(this, (olwir.__proto__ || Object.getPrototypeOf(olwir)).apply(this, arguments));
  }
...
_metalSoy2.default.register(olwir, _relationSoy2.default);

exports.default = olwir;
...
exports.templates = exports.olwir = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace olwir.
   * @public
   */

  goog.module('olwir.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param1765 = function param1765() {
      ie_open('h6');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param1765 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'olwir.render';
  }
...
_metalSoy2.default.register(olwir, templates);
exports.olwir = olwir;
