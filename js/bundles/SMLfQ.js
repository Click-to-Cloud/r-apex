...
var SMLfQ = function (_Component) {
  _inherits(SMLfQ, _Component);

  function SMLfQ() {
    _classCallCheck(this, SMLfQ);

    return _possibleConstructorReturn(this, (SMLfQ.__proto__ || Object.getPrototypeOf(SMLfQ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(SMLfQ, _step_8Soy2.default);

exports.default = SMLfQ;
...
exports.templates = exports.SMLfQ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace SMLfQ.
   * @public
   */

  goog.module('SMLfQ.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param2120 = function param2120() {
      ie_open('h2');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param2120 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'SMLfQ.render';
  }
...
_metalSoy2.default.register(SMLfQ, templates);
exports.SMLfQ = SMLfQ;
