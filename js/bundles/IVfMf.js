...
var IVfMf = function (_Component) {
  _inherits(IVfMf, _Component);

  function IVfMf() {
    _classCallCheck(this, IVfMf);

    return _possibleConstructorReturn(this, (IVfMf.__proto__ || Object.getPrototypeOf(IVfMf)).apply(this, arguments));
  }
...
_metalSoy2.default.register(IVfMf, _arithmeticSoy2.default);

exports.default = IVfMf;
...
exports.templates = exports.IVfMf = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace IVfMf.
   * @public
   */

  goog.module('IVfMf.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'IVfMf.render';
  }
...
_metalSoy2.default.register(IVfMf, templates);
exports.IVfMf = IVfMf;
