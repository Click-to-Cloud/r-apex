...
var mEWPa = function (_Component) {
  _inherits(mEWPa, _Component);

  function mEWPa() {
    _classCallCheck(this, mEWPa);

    return _possibleConstructorReturn(this, (mEWPa.__proto__ || Object.getPrototypeOf(mEWPa)).apply(this, arguments));
  }
...
_metalSoy2.default.register(mEWPa, _conditionSoy2.default);

exports.default = mEWPa;
...
exports.templates = exports.mEWPa = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace mEWPa.
   * @public
   */

  goog.module('mEWPa.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'mEWPa.render';
  }
...
_metalSoy2.default.register(mEWPa, templates);
exports.mEWPa = mEWPa;
