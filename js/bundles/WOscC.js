...
var WOscC = function (_Component) {
  _inherits(WOscC, _Component);

  function WOscC() {
    _classCallCheck(this, WOscC);

    return _possibleConstructorReturn(this, (WOscC.__proto__ || Object.getPrototypeOf(WOscC)).apply(this, arguments));
  }
...
_metalSoy2.default.register(WOscC, _utilitySoy2.default);

exports.default = WOscC;
...
exports.templates = exports.WOscC = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace WOscC.
   * @public
   */

  goog.module('WOscC.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param1288 = function param1288() {
      ie_open('h6');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'WOscC.render';
  }
...
_metalSoy2.default.register(WOscC, templates);
exports.WOscC = WOscC;
