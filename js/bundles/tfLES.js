...
var tfLES = function (_Component) {
  _inherits(tfLES, _Component);

  function tfLES() {
    _classCallCheck(this, tfLES);

    return _possibleConstructorReturn(this, (tfLES.__proto__ || Object.getPrototypeOf(tfLES)).apply(this, arguments));
  }
...
_metalSoy2.default.register(tfLES, _listSoy2.default);

exports.default = tfLES;
...
exports.templates = exports.tfLES = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace tfLES.
   * @public
   */

  goog.module('tfLES.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'tfLES.render';
  }
...
_metalSoy2.default.register(tfLES, templates);
exports.tfLES = tfLES;
