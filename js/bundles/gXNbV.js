...
var gXNbV = function (_Component) {
  _inherits(gXNbV, _Component);

  function gXNbV() {
    _classCallCheck(this, gXNbV);

    return _possibleConstructorReturn(this, (gXNbV.__proto__ || Object.getPrototypeOf(gXNbV)).apply(this, arguments));
  }
...
_metalSoy2.default.register(gXNbV, _conversionSoy2.default);

exports.default = gXNbV;
...
exports.templates = exports.gXNbV = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace gXNbV.
   * @public
   */

  goog.module('gXNbV.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'gXNbV.render';
  }
...
_metalSoy2.default.register(gXNbV, templates);
exports.gXNbV = gXNbV;
