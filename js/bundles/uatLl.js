...
var uatLl = function (_Component) {
  _inherits(uatLl, _Component);

  function uatLl() {
    _classCallCheck(this, uatLl);

    return _possibleConstructorReturn(this, (uatLl.__proto__ || Object.getPrototypeOf(uatLl)).apply(this, arguments));
  }
...
_metalSoy2.default.register(uatLl, _listSoy2.default);

exports.default = uatLl;
...
exports.templates = exports.uatLl = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace uatLl.
   * @public
   */

  goog.module('uatLl.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'uatLl.render';
  }
...
_metalSoy2.default.register(uatLl, templates);
exports.uatLl = uatLl;
