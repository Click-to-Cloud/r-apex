...
var _methodsSoy = __webpack_require__(301);
...
var vUfSC = function (_Component) {
  _inherits(vUfSC, _Component);

  function vUfSC() {
    _classCallCheck(this, vUfSC);

    return _possibleConstructorReturn(this, (vUfSC.__proto__ || Object.getPrototypeOf(vUfSC)).apply(this, arguments));
  }
...
_metalSoy2.default.register(vUfSC, _methodsSoy2.default);

exports.default = vUfSC;
...
exports.templates = exports.vUfSC = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace vUfSC.
   * @public
   */

  goog.module('vUfSC.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param1386 = function param1386() {
      ie_open('h6');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param1386 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'vUfSC.render';
  }
...
_metalSoy2.default.register(vUfSC, templates);
exports.vUfSC = vUfSC;
