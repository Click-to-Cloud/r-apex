...
var obYyv = function (_Component) {
  _inherits(obYyv, _Component);

  function obYyv() {
    _classCallCheck(this, obYyv);

    return _possibleConstructorReturn(this, (obYyv.__proto__ || Object.getPrototypeOf(obYyv)).apply(this, arguments));
  }
...
_metalSoy2.default.register(obYyv, _listSoy2.default);

exports.default = obYyv;
...
exports.templates = exports.obYyv = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace obYyv.
   * @public
   */

  goog.module('obYyv.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'obYyv.render';
  }
...
_metalSoy2.default.register(obYyv, templates);
exports.obYyv = obYyv;
