...
var wpZuq = function (_Component) {
  _inherits(wpZuq, _Component);

  function wpZuq() {
    _classCallCheck(this, wpZuq);

    return _possibleConstructorReturn(this, (wpZuq.__proto__ || Object.getPrototypeOf(wpZuq)).apply(this, arguments));
  }
...
_metalSoy2.default.register(wpZuq, _methodsSoy2.default);

exports.default = wpZuq;
...
exports.templates = exports.wpZuq = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace wpZuq.
   * @public
   */

  goog.module('wpZuq.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'wpZuq.render';
  }
...
_metalSoy2.default.register(wpZuq, templates);
exports.wpZuq = wpZuq;
