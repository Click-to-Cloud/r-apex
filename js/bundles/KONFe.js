...
var KONFe = function (_Component) {
  _inherits(KONFe, _Component);

  function KONFe() {
    _classCallCheck(this, KONFe);

    return _possibleConstructorReturn(this, (KONFe.__proto__ || Object.getPrototypeOf(KONFe)).apply(this, arguments));
  }
...
_metalSoy2.default.register(KONFe, _listSoy2.default);

exports.default = KONFe;
...
exports.templates = exports.KONFe = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace KONFe.
   * @public
   */

  goog.module('KONFe.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'KONFe.render';
  }
...
_metalSoy2.default.register(KONFe, templates);
exports.KONFe = KONFe;
