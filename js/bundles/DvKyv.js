...
var DvKyv = function (_Component) {
  _inherits(DvKyv, _Component);

  function DvKyv() {
    _classCallCheck(this, DvKyv);

    return _possibleConstructorReturn(this, (DvKyv.__proto__ || Object.getPrototypeOf(DvKyv)).apply(this, arguments));
  }
...
_metalSoy2.default.register(DvKyv, _indexSoy2.default);

exports.default = DvKyv;
...
exports.templates = exports.DvKyv = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace DvKyv.
   * @public
   */

  goog.module('DvKyv.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'DvKyv.render';
  }
...
_metalSoy2.default.register(DvKyv, templates);
exports.DvKyv = DvKyv;
