...
var aNPYD = function (_Component) {
  _inherits(aNPYD, _Component);

  function aNPYD() {
    _classCallCheck(this, aNPYD);

    return _possibleConstructorReturn(this, (aNPYD.__proto__ || Object.getPrototypeOf(aNPYD)).apply(this, arguments));
  }
...
_metalSoy2.default.register(aNPYD, _step_3Soy2.default);

exports.default = aNPYD;
...
exports.templates = exports.aNPYD = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace aNPYD.
   * @public
   */

  goog.module('aNPYD.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'aNPYD.render';
  }
...
_metalSoy2.default.register(aNPYD, templates);
exports.aNPYD = aNPYD;
