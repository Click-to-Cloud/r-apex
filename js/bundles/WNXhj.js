...
var WNXhj = function (_Component) {
  _inherits(WNXhj, _Component);

  function WNXhj() {
    _classCallCheck(this, WNXhj);

    return _possibleConstructorReturn(this, (WNXhj.__proto__ || Object.getPrototypeOf(WNXhj)).apply(this, arguments));
  }
...
_metalSoy2.default.register(WNXhj, _step_3Soy2.default);

exports.default = WNXhj;
...
exports.templates = exports.WNXhj = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace WNXhj.
   * @public
   */

  goog.module('WNXhj.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param2005 = function param2005() {
      ie_open('h2');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param2005 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'WNXhj.render';
  }
...
_metalSoy2.default.register(WNXhj, templates);
exports.WNXhj = WNXhj;
