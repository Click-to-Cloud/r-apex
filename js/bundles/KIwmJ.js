...
var KIwmJ = function (_Component) {
  _inherits(KIwmJ, _Component);

  function KIwmJ() {
    _classCallCheck(this, KIwmJ);

    return _possibleConstructorReturn(this, (KIwmJ.__proto__ || Object.getPrototypeOf(KIwmJ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(KIwmJ, _listSoy2.default);

exports.default = KIwmJ;
...
exports.templates = exports.KIwmJ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace KIwmJ.
   * @public
   */

  goog.module('KIwmJ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'KIwmJ.render';
  }
...
_metalSoy2.default.register(KIwmJ, templates);
exports.KIwmJ = KIwmJ;
