...
var WBTnt = function (_Component) {
  _inherits(WBTnt, _Component);

  function WBTnt() {
    _classCallCheck(this, WBTnt);

    return _possibleConstructorReturn(this, (WBTnt.__proto__ || Object.getPrototypeOf(WBTnt)).apply(this, arguments));
  }
...
_metalSoy2.default.register(WBTnt, _relationSoy2.default);

exports.default = WBTnt;
...
exports.templates = exports.WBTnt = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace WBTnt.
   * @public
   */

  goog.module('WBTnt.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'WBTnt.render';
  }
...
_metalSoy2.default.register(WBTnt, templates);
exports.WBTnt = WBTnt;
