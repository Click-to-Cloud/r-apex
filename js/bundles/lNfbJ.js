...
var lNfbJ = function (_Component) {
  _inherits(lNfbJ, _Component);

  function lNfbJ() {
    _classCallCheck(this, lNfbJ);

    return _possibleConstructorReturn(this, (lNfbJ.__proto__ || Object.getPrototypeOf(lNfbJ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(lNfbJ, _functionSoy2.default);

exports.default = lNfbJ;
...
exports.templates = exports.lNfbJ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace lNfbJ.
   * @public
   */

  goog.module('lNfbJ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'lNfbJ.render';
  }
...
_metalSoy2.default.register(lNfbJ, templates);
exports.lNfbJ = lNfbJ;
