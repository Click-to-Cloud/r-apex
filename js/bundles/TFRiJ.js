...
var TFRiJ = function (_Component) {
  _inherits(TFRiJ, _Component);

  function TFRiJ() {
    _classCallCheck(this, TFRiJ);

    return _possibleConstructorReturn(this, (TFRiJ.__proto__ || Object.getPrototypeOf(TFRiJ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(TFRiJ, _step_6Soy2.default);

exports.default = TFRiJ;
...
exports.templates = exports.TFRiJ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace TFRiJ.
   * @public
   */

  goog.module('TFRiJ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'TFRiJ.render';
  }
...
_metalSoy2.default.register(TFRiJ, templates);
exports.TFRiJ = TFRiJ;
