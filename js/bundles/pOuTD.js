...
var pOuTD = function (_Component) {
  _inherits(pOuTD, _Component);

  function pOuTD() {
    _classCallCheck(this, pOuTD);

    return _possibleConstructorReturn(this, (pOuTD.__proto__ || Object.getPrototypeOf(pOuTD)).apply(this, arguments));
  }
...
_metalSoy2.default.register(pOuTD, _arithmeticSoy2.default);

exports.default = pOuTD;
...
exports.templates = exports.pOuTD = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace pOuTD.
   * @public
   */

  goog.module('pOuTD.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'pOuTD.render';
  }
...
_metalSoy2.default.register(pOuTD, templates);
exports.pOuTD = pOuTD;
