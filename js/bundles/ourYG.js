...
var ourYG = function (_Component) {
  _inherits(ourYG, _Component);

  function ourYG() {
    _classCallCheck(this, ourYG);

    return _possibleConstructorReturn(this, (ourYG.__proto__ || Object.getPrototypeOf(ourYG)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ourYG, _step_5Soy2.default);

exports.default = ourYG;
...
exports.templates = exports.ourYG = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ourYG.
   * @public
   */

  goog.module('ourYG.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param2052 = function param2052() {
      ie_open('h2');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param2052 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ourYG.render';
  }
...
_metalSoy2.default.register(ourYG, templates);
exports.ourYG = ourYG;
