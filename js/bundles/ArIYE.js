...
var ArIYE = function (_Component) {
  _inherits(ArIYE, _Component);

  function ArIYE() {
    _classCallCheck(this, ArIYE);

    return _possibleConstructorReturn(this, (ArIYE.__proto__ || Object.getPrototypeOf(ArIYE)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ArIYE, _conversionSoy2.default);

exports.default = ArIYE;
...
exports.templates = exports.ArIYE = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ArIYE.
   * @public
   */

  goog.module('ArIYE.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ArIYE.render';
  }
...
_metalSoy2.default.register(ArIYE, templates);
exports.ArIYE = ArIYE;
