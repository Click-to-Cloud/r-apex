...
var wpjmJ = function (_Component) {
  _inherits(wpjmJ, _Component);

  function wpjmJ() {
    _classCallCheck(this, wpjmJ);

    return _possibleConstructorReturn(this, (wpjmJ.__proto__ || Object.getPrototypeOf(wpjmJ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(wpjmJ, _indexSoy2.default);

exports.default = wpjmJ;
...
exports.templates = exports.wpjmJ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace wpjmJ.
   * @public
   */

  goog.module('wpjmJ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'wpjmJ.render';
  }
...
_metalSoy2.default.register(wpjmJ, templates);
exports.wpjmJ = wpjmJ;
