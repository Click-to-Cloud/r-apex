...
var RMcLX = function (_Component) {
  _inherits(RMcLX, _Component);

  function RMcLX() {
    _classCallCheck(this, RMcLX);

    return _possibleConstructorReturn(this, (RMcLX.__proto__ || Object.getPrototypeOf(RMcLX)).apply(this, arguments));
  }
...
_metalSoy2.default.register(RMcLX, _stringSoy2.default);

exports.default = RMcLX;
...
exports.templates = exports.RMcLX = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace RMcLX.
   * @public
   */

  goog.module('RMcLX.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param1806 = function param1806() {
      ie_open('h6');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param1806 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'RMcLX.render';
  }
...
_metalSoy2.default.register(RMcLX, templates);
exports.RMcLX = RMcLX;
