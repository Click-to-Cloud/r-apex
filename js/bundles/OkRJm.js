...
var OkRJm = function (_Component) {
  _inherits(OkRJm, _Component);

  function OkRJm() {
    _classCallCheck(this, OkRJm);

    return _possibleConstructorReturn(this, (OkRJm.__proto__ || Object.getPrototypeOf(OkRJm)).apply(this, arguments));
  }
...
_metalSoy2.default.register(OkRJm, _arithmeticSoy2.default);

exports.default = OkRJm;
...
exports.templates = exports.OkRJm = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace OkRJm.
   * @public
   */

  goog.module('OkRJm.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'OkRJm.render';
  }
...
_metalSoy2.default.register(OkRJm, templates);
exports.OkRJm = OkRJm;
