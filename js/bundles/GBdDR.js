...
var GBdDR = function (_Component) {
  _inherits(GBdDR, _Component);

  function GBdDR() {
    _classCallCheck(this, GBdDR);

    return _possibleConstructorReturn(this, (GBdDR.__proto__ || Object.getPrototypeOf(GBdDR)).apply(this, arguments));
  }
...
_metalSoy2.default.register(GBdDR, _arithmeticSoy2.default);

exports.default = GBdDR;
...
exports.templates = exports.GBdDR = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace GBdDR.
   * @public
   */

  goog.module('GBdDR.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'GBdDR.render';
  }
...
_metalSoy2.default.register(GBdDR, templates);
exports.GBdDR = GBdDR;
