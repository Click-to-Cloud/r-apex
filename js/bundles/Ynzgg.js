...
var Ynzgg = function (_Component) {
  _inherits(Ynzgg, _Component);

  function Ynzgg() {
    _classCallCheck(this, Ynzgg);

    return _possibleConstructorReturn(this, (Ynzgg.__proto__ || Object.getPrototypeOf(Ynzgg)).apply(this, arguments));
  }
...
_metalSoy2.default.register(Ynzgg, _creationSoy2.default);

exports.default = Ynzgg;
...
exports.templates = exports.Ynzgg = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace Ynzgg.
   * @public
   */

  goog.module('Ynzgg.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'Ynzgg.render';
  }
...
_metalSoy2.default.register(Ynzgg, templates);
exports.Ynzgg = Ynzgg;
