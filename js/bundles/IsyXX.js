...
var IsyXX = function (_Component) {
  _inherits(IsyXX, _Component);

  function IsyXX() {
    _classCallCheck(this, IsyXX);

    return _possibleConstructorReturn(this, (IsyXX.__proto__ || Object.getPrototypeOf(IsyXX)).apply(this, arguments));
  }
...
_metalSoy2.default.register(IsyXX, _conversionSoy2.default);

exports.default = IsyXX;
...
exports.templates = exports.IsyXX = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace IsyXX.
   * @public
   */

  goog.module('IsyXX.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'IsyXX.render';
  }
...
_metalSoy2.default.register(IsyXX, templates);
exports.IsyXX = IsyXX;
