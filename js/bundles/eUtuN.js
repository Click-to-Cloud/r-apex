...
var eUtuN = function (_Component) {
  _inherits(eUtuN, _Component);

  function eUtuN() {
    _classCallCheck(this, eUtuN);

    return _possibleConstructorReturn(this, (eUtuN.__proto__ || Object.getPrototypeOf(eUtuN)).apply(this, arguments));
  }
...
_metalSoy2.default.register(eUtuN, _creationSoy2.default);

exports.default = eUtuN;
...
exports.templates = exports.eUtuN = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace eUtuN.
   * @public
   */

  goog.module('eUtuN.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'eUtuN.render';
  }
...
_metalSoy2.default.register(eUtuN, templates);
exports.eUtuN = eUtuN;
