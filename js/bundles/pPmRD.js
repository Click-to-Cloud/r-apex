...
var pPmRD = function (_Component) {
  _inherits(pPmRD, _Component);

  function pPmRD() {
    _classCallCheck(this, pPmRD);

    return _possibleConstructorReturn(this, (pPmRD.__proto__ || Object.getPrototypeOf(pPmRD)).apply(this, arguments));
  }
...
_metalSoy2.default.register(pPmRD, _step_5Soy2.default);

exports.default = pPmRD;
...
exports.templates = exports.pPmRD = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace pPmRD.
   * @public
   */

  goog.module('pPmRD.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'pPmRD.render';
  }
...
_metalSoy2.default.register(pPmRD, templates);
exports.pPmRD = pPmRD;
