...
var _functionSoy = __webpack_require__(279);
...
var qgcpF = function (_Component) {
  _inherits(qgcpF, _Component);

  function qgcpF() {
    _classCallCheck(this, qgcpF);

    return _possibleConstructorReturn(this, (qgcpF.__proto__ || Object.getPrototypeOf(qgcpF)).apply(this, arguments));
  }
...
_metalSoy2.default.register(qgcpF, _functionSoy2.default);

exports.default = qgcpF;
...
exports.templates = exports.qgcpF = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace qgcpF.
   * @public
   */

  goog.module('qgcpF.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'qgcpF.render';
  }
...
_metalSoy2.default.register(qgcpF, templates);
exports.qgcpF = qgcpF;
