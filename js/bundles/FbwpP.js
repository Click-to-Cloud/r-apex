...
var FbwpP = function (_Component) {
  _inherits(FbwpP, _Component);

  function FbwpP() {
    _classCallCheck(this, FbwpP);

    return _possibleConstructorReturn(this, (FbwpP.__proto__ || Object.getPrototypeOf(FbwpP)).apply(this, arguments));
  }
...
_metalSoy2.default.register(FbwpP, _mapSoy2.default);

exports.default = FbwpP;
...
exports.templates = exports.FbwpP = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace FbwpP.
   * @public
   */

  goog.module('FbwpP.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'FbwpP.render';
  }
...
_metalSoy2.default.register(FbwpP, templates);
exports.FbwpP = FbwpP;
