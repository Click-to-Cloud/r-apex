...
var iumVj = function (_Component) {
  _inherits(iumVj, _Component);

  function iumVj() {
    _classCallCheck(this, iumVj);

    return _possibleConstructorReturn(this, (iumVj.__proto__ || Object.getPrototypeOf(iumVj)).apply(this, arguments));
  }
...
_metalSoy2.default.register(iumVj, _indexSoy2.default);

exports.default = iumVj;
...
exports.templates = exports.iumVj = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace iumVj.
   * @public
   */

  goog.module('iumVj.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'iumVj.render';
  }
...
_metalSoy2.default.register(iumVj, templates);
exports.iumVj = iumVj;
