...
var xGJMT = function (_Component) {
  _inherits(xGJMT, _Component);

  function xGJMT() {
    _classCallCheck(this, xGJMT);

    return _possibleConstructorReturn(this, (xGJMT.__proto__ || Object.getPrototypeOf(xGJMT)).apply(this, arguments));
  }
...
_metalSoy2.default.register(xGJMT, _utilitySoy2.default);

exports.default = xGJMT;
...
exports.templates = exports.xGJMT = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace xGJMT.
   * @public
   */

  goog.module('xGJMT.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param1882 = function param1882() {
      ie_open('h6');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param1882 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'xGJMT.render';
  }
...
_metalSoy2.default.register(xGJMT, templates);
exports.xGJMT = xGJMT;
